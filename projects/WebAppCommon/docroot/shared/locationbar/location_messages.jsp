...
if (user.getLevel() == FDUserI.GUEST) {
	...
	if (EnumDeliveryStatus.DONOT_DELIVER.equals(deliveryStatus) && !user.isFutureZoneNotificationEmailSentForCurrentAddress()) {
		needDefaultContainer = false;
%>
<div id="nodeliver-form" class="invisible message" data-type="sitemessage">
	<div class="nodeliver-form">
		<form class="n"><label class="n">Enter your email address and we'll notify you when service expands in your area</label><label class="e"><b>That e-mail has already been added!</b><br>Please enter a different e-mail address.</label><div><input type="text" id="location-email" placeholder="enter your e-mail address"><input type="image" src="/media_stat/images/locationbar/button_submit.png" id="location-submit"></div><div class="p"></div></form>
...
<div id="nodeliver-thanks" class="invisible" data-type="sitemessage">
	<div class="nodeliver-form"><b>Thank you!</b> We'll send you an e-mail a few weeks before we arrive in your neighborhood. In the meantime, please feel free to browse around our online store - just remember that you will not able to sign up or place an order. <a href="/help/delivery_zones.jsp" class="delivery-popuplink">Click here</a> to see current delivery zones. To enter a different zip code, please enter in the box in the upper left.</div>
</div><% 
