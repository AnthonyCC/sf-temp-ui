...
<body scroll="no">
	...
	<div align="center">
		<div class="main_nav" style="background: #FFFFFF; border-bottom: 2px #000000 solid;">
	    	...
	    	<td class="login_form_title">	    	<b><span class="login_direct">Fresh</span><span class="login_fresh">Direct&nbsp;</span>ERPSy-Daisy</b></td></tr></table></div>
		<br />
			...
			<table align="center" cellpadding="6" cellspacing="0" class="login_field">
				...
				<tr>
					<td colspan="2" align="center"><span class="error">Invalid username or password</span></td>
				</tr>
