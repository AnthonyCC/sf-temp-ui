...
<div id="menubar">
        ...
        |
        <a href="<%= ((HttpServletRequest)pageContext.getRequest()).getContextPath() %>/attribute/material/material_search.jsp">View Material Attributes</a>
        |
        <a href="<%= ((HttpServletRequest)pageContext.getRequest()).getContextPath() %>/attribute/class/class_search.jsp">View Class Attributes</a>
        |
