	var	fixedX =-1  // 276 x position (-1 if to appear below control)
	var	fixedY =-1  //244 y position (-1 if to appear below control)
	var startAt = 0 // 0 - sunday ; 1 - monday
	var showWeekNumber = 0	// 0 - don't show; 1 - show
	var showToday = 1		// 0 - don't show; 1 - show
	var imgDir = "/ERPSAdmin/erpsy/images/"	// directory for images ... e.g. var imgDir="/img/"
	...
	if (dom)
	{
		...
		document.write ("</table></div><div id='selectMonth' style='z-index:10' class='div-style'></div><div id='selectYear' style='z-index:10' class='div-style'></div>");
	}
	...
	function constructCalendar () {
		...
		document.getElementById("dayselector").innerHTML   = sHTML
