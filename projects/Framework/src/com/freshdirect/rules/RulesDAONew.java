...
public class RulesDAONew {
	...
	private static final String LOAD_QUERY = "select id, name, start_date, end_date, priority, conditions, outcome, subsystem "
		+ "from cust.rules_new where subsystem = ? ";
	...
	private static final String ADD_QUERY = "insert into cust.rules_new (id, name, start_date, end_date, priority, conditions, outcome, subsystem) "
		+ "values(?, ?, ?, ?, ?, ?, ?, ?) ";
	...
	private static final String UPDATE_QUERY = "update cust.rules_new set name=?, start_date=?, end_date=?, priority=?, conditions=?, outcome=?, subsystem=? "
		+ "where id = ? ";
	...
	private static final String DELETE_QUERY = "delete from cust.rules_new where id = ? ";
