...
public class RulesManagerDAO {
	...
	private static final String LOAD_QUERY = "select id, name, start_date, end_date, priority, conditions, outcome, subsystem "
		+ "from dlv.rules_new where subsystem = ? ";
	...
	private static final String ADD_QUERY = "insert into dlv.rules_new (id, name, start_date, end_date, priority, conditions, outcome, subsystem) "
		+ "values(?, ?, ?, ?, ?, ?, ?, ?) ";
	...
	private static final String UPDATE_QUERY = "update dlv.rules_new set name=?, start_date=?, end_date=?, priority=?, conditions=?, outcome=?, subsystem=? "
		+ "where id = ? ";
	...
	private static final String DELETE_QUERY = "delete from dlv.rules_new where id = ? ";
