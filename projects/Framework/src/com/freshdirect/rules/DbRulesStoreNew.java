...
public class DbRulesStoreNew extends AbstractRuleStore {

	private final DataSource dataSource;
	private final RulesConfig config;
	private final RulesDAONew dao;

	public DbRulesStoreNew(DataSource dataSource, String subsystem, List configurations) {
		this.dataSource = dataSource;
		this.config = findConfig(configurations, subsystem);
		this.dao = new RulesDAONew(this.config);
	}
