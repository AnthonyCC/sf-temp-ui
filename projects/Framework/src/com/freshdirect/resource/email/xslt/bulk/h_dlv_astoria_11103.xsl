...
<html>
	<head>
		...
		<title>FreshDirect expands delivery to parts of Astoria!</title>
...
Deliveries in zip code 11103
begin Thursday, March 11th 2004.

Orders may be placed on the web today!

A note about our delivery areas:
We look forward to delivering to additional parts of Queens in the very near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                ...
                <font color="#CC0000" class="red12px"><b>Deliveries in zip code 11103<br/>begin Thursday, March 11th 2004.</b></font>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                Orders may be placed on the web today!
                ...
                <font color="#CC0000" class="red12px">We look forward to delivering to additional parts of Queens in the very near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.</font>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" />
                <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#CCCCCC"><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="1" border="0" alt="" /></td></tr></table>
                <img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" /><br/>
