...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dt='http://xsltsl.org/date-time' version="1.0">
	...
	<xsl:template name="h_order_info_fdx">
			...
			<table cellpadding="0" cellspacing="0" width="100%"  style="padding:0;margin:0;border-collapse:collapse;border-spacing:0;border-style:none;">
				<tr>
					<td width="49%" valign="top" style="font-family: Verdana, Arial, sans-serif;font-size:12px;">
						<b style="font-weight:bold;font-family: Verdana, Arial, sans-serif;font-size:12px;">TIME</b>
						<br />
						...
						<br />
						<b style="font-weight:bold;font-family: Verdana, Arial, sans-serif;font-size:12px;">ADDRESS</b>
						<br />
