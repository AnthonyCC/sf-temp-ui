...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
		...
		<td>
			...
			<p>We hope your first <a href="http://www.freshdirect.com/cmp">FreshDirect</a> experience was nothing short of excellent. Now we're giving you 10 good reasons to come back for seconds.</p>
