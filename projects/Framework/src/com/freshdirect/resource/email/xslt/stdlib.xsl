...
-->
  ...
  <doc:book xmlns="">
    <bookinfo>
      ...
      <!-- $Id: stdlib.xsl,v 1.12 2002/01/04 23:43:17 balls Exp $ -->
...
<xsl:import href="stdlib.xsl"/>
	...
	<listitem>
	  <para>Import or include either the main stylesheet, or the stylesheet module you wish to use, directly from the library website; http://xsltsl.sourceforge.net/modules/.  For example:</para>
	  <informalexample>
	    <programlisting><![CDATA[
