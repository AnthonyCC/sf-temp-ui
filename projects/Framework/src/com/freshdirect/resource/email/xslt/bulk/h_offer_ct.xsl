...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3"><img src="http://www.freshdirect.com/media/images/promotions/email/ct.gif" width="527" height="17"/><br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" alt="" width="1" height="14"/></td></tr>
                <tr valign="top">
				<td>
				...
				<img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" alt="" width="1" height="6" /><br/>
