...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
		...
		<td>
			...
			<p>Log on to <a href="http://www.freshdirect.com/cmp">www.freshdirect.com/cmp</a><xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;</xsl:text>Access Code: CMP600</p>
			
			<p>You can also contact us via email at <a href="mailto:cmpservice@freshdirect.com">cmpservice@freshdirect.com</a></p>
