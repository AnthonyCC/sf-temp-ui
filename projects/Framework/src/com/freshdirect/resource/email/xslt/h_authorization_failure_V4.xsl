...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="5" cellspacing="0" width="90%">
				...
				<tr>
					<td valign="top">
						<p>Unfortunately, the credit or debit card you selected for your upcoming FreshDirect order, <b>(#<xsl:value-of select="orderNumber"/>)</b>, appears to be expired or inactive, and we are not able to process the payment.</p>
						...
						<p>Please modify your pending order at www.freshdirect.com. At Step 3 of the checkout process, you will have a few options:
							...
							<li>Select a different payment method that is already on your account</li>
