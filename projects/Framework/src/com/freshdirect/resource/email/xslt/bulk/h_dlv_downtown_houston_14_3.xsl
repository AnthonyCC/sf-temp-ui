...
<html>
	<head>
		<title>FreshDirect expands delivery on May 20th</title>
...
FreshDirect continues to expand delivery Downtown!

Downtown Delivery Details

Deliveries Begin
Tuesday May 20th, 2003
See map for new delivery area

Orders may be placed on the web today!

A note about our delivery areas:
We look forward to delivering to all of Downtown in the very near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>FreshDirect continues to expand delivery Downtown!</b></font><br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="18" /></td></tr>
                <tr valign="top">
                <td width="474"><a href="http://www.freshdirect.com"><img src="http://www.freshdirect.com/media_stat/images/template/email/houston_14_3.gif" width="474" height="340" border="0" /></a><br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="18" /></td>
                ...
                <b>Downtown Delivery Details</b>
                <br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="12" /><br/>
                <font color="#CC0000" class="red12px"><b>Deliveries Begin<br/>Tuesday May 20th, 2003</b></font><br/>
                <img src="http://www.freshdirect.com/images/clear.gif" width="1" height="4" /><br/>
                See map for new delivery area
                <br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="12" /><br/>
                Orders may be placed on the web today!
                <br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="18" />
                </td>
                </tr>
		<tr>
		<td colspan="3">
                <b>A note about our delivery areas:</b><br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="4" /><br/>
                <font color="#CC0000" class="red12px">We look forward to delivering to all of Downtown in the very near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.</font><br/><br/>
               <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#CCCCCC"><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="1" border="0" alt="" /></td></tr></table><br/>
