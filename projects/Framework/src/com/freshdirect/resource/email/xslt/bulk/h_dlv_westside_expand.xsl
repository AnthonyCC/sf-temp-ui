...
<html>
	<head>
		<title>FreshDirect expands Upper West Side delivery area.</title>
...
FreshDirect continues West Side Rollout!
...
76th St. to 86th St., Central Park West to Riverside Dr.

Orders may be placed on the web today!

A note about our delivery areas:
We look forward to delivering to all of the Upper West Side in the very near future.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>FreshDirect continues West Side Rollout!</b></font><br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="18" /></td></tr>
                <tr valign="top">
                <td width="328"><img src="http://www.freshdirect.com/media_stat/images/template/email/westside_76_96.gif" width="345" height="425" /><br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="18" /></td>
                ...
                <font color="#CC0000" class="red12px"><b>Deliveries Begin<br/>Monday, March 31, 2003</b></font><br/>
                <img src="http://www.freshdirect.com/images/clear.gif" width="1" height="4" /><br/>
                76th St. to 86th St., Central Park West to Riverside Dr.
                <br/><img src="http://www.freshdirect.com/images/clear.gif" width="1" height="18" /><br/>
                ...
                <font color="#CC0000" class="red12px">We look forward to delivering to all of the Upper West Side in the very near future.<br/><br/></font>
                </td>
                </tr>
		<tr>
		<td colspan="3">
