...
<html lang="en-US" xml:lang="en-US">
	<head>
		...
		<title>Due to popular demand FreshDirect expands to even more of Tribeca on June 19th</title>
...
FreshDirect expands delivery to even more of Tribeca!

Tribeca Delivery Details
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>FreshDirect expands delivery to even more of Tribeca!</b></font></td></tr>
                <tr valign="top">
                <td width="283" class="bodyCopySmall"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14" /><br/><img src="/media_stat/images/template/email/tribeca_2.gif" width="283" height="525" alt="Map"/><br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8" /><br/><b>Note:</b> We do not currently deliver to<br/>addresses on Canal St<br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="18" /></td>
