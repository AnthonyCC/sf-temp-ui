...
<html>
	<head>
		...
		<title>FreshDirect expands delivery to Ridgewood and Glendale!</title>
...
Better Food. Better Prices. Delivered to more of Rego Park!

Ridgewood and Glendale Delivery Details:

Deliveries Begin Thursday April 15, 2004.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>Better Food. Better Prices. Delivered to more of Rego Park!</b></font></td></tr>
                <tr valign="top">
                ...
                <b>Ridgewood and Glendale Delivery Details:</b>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                <font color="#CC0000" class="red12px"><b>Deliveries Begin Thursday April 15, 2004.</b></font>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                Place your order on the web today!
