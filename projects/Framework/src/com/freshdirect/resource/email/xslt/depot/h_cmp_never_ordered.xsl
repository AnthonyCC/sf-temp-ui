...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
		<tr>
		<td>
			<p>A few weeks ago you signed up for more information about <a href="http://www.freshdirect.com/cmp">FreshDirect</a>.</p>
			
			<p>We still want to welcome you to <a href="http://www.freshdirect.com/cmp">FreshDirect</a> with <b>$50 worth of free fresh food.</b>*</p>
        ...
        <p>Start shopping for your favorite things, and get ready to have $50 worth of free fresh food.</p>  
            ...
            <p>*See <a href="http://www.freshdirect.com/cmp">website</a> for details.</p>
