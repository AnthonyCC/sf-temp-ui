...
<html>
	<head>
		...
		<title> FreshDirect expands delivery to Park Slope!</title>
...
Better Food. Better Prices. Delivered to Park Slope!
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>Better Food. Better Prices. Delivered to Park Slope!</b></font></td></tr>
                <tr valign="top">
                ...
                <font color="#CC0000" class="red12px"><b>Deliveries Begin<br/>Monday Oct. 20, 2003</b></font>
                <br/><img src="/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                Orders may be placed on the web today!
				...
				<td width="317" class="bodyCopySmall"><img src="/media_stat/images/template/email/park_slope.gif" width="317" height="657" vspace="14" alt="Map"/></td>
                </tr>
        		<tr>
        		<td colspan="3">
