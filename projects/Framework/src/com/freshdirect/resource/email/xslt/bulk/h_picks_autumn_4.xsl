	...
	<tr>
		...
		<td colspan="3" align="center">
			<table width="96%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr><td colspan="5" background="/media/editorial/picks/summer/autumn_line.gif"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12" border="0" /></td></tr>
