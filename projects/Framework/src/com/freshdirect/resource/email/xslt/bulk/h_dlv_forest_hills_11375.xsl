...
<html>
	<head>
		...
		<title>FreshDirect expands delivery to Forest Hills!</title>
...
Better Food. Better Prices. Delivered to Forest Hills!

Forest Hills Delivery Details
...
We look forward to delivering to additional parts of ZIP code 11375 in the near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>Better Food. Better Prices. Delivered to Forest Hills!</b></font></td></tr>
                <tr valign="top">
				<td width="393" class="bodyCopySmall"><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="14" /><br/><a href="http://www.freshdirect.com"><img src="http://www.freshdirect.com/media_stat/images/template/email/forest_hills_11375.gif" width="393" height="400" alt="Free $50 Fresh Food" border="0"/></a><br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" /></td>
                ...
                <font color="#CC0000" class="red12px"><b>Deliveries Begin<br/>Saturday, March 20, 2004</b></font>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                Place your order on the web today!
                ...
                <font color="#CC0000" class="red12px">We look forward to delivering to additional parts of ZIP code 11375 in the near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.</font>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" />
                <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#CCCCCC"><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="1" border="0" alt="" /></td></tr></table>
                <img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" /><br/>
