							...
							<xsl:choose>
								<xsl:when test="customer/numberOfOrders = 1">
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											<p>You'll know your order has arrived when a uniformed FreshDirect delivery person appears at your door bearing boxes of fresh food. You are under no obligation to tip but have the option to tip if you received exceptional service. Further, FreshDirect delivery personnel are not permitted to ask for a tip.</p>
										</xsl:otherwise>
									</xsl:choose>
