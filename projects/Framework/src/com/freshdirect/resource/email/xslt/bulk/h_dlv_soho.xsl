...
<html lang="en-US" xml:lang="en-US">
	<head>
		...
		<title>FreshDirect expands delivery on July 10th.</title>
...
FreshDirect expands delivery to Soho!

Soho Delivery Details
...
Note: We do not currently deliver to addresses on Canal St.

Order online at www.FreshDirect.com and get $50 worth of free fresh food* (offer expires September 1, 2003) just for trying us. Choose from over 3,000 irresistibly fresh items, plus a full selection of organic foods and popular grocery and household brands. All delivered to your door, exactly the way you want, with 100% satisfaction guaranteed.

To top it off, delivery is free for the first month of service, and our drivers won't accept tips. You've waited long enough. Log on to www.FreshDirect.com today.  You've waited long enough. Log on to www.FreshDirect.com today.   
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>FreshDirect expands delivery to Soho!</b></font></td></tr>
                <tr valign="top">
                <td width="201"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14" /><br/><img src="/media_stat/images/template/email/soho.gif" width="201" height="242" alt="Map" /><br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8" /><br/><font class="bodyCopySmall"><b>Note:</b> We do not currently deliver to addresses on Canal St.</font><br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="18" /></td>
                ...
                <b>Soho Delivery Details</b>
                <br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12" /><br/>
                <font color="#CC0000" class="red12px"><b>Deliveries Begin<br/>Thursday July 10th, 2003</b></font>
                <br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12" /><br/>
                Orders may be placed on the web today!
