...
<html lang="en-US" xml:lang="en-US">
	<head>
		...
		<title>FreshDirect expands delivery.</title>
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>FreshDirect continues to expand delivery Downtown!</b></font></td></tr>
                <tr valign="top">
                <td width="320"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14" /><br/><img src="/media_stat/images/template/email/noho.gif" width="320" height="259" alt="Map" /><br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="18" /></td>
                ...
                <font color="#CC0000" class="red12px"><b>Now Delivering</b></font>
