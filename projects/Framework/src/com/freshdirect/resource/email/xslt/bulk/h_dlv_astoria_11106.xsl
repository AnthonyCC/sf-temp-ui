...
<html>
	<head>
		...
		<title>FreshDirect expands delivery in Astoria!</title>
...
Better Food. Better Prices. Delivered to Astoria!

Astoria Delivery Details:

Deliveries begin Friday, March 12th, 2004.
Orders may be placed on the web today!

A note about our delivery areas:
We look forward to delivering to additional parts of Queens in the near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>Better Food. Better Prices. Delivered to Astoria!</b></font></td></tr>
                <tr valign="top">
                ...
                <b>Astoria Delivery Details:</b>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                <font color="#CC0000" class="red12px"><b>Deliveries begin Friday, March 12th, 2004.</b></font>
                <br/>
                Orders may be placed on the web today!
				<br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                ...
                <font color="#CC0000" class="red12px">We look forward to delivering to additional parts of Queens in the near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.</font>
				...
				<td width="200" class="bodyCopySmall"><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="14" /><br/><a href="http://www.freshdirect.com"><img src="http://www.freshdirect.com/media_stat/images/template/email/astoria_11106.gif" width="177" height="460" alt="Map" border="0"/></a><br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" /></td>
                </tr>
        		<tr>
        		<td colspan="3">
