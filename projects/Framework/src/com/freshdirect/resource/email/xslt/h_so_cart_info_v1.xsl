...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dt='http://xsltsl.org/date-time' version="1.0">
	...
	<xsl:template name="h_so_cart_info_v1">
		<br/>
		<b style="font-weight:bold;font-family: Verdana, Arial, sans-serif;font-size:12px;"><span style="color:#FF9933">STANDING ORDER CONFIRMATION</span></b><br/>
		<br/>
...
<table cellpadding="0" cellspacing="0" width="100%"  style="padding:0;margin:0;border-collapse:collapse;border-spacing:0;border-style:none;">
	<tr>
		<td width="33%" valign="top" style="font-family: Verdana, Arial, sans-serif;font-size:12px;">
			...
			<xsl:value-of select="standingOrder/deliveryDay" /><b>, </b><xsl:value-of select="standingOrder/frequencyDescription" /><br/> 
			<xsl:value-of select="standingOrder/deliveryTime" />
			<br/><br/>
