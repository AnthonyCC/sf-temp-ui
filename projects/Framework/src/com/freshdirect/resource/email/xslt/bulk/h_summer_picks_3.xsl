		...
		<td colspan="3" align="center">
			...
			<table width="96%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
						...
						<table width="246" cellpadding="0" cellspacing="0" border="0" align="center">
							<tr>
								<td class="bodyCopySmall">
									Buying "in season" is probably the best way to ensure delicious fruit. Let our experts guide you to the best that nature has to offer all year round.<br/><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="4" alt="" border="0" /><br/>
					...
					<td><img src="/media_stat/images/layout/clear.gif" width="15" alt="" height="1" border="0" /></td>
					<td width="50%">
