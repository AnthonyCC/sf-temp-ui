	...
	<xsl:template name="mail_body">
		...
		<div style="background-color: #ffffff; border: 1px solid #bbbbbb; margin: 5px; padding: 20px;">
			...
			<div style="margin: 15px 0; font-size: 16px;">
				<span style="font-weight: bold;">#Success!</span> You just added a new delivery address to your account:<br />
				<br />
				...
				<br />
				If you didn't make this change or have any questions, open up the FoodKick app and hit 'Me' to check your settings. Tap 'Help -> Contact Us' to chat with one of our SideKicks so we can clear things up. <br />
				<br />
				Happy Shopping,<br />
