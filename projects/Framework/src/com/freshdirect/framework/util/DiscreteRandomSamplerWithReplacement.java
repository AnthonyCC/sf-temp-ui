 ...
 * @author istvan
 */
public class DiscreteRandomSamplerWithReplacement implements DiscreteRandomSampler {
	 ...
	 */
	public DiscreteRandomSamplerWithReplacement() {
		values = new TreeMap();
	}
	 ...
	 */
	public DiscreteRandomSamplerWithReplacement(Comparator comp) {
	 ...
	 * @param value
	 * @param frequency
	 * @see #setItemFrequency(Object, long)
	 */
	 ...
	 */
	public void setItemFrequency(Object value, long frequency) {
	 ...
	 */
	public long getTotalFrequency() { return total; }
	 ...
	 */
	public long getItemFrequency(Object value) {
		Long freq = (Long)values.get(value);
	...
	public Iterator items() {
		return Arrays.asList(sortedValues).iterator();
	}
}
