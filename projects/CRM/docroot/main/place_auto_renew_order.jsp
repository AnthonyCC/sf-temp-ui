...
%>
<crm:SubscriptionController actionName='<%= request.getParameter("actionName") %>' result='result' successPage='<%= "/main/place_auto_renew_order_review.jsp" %>'>
<TABLE>
<form name="place_order" METHOD="POST" action="">
<input type="hidden" name="actionName" value="review_subscription_order">
