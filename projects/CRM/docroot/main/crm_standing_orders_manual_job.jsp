...
<tmpl:insert template='/template/top_nav.jsp'>
	...
	<tmpl:put name='content' direct='true'>
				...
				<%
					...
					System.out.println("line 51 --------------- isSOJobRunning = " + isSOJobRunning);
				...
				<% } else { %>						
							...
							<%
								...
								System.out.println("line 136 --------------- request.getMethod() = " + request.getMethod());
								...
								if ("POST".equalsIgnoreCase(request.getMethod())){
									try {
										...
										System.out.println("line 148 --------------- POST, kickout job ---------------" );
