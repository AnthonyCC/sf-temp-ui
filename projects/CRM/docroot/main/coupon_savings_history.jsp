...
<%! Date currentDate = new Date();
	...
	private List getCoupons(List productsList) {
		Iterator iter = productsList.iterator();
		List upcCodes = new ArrayList();
		while(iter.hasNext()) {
			ProductModel prod = (ProductModel) iter.next();
			List<SkuModel> skus = prod.getSkus();
		...
		Iterator upcIter = upcCodes.iterator();
		while(upcIter.hasNext()) {
			String upc = (String) upcIter.next();
	...
	private List getProductsForAllDepartments(List<ProductModel> searchproducts,Hashtable<String, String> departments,String searchTerm){
		Enumeration enumer1 = departments.keys();
...
<script language="javascript">
	...
	<% 	
		...
		Enumeration enumer = departments.keys();
...
<form method='POST' name="frmStndOrders" id="frmStndOrders" action="/main/coupon_savings_history.jsp">
	...
	<%!
		...
		private static Comparator<Object> COMP_CODE = new Comparator<Object>() {
		...
		private static Comparator<Object> COMP_NAME = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		private static Comparator<Object> COMP_BRAND = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		private static Comparator<Object> COMP_AMOUNT = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		private static Comparator<Object> COMP_QTY = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		private static Comparator<Object> COMP_STARTS = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		private static Comparator<Object> COMP_EXPIRES = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		private static Comparator<Object> COMP_STATUS = new Comparator<Object>() {
			public int compare(Object o1, Object o2) {
				PromoRow p1 = (PromoRow)o1;
				PromoRow p2 = (PromoRow)o2;
		...
		public final static Map<String, Comparator<Object>> PROMO_COMPARATORS = new HashMap<String, Comparator<Object>>();
		static {
