...
List recipes =  FilteringSortingItem.unwrap(searchResults.getRecipes());
if (searchResults != null && (recipes.size() > 0 || searchResults.getProducts().size() > 0) ) { 
        ...
        for (Iterator pi = FilteringSortingItem.unwrap(searchResults.getProducts()).iterator();pi.hasNext();) {
