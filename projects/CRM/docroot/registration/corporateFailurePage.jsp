...
<% } else { %>
	...
	<img src="/media_stat/images/template/site_access/fd_logo.gif" width="267" height="53" alt="FreshDirect"><br><br>
	<!-- <img src="/media_stat/images/template/site_access/home_delivery_no.gif" width="388" height="66" alt="CORPORATE DELIVERY IS NOT AVAILABLE IN YOUR AREA"> -->
	<h1>CORPORATE DELIVERY IS NOT AVAILABLE IN YOUR AREA</h1>
<%  }   %>
<br><br>
<% if (user.isNotServiceable()) { %>
