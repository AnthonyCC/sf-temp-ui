...
public class ReferralCreditCron {
	...
	public static void main(String[] args) throws Exception {
		...
		LOGGER.info(" Sales list of the Advocate :" + sales);
		...
		while (salesIter.hasNext()) {
			try {
				...
				if (referral_max_sale_id != null
					...
					LOGGER.info("Got the FDOrder:" + order.toString());
		...
		try {
			...
			LOGGER.info(" Finished ReferralCreditCron ");
		} catch (NumberFormatException e) {
			StringWriter sw = new StringWriter();
			e.printStackTrace(new PrintWriter(sw));
			email(Calendar.getInstance().getTime(), sw.getBuffer().toString());
	...
	private static void email(Date processDate, String exceptionMsg) {
		try {
			...
			String subject = "ReferralCreditCron: " + (processDate != null ? dateFormatter.format(processDate) : " date error");
