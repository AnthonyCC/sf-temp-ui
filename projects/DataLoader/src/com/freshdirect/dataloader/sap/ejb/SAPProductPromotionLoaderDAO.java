...
public class SAPProductPromotionLoaderDAO {
	...
	private static final String INSERT_INTO_ERPS_PRODUCT_PROMOTION_GROUP = "INSERT INTO ERPS.PRODUCT_PROMOTION_GROUP(ID,ZONE_ID,VERSION,TYPE,MAT_NUM,SKU_CODE,PRIORITY,ERP_DEPT,FEATURED,FEATURED_HEADER,ERP_CATEGORY,ERP_CAT_POSITION) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
