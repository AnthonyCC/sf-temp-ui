 ...
 *
 */
public class AddressScrubbingLoader {

	private static final Category LOGGER = LoggerFactory.getInstance(AddressScrubbingLoader.class);
//	private static final int DEFAULT_ONE_TIME_RCD_SIZE=200;
	...
	public static void main(String arg[]){
		...
		try {
			...
			while(true){
				long addrCount = sb.getTotalAddressCount();
				System.out.println(" Total record to process ..... : "+addrCount);
				if(addrCount > 0){
					sb.getAddress();
				}else{
					break;
