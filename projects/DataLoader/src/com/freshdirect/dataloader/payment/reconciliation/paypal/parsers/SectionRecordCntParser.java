...
import com.freshdirect.dataloader.payment.reconciliation.paypal.SectionRecordCntDataRecord;

public class SectionRecordCntParser extends PayPalSettlementParser {
	
	private final EnumPayPalRecordType type;
	private static final String ROW_COUNT = "ROW_COUNT";
	
	public SectionRecordCntParser(EnumPayPalRecordType type) {
		super();
		this.type = type;
	...
	protected void makeObjects(Map<String, String> tokens)
		...
		SectionRecordCntDataRecord record = new SectionRecordCntDataRecord();
