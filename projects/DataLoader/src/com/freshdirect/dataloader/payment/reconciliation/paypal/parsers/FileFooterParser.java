...
import com.freshdirect.dataloader.payment.reconciliation.paypal.FileFooterDataRecord;

public class FileFooterParser extends PayPalSettlementParser {
	
	private final EnumPayPalRecordType type;
	private static final String ROW_COUNT = "ROW_COUNT";
	
	public FileFooterParser(EnumPayPalRecordType type) {
		super();
		this.type = type;
	...
	protected void makeObjects(Map<String, String> tokens)
		...
		FileFooterDataRecord record = new FileFooterDataRecord();
