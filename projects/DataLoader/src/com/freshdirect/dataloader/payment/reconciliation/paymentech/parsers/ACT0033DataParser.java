...
import com.freshdirect.dataloader.payment.reconciliation.paymentech.ACT0033DataRecord;

public class ACT0033DataParser extends PaymentechSettlementParser {
	
	private static final String ACTION_CODE = "ACTION_CODE";

	private SynchronousParserClient client;
	
	public ACT0033DataParser(){
		super();
		...
		this.fields.add(new Field(ACTION_CODE, 6, true));
	...
	protected void makeObjects(HashMap tokens) throws BadDataException {
		ACT0033DataRecord record = new ACT0033DataRecord();
		...
		record.setActionCode(getString(tokens, ACTION_CODE));
