...
<%
ProductModel productNode = ProductPricingFactory.getInstance().getPricingAdapter( PopulatorUtil.getProductByName( request.getParameter("catId"), request.getParameter("productId") ));
