...
<%--   <tmpl:put name='title' direct='true'>FreshDirect - E-mail Reminder</tmpl:put> --%>
		...
		<tr>
			<td align="center" class="text12"><br><br><br>
				...
				<br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"><br><img src="/media_stat/images/template/tell_a_friend/confirm_berry.jpg" alt="" width="70" height="70"><br><br><br><br></td></tr>
		</table>
	</tmpl:put>
</tmpl:insert>
