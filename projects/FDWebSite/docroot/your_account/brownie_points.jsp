								...
								<div id="fbbox">
									<div id="testbox1">
										...
										%>
											...
											<% } else { %>									
												<table width="100%" style="">
													<tr>
														<td colspan="3" id="greytext" style="padding-left:15px;padding-top:15px;">
										...
										<% } else if ("fb".equals(current)) { %>
											<br />									
											<div id="login"></div>
											<span id="hide_login" style="padding:15px;float:left;display:none;"><fb:login-button onlogin="window.fbAsyncInit();" id="fb_loginButton">Login</fb:login-button></span>
											<div id="friends">
											...
											<script	language="javascript">
												...
												window.fbAsyncInit = function()	{
													...
													FB.getLoginStatus(function(response) {
														...
														if (response.status	== 'connected')	{
															...
															if (!loginPrompted)	{
																$('#fb_loginButton').children('a').click();
												...
												function logout() { var logout = FB.logout(); $('#friends').empty(); $('#hide_login').show(); }
											</script>
		...
		<TD width="970" align="center">
			...
			<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="<%= W_YA_CUSTOMER_PROFILE_SUMMARY_TOTAL %>">
				<tr VALIGN="TOP">
					...
					<td WIDTH="<%= W_YA_CUSTOMER_PROFILE_SUMMARY_TOTAL - 35 %>"><a href="/index.jsp"><img src="/media_stat/images/buttons/continue_shopping_text.gif"  border="0" alt="CONTINUE SHOPPING"></a><br />from <FONT CLASS="text11bold"><A HREF="/index.jsp">Home Page</A></FONT><br /><IMG src="/media_stat/images/layout/clear.gif" WIDTH="340" HEIGHT="1" BORDER="0"></td>
				</tr>
			</TABLE>
		</td>
	</tr>
