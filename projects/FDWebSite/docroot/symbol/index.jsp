...
<fd:DepotLoginController actionName='checkByDepotCode' depotCode='SYMBOL' successPage='/index.jsp' result='result'>
  ...
  <tmpl:insert template='/common/template/depot_discontinued.jsp'>
    ...
    <tmpl:put name='splash' direct='true'>
		...
		<img src="/media_stat/images/template/depot/splash_logo_sym.gif" width="211" height="59" alt="Symbol" border="0">
    </tmpl:put>
