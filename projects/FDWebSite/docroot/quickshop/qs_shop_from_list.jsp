...
<%--     <tmpl:put name='title' direct='true'>FreshDirect - Reorder from Your Lists</tmpl:put> --%>
    ...
    <tmpl:put name='listactions'>
        <div class="qs-actions">
          <c:if test="${!isQS20}">
          <button aria-label="remove all items" class="qs-deletelist cssbutton transparent white icon-trash-new-before" data-confirm-class="qs-deletelist" data-alignpopup="tc-bc" data-confirm="true" data-confirm-header="Would you also like to delete this list?" data-hide-background="true" data-confirm-removeclass="bubblepopup"
            data-confirm-data="{&quot;buttons&quot;: [{&quot;id&quot;: &quot;keep&quot;, &quot;name&quot;: &quot;Keep List&quot;, &quot;class&quot;: &quot;cssbutton green&quot;}, {&quot;id&quot;: &quot;delete&quot;, &quot;name&quot;: &quot;Delete List&quot;, &quot;class&quot;: &quot;cssbutton red&quot;}]}" data-confirm-button-delete="FreshDirect.quickshop.shopFromList.manageshoppinglists.deleteCurrentList" data-confirm-button-keep="FreshDirect.quickshop.shopFromList.manageshoppinglists.emptyCurrentList">Remove All Items</button>
          </c:if>
...
<!--     		<div id="shoppinglists" class=""></div> -->
    	<% } %>
    	<div id="productlist" class="" data-eventsource="qs_customerLists"></div>
