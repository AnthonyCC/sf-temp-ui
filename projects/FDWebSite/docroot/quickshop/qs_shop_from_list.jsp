...
<tmpl:insert template='/quickshop/includes/qs_template.jsp'>
    ...
    <tmpl:put name='listactions'>
        <div class="qs-actions">
          <c:if test="${!isQS20}">
            <span class="qs-deletelist cssbutton transparent white icon-trash-new-before" data-alignpopup="tc-bc" data-confirm="true" data-confirm-header="Would you also like to delete this list?" data-confirm-data="{&quot;buttons&quot;: [{&quot;id&quot;: &quot;delete&quot;, &quot;name&quot;: &quot;Delete List&quot;, &quot;class&quot;: &quot;cssbutton red&quot;},{&quot;id&quot;: &quot;keep&quot;, &quot;name&quot;: &quot;Keep List&quot;, &quot;class&quot;: &quot;cssbutton green&quot;}]}" data-confirm-button-delete="FreshDirect.quickshop.shopFromList.manageshoppinglists.deleteCurrentList" data-confirm-button-keep="FreshDirect.quickshop.shopFromList.manageshoppinglists.emptyCurrentList">Remove All Items</span>
          </c:if>
