...
if (prodPageLayout.equals(EnumProductLayout.WINE)  ||
    prodPageLayout.equals(EnumProductLayout.RECIPE_MEALKIT_PRODUCT)) prodPageLayout= EnumProductLayout.PERISHABLE;
