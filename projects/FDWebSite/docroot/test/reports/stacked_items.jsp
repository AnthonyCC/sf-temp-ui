...
<body>
<h1>Query for non-Archive items with more than one Web Id</h1>
...
for (ContentKey category : categories){
    ...
    List skuCodes = productModel.getSkuCodes();

    if(categoryModel.getDepartment().toString() != "Archive" && skuCodes.size() > 1){
	count += 1;
%>
      <tr>
