...
<tr>
	<td valign="top">
		...
		<table border="0" cellpadding="0" cellspacing="5" width="100%">
			...
			<!-- Begin Tx Ref -->
			<tr>
				<td nowrap class="form">Profile Id
					 &nbsp;<img alt="*" border="0" height="13" src="global/images/glo_ico_req.gif" width="9"> 
					
				</td>
				<td colspan="3">
					<input type="text" name="userProfile.profileID" maxlength="40" size="40" value="" class="inputfield">
				</td>
			</tr>
			<!-- End Tx Ref Num  -->
			<!-- Begin Amount  -->
			<tr>
				<td nowrap class="form" valign="top">Amount <img alt="*" border="0" height="13" src="global/images/glo_ico_req.gif" width="9"></td>
				<td colspan="3">
					<input type="text" name="userProfile.amount" maxlength="30" size="25" value="" class="inputfield">
					<br>
				</td>
			</tr>
			<!-- End Amount -->
							...
							<table border="0" cellpadding="0" cellspacing="5" width="100%">
								...
								<tr>
									<td align="center">
											...
											<input type="submit" name="capture" id="capture" value="Capture" />
											&nbsp;&nbsp; 
