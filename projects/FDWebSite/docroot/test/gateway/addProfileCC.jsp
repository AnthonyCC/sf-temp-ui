...
<input type="hidden" name="action" id="action" value="addEditProfileCC"/>
...
<option value="WY">WY</option></select>
			...
			<tr>
				...
				<!-- Begin Card Number | Expiration Date -->
							<tr>
							<td class="form" nowrap width="5%">Card Type&nbsp;<img alt="Required Field" border="0" height="13" src="global/images/glo_ico_req.gif" width="9"></td>
							<td>
								...
								<!-- Begin Card Number -->
								<td class="form" nowrap width="5%">Card Number&nbsp;<img alt="Required Field" border="0" height="13" src="global/images/glo_ico_req.gif" width="9"></td>
