...
%><%
	...
	response.setHeader("Content-Disposition", "attachment; filename=spelling_synonyms.csv");
	...
	out.println();
	SynonymDictionary dictionary = SynonymDictionary.createSpellingFromCms(new IdentityConvFactory());
