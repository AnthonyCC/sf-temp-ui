			...
			<div style="width:650px; padding:20px 20px; display:inline-block;">
				...
				<div style="padding:30px 20px 0px 0px;">
					<div style="float: right;">
						...
						<img name="viewcartbutton" onmouseout="swapImage('viewcartbutton','/media_stat/images/buttons/continueshop_f1.png')" onmouseover="swapImage('viewcartbutton','/media_stat/images/buttons/continueshop_f2.png')" src="/media_stat/images/buttons/continueshop_f1.png" border="0"></a>
					</div>
					<div style="float: right;margin-right: 10px">
						<a class="butText" id="choosenewtimeslot" href="#">
						<img name="timeslotbutton" onmouseout="swapImage('timeslotbutton','/media_stat/images/buttons/newtime_popup_f1.png')" onmouseover="swapImage('timeslotbutton','/media_stat/images/buttons/newtime_popup_f2.png')" src="/media_stat/images/buttons/newtime_popup_f1.png" border="0"></a>
					</div>
