...
%>
<fd:CheckoutController actionName="rh_submitDonationOrder" result="result" successPage="/robin_hood/rh_receipt.jsp" ccdProblemPage="/gift_card/purchase/purchase_giftcard.jsp?ccerror=true">
