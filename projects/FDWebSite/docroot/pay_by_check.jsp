...
<tmpl:insert template='/common/template/large_pop.jsp'>
	<tmpl:put name='title' direct='true'>FreshDirect - Pay using your checking account</tmpl:put>
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td class="text12">
				<img src="/media_stat/images/headers/pay_with_checking_acct.gif" width="309" height="17" alt="PAY WITH CHECKING ACCOUNT" vspace="5"><br />
				<strong>Paying from your checking account has great benefits!</strong><br />
				<ul>
					<li>No need to worry about credit card expiration</li>
					<li>Avoid the monthly interest on credit card debt</li>
				</ul>
				<strong>Did you know?</strong> While every order paid with a credit card costs FreshDirect a fee, the costs associated with checking accounts are much lower. As more customers switch to e-check payments, we save money and can pass the savings on to you.<br />
				<br />
