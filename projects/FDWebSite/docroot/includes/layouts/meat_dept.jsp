...
<%if (FDStoreProperties.isDeptEDLPEnabled()) { 
	String sPage = "/includes/department_featured_row.jsp?catId="+FDStoreProperties.getDeptMeatDealsCatId();%>
...
<%if (FDStoreProperties.isDeptMeatDealsEnabled()) {
	String sPage = "/includes/department_featured_row.jsp?catId="+FDStoreProperties.getDeptEDLPCatId();%>
<jsp:include page='<%= sPage %>' flush="true"/>
<% } %>