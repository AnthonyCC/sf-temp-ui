...
%>
    ...
    %>
        <div class="qtyinput qtyinput_fixedwidth">
          <a href="javascript:chgQty<%=catIndex%>(<%=itemShownIndex%>,'<%= qtyFldName %>', -<%= displayProduct.getQuantityIncrement() %>, <%= displayProduct.getQuantityMinimum() %>, <%= user.getQuantityMaximum(displayProduct) %>);return false;" class="quantity_minus"><span>Increase quantity</span></a>
          ...
          <a href="javascript:chgQty<%=catIndex%>(<%=itemShownIndex%>,'<%= qtyFldName %>', <%= displayProduct.getQuantityIncrement() %>, <%= displayProduct.getQuantityMinimum() %>, <%= user.getQuantityMaximum(displayProduct) %>);return false;" class="quantity_plus"><span>Decrease quantity</span></a>
        </div>
    <%  }   %>
