...
<BR><BR>
	...
	<TR VALIGN="TOP">
<%	if (proceedThruCheckout) { %>
		<TD WIDTH="25"><a href="/view_cart.jsp?trk=chkplc"><img src="/media_stat/images/buttons/x_green.gif" WIDTH="20" HEIGHT="19" border="0" alt="CONTINUE SHOPPING" onclick="ntptEventTag('ev=button_event&ni_btn=cancel_checkout');var d=new Date();var cD;do{cD=new Date();}while((cD.getTime()-d.getTime())<500);" id="cancelX"></a></TD>
