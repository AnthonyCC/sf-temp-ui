...
<table width="<%=W_CHECKOUT_STEP_3_WAIVE_TOTAL%>" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="title18"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="6"><br><b>Please note: Your billing and delivery addresses do not match!</b><br><img src="/media_stat/images/layout/ff9933.gif" alt="" width="100%" height="1" vspace="6"></td>
	</tr>
	<tr>
		<td class="text12"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8"><br>
	...
	<tr><td>
		...
		<img src="/media_stat/images/layout/ff9933.gif" alt="" width="<%=W_CHECKOUT_STEP_3_WAIVE_TOTAL%>" height="1" border="0"><br>
		<img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8" border="0"><br>
