...
final int W_NO_ALCOHOL_ADDRESS_TOTAL = 970;
%>
...
<table width="<%=W_NO_ALCOHOL_ADDRESS_TOTAL%>" cellpadding="0" cellspacing="0" border="0">
<form method="POST">
...
<table width="<%=W_NO_ALCOHOL_ADDRESS_TOTAL-100%>" cellpadding="0" cellspacing="0" border="0">
...
<tr valign="top">
	<td width="35"><a href="<%=response.encodeURL("/checkout/view_cart.jsp?trk=chkplc")%>"><img src="/media_stat/images/buttons/green_back_arrow.gif" width="29" height="30" border="0" alt="CONTINUE SHOPPING"></a></td>
