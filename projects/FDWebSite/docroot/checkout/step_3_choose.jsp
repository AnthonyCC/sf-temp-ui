...
<%
    ...
    */    
    ...
    if(cart.getSelectedGiftCards() != null && cart.getSelectedGiftCards().size() > 0 && outStandingBalance <= 0.0) {
    	/* GC-only form */
    	%>
    ...
    <%-- Start Header --%>
		...
		<%
				...
				<table border="0" cellspacing="0" cellpadding="0" width="<%=W_CHECKOUT_STEP_3_CHOOSE_TOTAL%>">
					<tr valign="top">
						<td class="text11" valign="middle">
							<span class="title18">PAYMENT&nbsp;INFO</span>
						</td>
					</tr>
				</table>
				<%
			...
			%>
				<table border="0" cellspacing="0" cellpadding="0" width="<%=W_CHECKOUT_STEP_3_CHOOSE_TOTAL%>">
				    <tr valign="top"> 
						<td class="text11" width="<%=W_CHECKOUT_STEP_3_CHOOSE_TOTAL-475%>" valign="middle">
							<span class="title18">PAYMENT&nbsp;INFO</span>
						</td>
						<td width="340" align="right" valign="middle" class="text10">
