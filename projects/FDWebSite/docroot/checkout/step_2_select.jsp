...
%>
<form method="post" name="step2Form" id="step2Form" onSubmit="return checkPromoEligibilityByTimeSlot('<%= null==user.getRedeemedPromotion()?"null":"not null" %>');" action="/checkout/step_2_select.jsp">
...
<!--START TIMESLOT PAGE HEADER-->
	...
	if (cart instanceof FDModifyCartModel) {
		...
		<table border="0" cellspacing="0" cellpadding="0" width="<%= W_CHECKOUT_STEP_2_SELECT_TOTAL %>">
			<tr valign="top">
				<td class="text11" width="150" valign="middle">
					<span class="title18">CHOOSE&nbsp;TIME</span>
				</td>
	...
	%>
		<table border="0" cellspacing="0" cellpadding="0" width="<%=W_CHECKOUT_STEP_2_SELECT_TOTAL%>">
			<tr>
				...
				<% } %>
				<%-- This column needs to be a dynamic width to allow the media include to have as much space as possible --%>
				<td width="<%= (FDStoreProperties.isNewFDTimeslotGridEnabled()) ? 220 : W_CHECKOUT_STEP_2_SELECT_TOTAL-310 %>" align="right" valign="middle" class="text10" style="color: #666; font-weight: bold;">
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="<%=W_CHECKOUT_STEP_2_SELECT_TOTAL%>" ALIGN="center">
	...
	<TR>
		<td colspan="2">
			<IMG src="/media_stat/images/layout/clear.gif" width="1" height="8" border="0" alt="" />
...
%><IMG src="/media_stat/images/layout/clear.gif" width="1" height="10" border="0" alt="" /><span class="title13 fleft tsAdvanceHeader">Advance Order Delivery Timeslots&nbsp;&nbsp;</span><a class="title13 fleft tsDivHide" id="displayAdvanceOrderGrid" href="javascript:hideAdvanceOrder();">Hide Delivery Timeslots</a><IMG src="/media_stat/images/layout/clear.gif" width="1" height="10" border="0" alt="" /><br />
<% } %>

<%
	if(timeslotList.size()==3 && idx.intValue()==1){
%>
	<div><IMG src="/media_stat/images/layout/clear.gif" width="1" height="10" border="0" alt="" /><br />
		<span class="title13 fleft tsAdvanceHeader" id="displayAdvanceOrderHeader">Advance Order Delivery Timeslots</span>
	<br /><IMG src="/media_stat/images/layout/clear.gif" width="1" height="10" border="0" alt="" /><br /></div>
<% } %>
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=W_CHECKOUT_STEP_2_SELECT_TOTAL%>">
	...
	<% if (hasCapacity) { %>
			<td width="<%=W_CHECKOUT_STEP_2_SELECT_TOTAL-445%>" align="right" valign="middle" colspan="2">
				<%@ include file="/includes/i_cart_next_step_button.jspf" %>
			</td>
	<% }else{ %>
...
<img src="/media_stat/images/layout/clear.gif" width="1" height="8" border="0" alt="" /><br />
<img src="/media_stat/images/layout/dotted_line_w.gif" width="<%=W_CHECKOUT_STEP_2_SELECT_TOTAL%>" height="3" border="0" alt="" /><br />
<img src="/media_stat/images/layout/clear.gif" width="1" height="8" border="0" alt="" /><br />
