...
<fd:DepotLoginController actionName='checkByDepotCode' depotCode='CA' successPage='/index.jsp' result='result'>
  ...
  <tmpl:insert template='/common/template/depot_discontinued.jsp'>
    ...
    <tmpl:put name='splash' direct='true'>
		...
		<img src="/media_stat/images/template/depot/splash_logo_ca.gif" width="177" height="95" alt="CA" border="0">
    </tmpl:put>
