...
<%@ include file="/common/template/includes/globalnav.jspf" %>
	<section class="container">
		<CENTER CLASS="text10">
			<table class="W_RECIPE_DR_NAVS_TOTAL" BORDER="0" CELLPADDING="0" CELLSPACING="0">
			<tr>
				<td class="W_RECIPE_DR_NAVS_LEFT"><img src="/media_stat/images/layout/clear.gif" alt="" class="W_RECIPE_DR_NAVS_LEFT" height="1" border="0"></td>
				<td class="W_RECIPE_DR_NAVS_RIGHT"><img src="/media_stat/images/layout/clear.gif" alt="" class="W_RECIPE_DR_NAVS_RIGHT" height="1" border="0"></td>
			</tr>
			<tr>
				<td class="W_RECIPE_DR_NAVS_TOTAL" colspan="2"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="5" border="0"></td>
			</tr>
			<tr>
				<td class="W_RECIPE_DR_NAVS_TOTAL" colspan="2">
			...
			<tr>
				<td class="W_RECIPE_DR_NAVS_TOTAL" bgcolor="#999966" colspan="2"><IMG src="/media_stat/images/layout/999966.gif" alt="" width="1" height="1"></td>
			</tr>
			<tr valign="TOP">
				<td class="W_RECIPE_DR_NAVS_LEFT" align="left">
					<img src="/media_stat/images/layout/clear.gif" alt="" class="W_RECIPE_DR_NAVS_LEFT" height="15"><br>
					<!-- content lands here -->
					<tmpl:get name='content'/>
					<!-- content ends above here-->
					<br><br>
				</td>
				<td class="W_RECIPE_DR_NAVS_RIGHT" align="center">
