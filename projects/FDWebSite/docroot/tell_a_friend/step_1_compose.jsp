...
<fd:TellAFriendGetterTag id="taf" >
	<table width="520" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td colspan="7" class="text12"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12"><br>
				To tell a friend about this product, just fill out the fields below,<br>Preview your e-mail, and then send it.
				<div align="right" class="text10">* Required Information<br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="3"></div>
			</td>
		</tr>
	
		<tr>
			<td colspan="7" bgcolor="#cccccc" height="1"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="1"></td>
		</tr>
	
		<tr>
			<td rowspan="8" bgcolor="#cccccc"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="1"></td>
			<td><img src="/media_stat/images/layout/clear.gif" alt="" width="39" height="16"></td>
			<td><img src="/media_stat/images/layout/clear.gif" alt="" width="60" height="16"></td>
			<td><img src="/media_stat/images/layout/clear.gif" alt="" width="120" height="16"></td>
			<td><img src="/media_stat/images/layout/clear.gif" alt="" width="260" height="16"></td>
			<td><img src="/media_stat/images/layout/clear.gif" alt="" width="39" height="16"></td>
			<td rowspan="8" bgcolor="#CCCCCC"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="1"></td>
		</tr>
		...
		<tr>
			<td colspan="7" align="center"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="18"><br><input type="image" name="preview_email" src="/media_stat/images/template/tell_a_friend/preview_email.gif" width="117" height="18" border="0" alt="Preview E-mail"></td>
		</tr>
