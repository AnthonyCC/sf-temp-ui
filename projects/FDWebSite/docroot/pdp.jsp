...
String productFullName = productNode.getFullName();
//String title = Jsoup.parse(productNode.getPageTitle() != null && !productNode.getPageTitle().isEmpty() ? productNode.getPageTitle() : productNode.getFullName()).text();
//String str1 = title.replaceAll("<[^>]*>", ""); 
