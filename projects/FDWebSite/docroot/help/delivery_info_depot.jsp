...
<table width="<%=W_DELIVERY_INFO_DEPOT_TOTAL%>" CELLPADDING="0" CELLSPACING="0" border="0">
		  	<tr valign="top">
		  		<td><IMG src="/media_stat/images/layout/clear.gif" alt="" width="<%=W_DELIVERY_INFO_DEPOT_TOTAL%>" HEIGHT="15" border="0"><BR><img src="/media_stat/images/template/depot/how_depot_delivery_works.gif" width="525" height="21" alt="" border="0"><br><FONT CLASS="space2pix"><BR></FONT></td>
		 	</tr>
			<tr bgcolor="#CCCCCC">
			<td><IMG src="/media_stat/images/layout/clear.gif" alt="" width="1" HEIGHT="1"></td>
			</tr>
			<tr>
			<td><IMG src="/media_stat/images/layout/clear.gif" alt="" width="1" HEIGHT="16" border="0"></td>
			</tr>
		  <tr>
...
<table width="<%=W_DELIVERY_INFO_DEPOT_TOTAL%>" border="0" cellpadding="0" cellspacing="0">
     <tr>
          <td><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=W_DELIVERY_INFO_DEPOT_LEFT%>" height="18"></td>
          <td rowspan="2"><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=(W_DELIVERY_INFO_DEPOT_CENTER-1)/2%>" height="1"></td>
          <td><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="1"></td>
          <td rowspan="2"><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=(W_DELIVERY_INFO_DEPOT_CENTER-1)/2%>" height="1"></td>
          <td><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=W_DELIVERY_INFO_DEPOT_RIGHT%>" height="1"></td>
    </tr>
          
    <tr valign="top">
          <td class="text12"><img src="/media_stat/images/template/help/about_depot.gif" width="310" height="13"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"><br><b>Corporate Depot Program</b><br>
...
<tr><td colspan="5"><img src="/media_stat/images/layout/clear.gif" alt="" width="10" height="10"></td></tr>
</table>
<% } %>
</tmpl:put>
</tmpl:insert>