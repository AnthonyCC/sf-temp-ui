	...
	<table border="0" cellspacing="0" cellpadding="2" style="width: <%= (mobWeb) ? "100%" : "675px" %>">
		...
		<tr class="NOMOBWEB">
		    <td style="width: <%= (mobWeb) ? "100%" : "675px" %>" align="center">
				<br><a href="/index.jsp"<%= (("true".equalsIgnoreCase(overlay)) ? " onclick=\"FreshDirect.components.ifrPopup.close()\"" : "") %> onmouseover="swapImage('home_img','/media_stat/images/template/help/help_home_r.gif')" onmouseout="swapImage('home_img','/media_stat/images/template/help/help_home.gif')"><img src="/media_stat/images/template/help/help_home.gif" name="home_img" width="71" height="26" alt="" border="0"></a>
			</td>		
		</tr>
	</table><br><br>
