...
<tr valign="TOP">
	<td width="670" class="text12">
		...
		FreshDirect Customer Service is standing by to answer your questions, seven days a week.  <b>We'll respond within 24 hours &mdash;  
        usually much sooner.</b> Please select an order number and include as much specific information as possible to ensure a prompt
