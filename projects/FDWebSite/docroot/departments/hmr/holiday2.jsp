...
<tmpl:insert template='/common/template/dnav.jsp'>
	...
	<td><img src="/media_stat/images/layout/clear.gif" width="<%=W_HOLIDAY2-222%>" height="22"></td>
	<td><img src="/media_stat/images/layout/clear.gif" width="111" height="22"></td>
	</tr>
	...
	<%-- spacer --%>
	<tr>
	<td><img src="/media_stat/images/layout/clear.gif" width="<%=(W_HOLIDAY2-24)/3%>" height="20"></td>
	...
	<br><img src="/media_stat/images/template/kitchen/hearts3.gif" width="970" height="7"><br><img src="/media_stat/images/layout/clear.gif" width="1" height="3"></td></tr>
	...
	<tr valign="top">
	<td class="text12"><div align="center"><font face="Arial Black, Arial, sans-serif">STEP 1 : HEAT</font></div><br><img src="/media_stat/images/layout/clear.gif" width="1" height="5"><br>
	Heat cheese, oil or stock in a 
	small saucepot over low heat 
	until melted or simmering.</td>
	<td class="text12"><div align="center"><font face="Arial Black, Arial, sans-serif">STEP 2 : SET THE TABLE</font></div><br><img src="/media_stat/images/layout/clear.gif" width="1" height="5"><br>
	...
	<td class="text12"><div align="center"><font face="Arial Black, Arial, sans-serif">STEP 3 : FEEL THE LOVE</font></div><br><img src="/media_stat/images/layout/clear.gif" width="1" height="5"><br>
	...
	<tr><td colspan="5" align="center"><img src="/media_stat/images/layout/clear.gif" width="1" height="14"><br><img src="/media_stat/images/template/kitchen/hearts3.gif" width="970" height="7"></td></tr>
	</table>
    </tmpl:put>	
</tmpl:insert>
