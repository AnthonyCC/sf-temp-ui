...
<tmpl:insert template='/common/template/dnav.jsp'>
  ...
  <tmpl:put name='title'>FreshDirect - Our Valentine's Day Menu</tmpl:put>
	...
	<td align="center"><img src="/media_stat/images/template/kitchen/hearts2.gif" width="748" height="8"></td>
	<td rowspan="3" align="right"><img src="/media_stat/images/template/kitchen/cherub_r.gif" width="101" height="75"></td>
	</tr>
	<tr>
	<td class="text12"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="6"><br>
	...
	<%-- spacer --%>
	<tr>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="111" height="22"></td>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=W_HOLIDAY2-222%>" height="22"></td>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="111" height="22"></td>
	</tr>
	<tr><td align="center" class="text12" colspan="3">
	<img src="/media_stat/images/template/kitchen/title_cheese.gif" width="328" height="22" alt="Classic Cheese Fondue for Two  $64.99"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12">
	...
	<br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"><br>
	<img src="/media_stat/images/template/kitchen/xoxoxo.gif" width="47" height="9">
	<br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"><br>
	<img src="/media_stat/images/template/kitchen/title_seafood.gif" width="273" height="23" alt="Seafood Fondue for Two  $84.99"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12">
	...
	<img src="/media_stat/images/template/kitchen/xoxoxo.gif" width="47" height="9">
	<br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"><br>
	<img src="/media_stat/images/template/kitchen/title_meat.gif" width="254" height="23" alt="Meat Fondue for Two  $94.99"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="12">
	...
	<%-- spacer --%>
	<tr>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=(W_HOLIDAY2-24)/3%>" height="20"></td>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="12" height="20"></td>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=(W_HOLIDAY2-24)/3%>" height="20"></td>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="12" height="20"></td>
	<td><img src="/media_stat/images/layout/clear.gif" alt="" width="<%=(W_HOLIDAY2-24)/3%>" height="20"></td>
	</tr>
	<tr><td colspan="5"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr valign="middle"><td><img src="/media_stat/images/template/kitchen/hearts1.gif" width="109" height="7"><img src="/media_stat/images/template/kitchen/hearts1.gif" width="109" height="7"></td><td class="text13" align="center"><font face="Arial, Helvetica, sans-serif"><b>ALL OF OUR VALENTINE'S DAY FONDUE DINNERS ALSO INLUDE:</b></font></td><td align="right"><img src="/media_stat/images/template/kitchen/hearts1.gif" width="109" height="7"><img src="/media_stat/images/template/kitchen/hearts1.gif" width="109" height="7"></td></tr><tr><td colspan="3"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"></td></tr></table></td></tr>
	...
	<tr align="center" valign="top">
	<td class="text12">Crisp hearts of romaine lettuce with our special Caesar dressing, a bold blend of garlic, lemon, Dijon mustard, anchovy and olive oil. Topped with croutons and Parmesan cheese.</td>
	...
	<tr><td colspan="5" align="center"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="20">
	<br><img src="/media_stat/images/template/kitchen/hearts3.gif" width="970" height="7"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="3"></td></tr>
	...
	<br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8"></td></tr>
	<tr><td colspan="5" class="text15" align="center"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8"><br><b><span class="title16"><font face="Arial, Helvetica, sans-serif">PHONE ORDERS ONLY. $4.95 DELIVERY FEE.</font></span><br><font face="Arial, Helvetica, sans-serif">ORDERS MUST BE PLACED BY 6PM, FEBRUARY 11 FOR DELIVERY FEBRUARY 13 OR 14.</b></font><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="10"></td></tr>
	<tr><td colspan="5" align="center"><img src="/media_stat/images/template/kitchen/hearts3.gif" width="970" height="7"></td></tr>
	<tr><td colspan="5" align="center"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="10"><br>
	<img src="/media_stat/images/template/kitchen/fondue_made_easy.gif" width="402" height="61"><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="4"></td></tr>
	<tr valign="top">
	<td align="center"><img src="/media_stat/images/template/kitchen/step1.gif" width="196" height="143"></td>
	<td rowspan="3"></td>
	<td align="center"><img src="/media_stat/images/template/kitchen/step2.gif" width="196" height="143"></td>
	<td rowspan="3"></td>
	<td align="center"><img src="/media_stat/images/template/kitchen/step3.gif" width="196" height="143"></td>
	</tr>
	<tr><td><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="8"></td><td></td><td></td></tr>
	<tr valign="top">
	<td class="text12"><div align="center"><font face="Arial Black, Arial, sans-serif">STEP 1 : HEAT</font></div><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="5"><br>
	Heat cheese, oil or stock in a 
	small saucepot over low heat 
	until melted or simmering.</td>
	<td class="text12"><div align="center"><font face="Arial Black, Arial, sans-serif">STEP 2 : SET THE TABLE</font></div><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="5"><br>
	...
	<td class="text12"><div align="center"><font face="Arial Black, Arial, sans-serif">STEP 3 : FEEL THE LOVE</font></div><br><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="5"><br>
	...
	<tr><td colspan="5" align="center"><img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="14"><br><img src="/media_stat/images/template/kitchen/hearts3.gif" width="970" height="7"></td></tr>
	</table>
    </tmpl:put>	
</tmpl:insert>
