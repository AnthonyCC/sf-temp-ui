...
final int W_SURVEY_POST_ORDER_2_TOTAL = 970;
%>
...
<table width="<%=W_SURVEY_POST_ORDER_2_TOTAL%>" cellpadding="0" cellspacing="0" border="0" class="text12">
<% if (submitted) { %>
<tr>
	...
	<tr>
	    ...
	    <logic:iterate id="question" collection="<%= shownQuestions %>" type="com.freshdirect.fdstore.survey.FDSurveyQuestion" indexId='index'>
			...
			<% } else { %>
	            ...
	            <tr><td colspan="<%=subQuestion? "6" : "7"%>"><img src="/media_stat/images/layout/<%=subQuestion? "FFFFFF" : "999966"%>.gif" width="<%=subQuestion? W_SURVEY_POST_ORDER_2_TOTAL-105 : W_SURVEY_POST_ORDER_2_TOTAL-80%>" height="1" vspace="2"><%=isHeader?"<br><span class=\"space8pix\"><br></span>":""%></td></tr>
				<% int col = 0; %>
