...
<tmpl:insert template='/common/template/large_pop.jsp'>
	...
	<tr><td align="center" class="text12"><br><br><br><div style="font-size: 48px; font-face:Arial,Verdana,Helvetica;"><b>THANK YOU.</b></div><br>
    <%if("wine".equalsIgnoreCase(request.getParameter("department"))) {%>
    <div class="text12"><img src="/media_stat/images/template/newproduct/wine_request_img.jpg"><br><br><br><b>Your feedback is important to helping us improve.</b>
    <br>To continue shopping,  <a href="javascript:window.close();"><b>click here</b></a> to close this window.<br><br><br></div><br><br><br><br><br></td></tr>
    <%} else { %>
