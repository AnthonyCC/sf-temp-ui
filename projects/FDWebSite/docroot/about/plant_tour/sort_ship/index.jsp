...
<tr>
<td class="text12">
<div align="right"><a href=<%=(siteAccessPage==null || !siteAccessPage.equalsIgnoreCase("tour")) ? "/category.jsp?catId=about_tour_safety" : "/about/plant_tour/food_safety/index.jsp?siteAccessPage=tour&catId=about_tour_safety"%>><img src="/media_stat/images/template/about/plant_tour/sort_ship/sort_ship_next.gif" width="126" height="16" alt="Next - Food Safety" vspace="6" border="0"></a></div><span class="text15"><font color="#666666"><b>Click on the images below to enlarge.</b></font></span><br>
