...
<tr>
<td class="text12">
<div align="right"><a href=<%=(siteAccessPage==null || !siteAccessPage.equalsIgnoreCase("tour")) ? "/category.jsp?catId=about_tour_produce" : "/about/plant_tour/produce/index.jsp?siteAccessPage=tour&catId=about_tour_produce"%>><img src="/media_stat/images/template/about/plant_tour/seafood/seafood_next.gif" width="103" height="16" alt="Next - Produce" vspace="6" border="0"></a></div><span class="text15"><font color="#666666"><b>Click on the images below to enlarge.</b></font></span><br>
...
<tr>
<td><div align="right"><a href=<%=(siteAccessPage==null || !siteAccessPage.equalsIgnoreCase("tour")) ? "/category.jsp?catId=about_tour_produce" : "/about/plant_tour/produce/index.jsp?siteAccessPage=tour&catId=about_tour_produce"%>><img src="/media_stat/images/template/about/plant_tour/seafood/seafood_next.gif" width="103" height="16" alt="Next - Produce" vspace="6" border="0"></a></div></td>
</tr>
</table>
</tmpl:put>
</tmpl:insert>