...
<tr>
<td class="text12">
<div align="right"><a href=<%=(siteAccessPage==null || !siteAccessPage.equalsIgnoreCase("tour")) ? "/category.jsp?catId=about_tour_sorting" : "/about/plant_tour/sort_ship/index.jsp?siteAccessPage=tour&catId=about_tour_sorting"%>><img src="/media_stat/images/template/about/plant_tour/kitchen/kitchen_next.gif" width="97" height="16" alt="Next - Kitchen" vspace="6" border="0"></a></div><span class="text15"><font color="#666666"><b>Click on the images below to enlarge.</b></font></span><br>
