								...
								<table border="0" cellspacing="1" cellpadding="0" width="100%">
									...
									<tr valign="MIDDLE">
										<td colspan="4" <%= isCorporate ? "align=\"center\"" : ""%>>
											<br />
												<a href="#" onclick="doRemoteOverlay1('/registration/referee_address.jsp'); return false;"><img src="/media_stat/images/buttons/check_my_address.gif" height="16" width="112" border="0"></a>
										</td>
									</tr>
								</table>
