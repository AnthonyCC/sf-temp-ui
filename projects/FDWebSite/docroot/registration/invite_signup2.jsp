...
<%
	System.out.println("**********Inside Invite 2***********"+request.getRequestURI());
...
<%-- 			
			...
			<a href="#" onclick="doRemoteOverlay1('invite_signup2.jsp'); return false;"><img src="/media_stat/images/profile/start_shopping.jpg" border="0"></a>
		</form>
	</div>
	</div>
	<% } } %>
