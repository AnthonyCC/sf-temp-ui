...
<%
	String successPage = "/request_product_test.jsp?success=true" + ((request.getQueryString() != null) ? "" : "&" + request.getQueryString());
...
<fd:RequestAProductNewTag actionName="requestProducts" result="result" successPage="<%= successPage %>">
	request.getParameter("success") : <%=request.getParameter("success") %><br />
	<% if (request.getParameter("success") != null && "true".equals((String)request.getParameter("success")) ) { %>
