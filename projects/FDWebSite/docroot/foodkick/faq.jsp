...
<tmpl:insert template='includes/fklayout_tmpl.jsp'>
	...
	<tmpl:put name='content'>
		...
		<script type="text/javascript">
			cmCreatePageviewTag("FAQ: faq.jsp","FDX_FAQ",null,null,"-_--_-FAQ: faq.jsp-_--_--_--_-FAQ: faq.jsp");
			FreshDirect.Coremetrics.populateTrackingObject("FAQ: faq.jsp","FAQ: faq.jsp-_--_--_-","");
		</script>
