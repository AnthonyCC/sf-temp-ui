...
<tmpl:insert template='includes/fklayout_tmpl.jsp'>
	...
	<tmpl:put name='content'>
		...
		<script type="text/javascript">
			cmCreatePageviewTag("ABOUTUS: about_us.jsp","FDX_ABOUTUS",null,null,"-_--_-ABOUTUS: about_us.jsp-_--_--_--_-ABOUTUS: about_us.jsp");
			FreshDirect.Coremetrics.populateTrackingObject("ABOUTUS: about_us.jsp","ABOUTUS: about_us.jsp-_--_--_-","");
		</script>
