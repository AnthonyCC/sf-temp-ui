...
<A NAME="top"></A>
				...
				<TR VALIGN="TOP">
					...
					FreshDirect At The Office brings area businesses the same great, fresh food that's made FreshDirect indispensable for tens of thousands of New York households, with expanded product and service offerings especially for corporate clients. These include:<br><br></td></tr>
							...
							<tr><td class="bodyCopy" colspan="2">
								<ul>
									<li>Chef-prepared breakfast and luncheon catering platters perfect for business meetings;</li>
									<li>Popular brands of snacks, beverages, and pantry-stocking items;</li>
									<li>Delicious restaurant-quality individual meals;</li>
									<li>Catering services for upscale events;</li>
									<li>Convenient morning and afternoon delivery windows;</li>
									<li>Dedicated corporate account manager and customer service representatives.</li>
									<li>Where does FreshDirect deliver?</li>
								</ul>
							</td></tr>

							<tr><td class="bodyCopy" colspan="2">
								<img src="/media_stat/images/layout/cccccc.gif" width="${tableWidth}" height="1" alt="" border="0" vspace="14">
							</td></tr>
							...
							<tr><td class="bodyCopy" colspan="2">
								<ul>
									...
									<li><A HREF="#question5">Will FreshDirect set up for my meeting or event?</A></li>
									<li><A HREF="#question6">Is there a charge for delivery?</A></li>
									<li><A HREF="#question_fuel">What is the Fuel Surcharge?</A></li>
									<li><A HREF="#question7">Should I tip the driver?</A></li>
									<li><A HREF="#question8">What if no one is available to receive the order?</A></li>
									<li><A HREF="#question9">How long  delivery boxes?</A></li>
			...
			<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="${tableWidth}" class="bodyCopy">
				<TR VALIGN="TOP">
					...
					<TD WIDTH="${tableWidth}" class="bodyCopy">
						...
						We currently deliver to downtown areas of Manhattan but will soon be expanding throughout Manhattan, as well as to parts of Brooklyn and Queens. Call us at ${customerServiceContact} to find out if we deliver to your office.<br>
				   </TD>
				</TR>
			</TABLE>
			<br><img src="/media_stat/images/layout/clear.gif" width="1" height="4" alt="" border=0><br>
			...
			<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="${tableWidth}" class="bodyCopy">
				<TR VALIGN="TOP" class="bodyCopy">
					...
					<TD WIDTH="${tableWidth}" class="bodyCopy">
						...
						<br>
						${helper.includeMedia("/media/editorial/site_pages/cos_delivery_plan_table.html", parameters)}
				   </TD>
				</TR>
			</TABLE>
			<br><img src="/media_stat/images/layout/clear.gif" width="1" height="4" alt="" border=0><br>
			...
			<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="${tableWidth}" class="bodyCopy">
				<TR VALIGN="TOP">
					...
					<TD WIDTH="${tableWidth}" class="bodyCopy">
						...
						<br><br>
						If anything is wrong with your order, please contact FreshDirect Customer Service right away at ${customerServiceContact}.
						<br>
				   </TD>
				</TR>
			</TABLE>
			...
			<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="${tableWidth}" class="bodyCopy">
				<TR VALIGN="TOP">
					...
					<TD WIDTH="${tableWidth}" class="bodyCopy">	
						...
						Delivery costs &#36;${corpDeliveryFee}. The minimum order is &#36;${minCorpOrderAmount}.<br>
				   </TD>
				</TR>
			</TABLE>
			<br><img src="/media_stat/images/layout/clear.gif" width="1" height="4" alt="" border=0><br>
			...
			<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="${tableWidth}" class="bodyCopy">
				<TR VALIGN="TOP">
					<TD WIDTH="15"><img src="/media/images/layout/clear.gif" width="15" height="1" alt="" border="0"></TD>
					<TD WIDTH="${tableWidth}" class="bodyCopy"><A HREF="#top"><img src="/media_stat/images/template/help/up_arrow.gif" width="17" height="9" hspace="0" vspace="4" alt="" border="0" align="left"><img src="/media/images/layout/clear.gif" width="6" height="1" border="0">top of page</A>
						<br><br><br>			
				   </TD>
				</TR>
			</TABLE>
