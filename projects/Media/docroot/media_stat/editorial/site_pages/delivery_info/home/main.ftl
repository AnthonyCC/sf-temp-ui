...
<br><br>
${helper.includeMedia("/media/editorial/site_pages/delivery_time_text.html", parameters)}
<br><br>
...
<br>
<img src="/media_stat/images/layout/clear.gif" alt="" width="1" height="18">
<div align="center">
	<a href="javascript:popup('/help/faq_index.jsp?show=delivery','large')"><b>Learn More - Click here for our Home Delivery FAQs</b></a>
</div>
<br><br><br>
