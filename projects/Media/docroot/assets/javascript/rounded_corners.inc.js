  ...
  */
  function curvyCorners()
  {
      ...
      // Reapplies the curvyCorners to all objects
      this.reapplyCornersToAll = function()
      {
          for(var x = 0, k = this.objects.length; x < k; x++)
          {
              this.objects[x].reapplyCorners();
          }
      }
  ...
  function curvyObject()
  {
	  ...
	  this.reapplyCorners = function() {
	  	if (this.topContainer) {
	  		this.box.removeChild(this.topContainer);
	  		this.box.appendChild(this.topContainer);	  		
	  	}
	  	if (this.bottomContainer) {
	  		this.box.removeChild(this.bottomContainer);
	  		this.box.appendChild(this.bottomContainer);	  		
	  	}
	  }
              ...
              if(i > -1 < 4)
              {
                  ...
                  if(!this.settings[cc])
                  {
                      ...
                      if(((cc == "tr" || cc == "tl") && this.topContainer != null) || ((cc == "br" || cc == "bl") && this.bottomContainer != null))
                      {
                          ...
                          {
                              case "tl":
                              	  if (this.settings.topColour) newCorner.style.backgroundColor = this.settings.topColour;
                              ...
                              case "bl":
                              	  if (this.settings.bottomColour) newCorner.style.backgroundColor = this.settings.bottomColour;
                  ...
                  else
                  {
                      ...
                      */
                      if(this.masterCorners[this.settings[cc].radius] && !(this.settings.topColour || this.settings.bottomColour))
                      {
                      ...
                      else
                      {
                          ...
                          newCorner.style.fontSize = "1px";
                          newCorner.style.overflow = "hidden";
                          var cornerColour = this.boxColour;
                          if (this.settings.topColour && (cc == "tl" || cc == "tr")) {
                          	cornerColour  = this.settings.topColour;
                          }
                          if (this.settings.bottomColour && (cc == "bl" || cc == "br")) {
                          	cornerColour  = this.settings.bottomColour;
                          }
                          ...
                          for(var intx = 0, j = this.settings[cc].radius; intx < j; intx++)
                          {
                              ...
                              if(y1 > -1) this.drawPixel(intx, 0, cornerColour, 100, (y1+1), newCorner, -1, this.settings[cc].radius);
                              ...
                              if(borderRadius != j)
                              {
                                  ...
                                  for(var inty = (y1 + 1); inty < y2; inty++)
                                  {
                                      ...
                                      if(this.settings.antiAlias)
                                      {
                                          ...
                                          {
                                              var pixelcolour = BlendColour(cornerColour, this.borderColour, pixelFraction(intx, inty, borderRadius));
                              ...
                              else
                              {
                                  ...
                                  var outsideColour = cornerColour;
                                  var y3 = y1;
                              }
                  ...
                  switch(z)
                  {
                      case "t":
                          ...
                          if(this.topContainer)
                          {
                              ...
                              {
                              	  if (this.settings.topColour) newFillerBar.style.backgroundColor = this.settings.topColour;
                      ...
                      case "b":
                          if(this.bottomContainer)
                          {
                              ...
                              {
                                  // Bottom Bar
                              	  if (this.settings.bottomColour) newFillerBar.style.backgroundColor = this.settings.bottomColour;
