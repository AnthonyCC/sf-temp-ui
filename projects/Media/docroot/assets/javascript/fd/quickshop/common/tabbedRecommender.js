...
(function (fd) {
	...
	tabbedRecommender.selectTab($('[data-component="tabbedRecommender"]'),firstTab.data('tabname'),firstTab);
	$(document).on('click','[data-component="tabbedRecommender"]',tabbedRecommender.clickHandler.bind(tabbedRecommender));	
	
	fd.modules.common.utils.register("quickshop.common", "tabbedRecommender", tabbedRecommender, fd);
}(FreshDirect));
