/*
 overlibmws_scroll.js plug-in module - Copyright Foteos Macrides 2002-2005.
  ...
  Initial: October 20, 2002 - Last Revised: November 2, 2004
...
if(o3_scroll){if(!OLshowingsticky||(OLdraggablePI&&o3_draggable&&o3_frame==self)||
...
if(o3_scroll&&over&&over==OLgetRefById('overDiv')){
...
if(OLiframePI)OLrepositionIfs(pgLeft+over.scroll.x,pgTop+over.scroll.y);
