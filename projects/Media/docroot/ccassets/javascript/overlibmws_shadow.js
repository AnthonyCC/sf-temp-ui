...
OLloaded=0;
OLshadowCmds='shadow,shadowx,shadowy,shadowcolor,shadowimage,shadowopacity';
...
if(OLie55&&OLfilterPI&&o3_filtershadow){o3_shadow=0;return}var o;
if(!(o=OLmkLyr('backdrop',o3_frame,999))||bkdrop!=o){bkdrop=null;OLgetShadowLyrRef();}
}

function OLgetShadowLyrRef(){
if(bkdrop||!o3_shadow)return;
bkdrop=OLgetRefById('backdrop');
...
var o=bkdrop.style;
o.backgroundColor='transparent';o.backgroundImage='none';
if(OLie4&&!OLieM&&typeof o.filter=='string'){
