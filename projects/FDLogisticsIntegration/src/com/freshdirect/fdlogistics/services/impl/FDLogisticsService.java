...
public class FDLogisticsService extends AbstractLogisticsService implements ILogisticsService {
	...
	private static final String STATUS_FDX_ORDER_DISPATCH_API="/order/dispatchorder";
	...
	@Override
	public Result isDispatched(CreateOrderRequest request) throws FDLogisticsServiceException{
		String inputJson = buildRequest(request);
		Result response = getData(inputJson, getEndPoint(STATUS_FDX_ORDER_DISPATCH_API), Result.class);
		return response;
	}
