 ...
 */
public class FDDeliveryZoneCapacityInfo implements Serializable {
	
	private final String zoneCode;
	private final int totalCapacity;
	private final int remainingCapacity;
	
	public FDDeliveryZoneCapacityInfo (String zoneCode, int totalCapacity, int remainingCapacity) {
