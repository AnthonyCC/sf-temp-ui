package com.freshdirect.routing.util.json;
...
public class CrisisManagerJSONSerializer extends AbstractSerializer {
	...
	private static Class<?>[] _serializableClasses = new Class[] { EnumDeliveryType.class, 
		EnumReservationType.class, ReservationModel.class, StandingOrderModel.class, GenericSearchModel.class};

	private static Class<?>[] _JSONClasses = new Class[] { JSONObject.class };

	
	private static Serializer instance = new CrisisManagerJSONSerializer();

	private boolean appendClassInfo = true;
	
	/** Use getInstance() */
	private CrisisManagerJSONSerializer() {}
