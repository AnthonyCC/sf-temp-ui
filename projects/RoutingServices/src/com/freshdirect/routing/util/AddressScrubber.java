...
public class AddressScrubber {
    ...
    public static String standardizeForUSPS(String streetAddress) throws RoutingServiceException {
        return standardize(streetAddress, false, false,false);
    }
    
    public static String standardizeForGeocode(String streetAddress) throws RoutingServiceException {
        return standardize(streetAddress, true, false,isNewGeocodeFormat());
    }
        
    public static String standardizeForGeocodeNoSubstitution(String streetAddress) throws RoutingServiceException {
        return standardize(streetAddress, true, true,isNewGeocodeFormat());
    }

    private static String standardize(String address, boolean forGeocode, boolean canReverseDirections,boolean isNewFormat) throws RoutingServiceException {
    	if (address == null) {
            throw new RoutingServiceException(null, "Invalid address :" + address);
        }
    	//
        ...
        if (numBreak == -1) {
            throw new RoutingServiceException(null, "Invalid address :" + streetAddress);
        }
        ...
        try {
            ...
            if (!isNumber) {
                ...
                //
                throw new RoutingServiceException(null, "Unable to find a building number in : " + address);
            }
        }
    ...
    public static String cleanBldgNum(String bldgNum) {
		StringBuffer clean = new StringBuffer();
    ...
    public static String[] getZipCodeFromAddress(AddressModel addressModel) {
