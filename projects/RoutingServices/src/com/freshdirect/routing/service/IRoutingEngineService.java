...
public interface IRoutingEngineService {
	...
	List<EquipmentType> getEquipmentTypes(String region) throws RoutingServiceException;
	
	List<IRouteModel> getRoutesByCriteria(IRoutingSchedulerIdentity schedulerId, String waveCode)  throws RoutingServiceException;
