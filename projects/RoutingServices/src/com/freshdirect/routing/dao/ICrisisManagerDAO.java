...
public interface ICrisisManagerDAO {
	...
	List<ICrisisManagerBatchOrder> getOrderByCriteria(Date deliveryDate, Date cutOffDateTime
			, String[] area, Date startTime, Date endTime, String[] deliveryType, boolean isSOIncluded) throws SQLException;
	...
	List<ICrisisManagerBatchReservation> getReservationByCriteria(Date deliveryDate, Date cutOffDateTime, String[] area, Date startTime, Date endTime) throws SQLException;
