...
/**
 * RetrieveRoutingSourcedOrdersByCriteriaResponse.java
 *
 ...
 */
            ...
            /**
            *  RetrieveRoutingSourcedOrdersByCriteriaResponse bean class
            */
        
        public  class RetrieveRoutingSourcedOrdersByCriteriaResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                "RetrieveRoutingSourcedOrdersByCriteriaResponse",
                "ns1");
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RetrieveRoutingSourcedOrdersByCriteriaResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RetrieveRoutingSourcedOrdersByCriteriaResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RetrieveRoutingSourcedOrdersByCriteriaResponse",
    ...
    public static class Factory{
        ...
        */
        public static RetrieveRoutingSourcedOrdersByCriteriaResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrieveRoutingSourcedOrdersByCriteriaResponse object =
                new RetrieveRoutingSourcedOrdersByCriteriaResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RetrieveRoutingSourcedOrdersByCriteriaResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetrieveRoutingSourcedOrdersByCriteriaResponse)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.freshdirect.routing.proxy.stub.transportation.RoutingOrder.Factory.parse(reader));
