 ...
 */
            ...
            /**
            *  RouteExceptionCriteria bean class
            */
        
        public  class RouteExceptionCriteria
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RouteExceptionCriteria
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for MinimumTimestamp
                        */

                        
                                    protected java.util.Calendar localMinimumTimestamp ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMinimumTimestampTracker = false ;
                           ...
                           */
                           public  java.util.Calendar getMinimumTimestamp(){
                               return localMinimumTimestamp;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MinimumTimestamp
                               */
                               public void setMinimumTimestamp(java.util.Calendar param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localMinimumTimestampTracker = true;
                                       } else {
                                          localMinimumTimestampTracker = false;
                                              
                                       }
                                   
                                            this.localMinimumTimestamp=param;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAcknowledgedTracker = false ;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RouteExceptionCriteria.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RouteExceptionCriteria",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RouteExceptionCriteria",
                           xmlWriter);
                   }
                ...
                if (localRegionIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localMinimumTimestampTracker){
                                    namespace = "http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"minimumTimestamp", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"minimumTimestamp");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("minimumTimestamp");
                                    }
                                

                                          if (localMinimumTimestamp==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("minimumTimestamp cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMinimumTimestamp));
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localRegionIDTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                                        ...
                                        if (localMinimumTimestamp != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMinimumTimestamp));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("minimumTimestamp cannot be null!!");
                                        }
                                    } if (localAcknowledgedTracker){
    ...
    public static class Factory{
        ...
        */
        public static RouteExceptionCriteria parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RouteExceptionCriteria object =
                new RouteExceptionCriteria();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RouteExceptionCriteria".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RouteExceptionCriteria)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","minimumTimestamp").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMinimumTimestamp(
