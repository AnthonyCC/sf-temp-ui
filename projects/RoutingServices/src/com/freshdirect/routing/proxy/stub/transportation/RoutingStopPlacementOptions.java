...
/**
 * RoutingStopPlacementOptions.java
 *
 ...
 */
            ...
            /**
            *  RoutingStopPlacementOptions bean class
            */
        
        public  class RoutingStopPlacementOptions
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RoutingStopPlacementOptions
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.transportation.RoutingStopPlacementType localPlacementType ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.freshdirect.routing.proxy.stub.transportation.RoutingStopPlacementType
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.RoutingStopPlacementType getPlacementType(){
                            ...
                            /**
                               ...
                               */
                               public void setPlacementType(com.freshdirect.routing.proxy.stub.transportation.RoutingStopPlacementType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RoutingStopPlacementOptions.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RoutingStopPlacementOptions",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RoutingStopPlacementOptions",
                           xmlWriter);
                   }
                                           ...
                                           localPlacementType.serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","placementType"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static RoutingStopPlacementOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RoutingStopPlacementOptions object =
                new RoutingStopPlacementOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RoutingStopPlacementOptions".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RoutingStopPlacementOptions)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","placementType").equals(reader.getName())){
                                
                                                object.setPlacementType(com.freshdirect.routing.proxy.stub.transportation.RoutingStopPlacementType.Factory.parse(reader));
