                                   ...
                                   xmlWriter.writeEndElement();
                                       ...
                                       if (localVec!=null){
                                            for (int i = 0;i < localVec.length;i++){
                                                if (localVec[i] != null){
                                                 localVec[i].serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","vec"),
                                                           factory,xmlWriter);
                                                } else {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","str").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","vec").equals(reader.getName())){
                                    ...
                                    list2.add(com.freshdirect.routing.proxy.stub.roadnet.MapArcOverride.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","vec").equals(reader.getName())){
                                                                    list2.add(com.freshdirect.routing.proxy.stub.roadnet.MapArcOverride.Factory.parse(reader));
