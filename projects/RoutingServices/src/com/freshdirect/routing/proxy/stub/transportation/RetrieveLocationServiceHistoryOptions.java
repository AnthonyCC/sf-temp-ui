...
/**
 * RetrieveLocationServiceHistoryOptions.java
 *
 ...
 */
            ...
            /**
            *  RetrieveLocationServiceHistoryOptions bean class
            */
        
        public  class RetrieveLocationServiceHistoryOptions
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RetrieveLocationServiceHistoryOptions
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for MaximumServiceDate
                        */

                        
                                    protected java.util.Calendar localMaximumServiceDate ;
                           ...
                           */
                           public  java.util.Calendar getMaximumServiceDate(){
                               return localMaximumServiceDate;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MaximumServiceDate
                               */
                               public void setMaximumServiceDate(java.util.Calendar param){
                            
                                            this.localMaximumServiceDate=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RetrieveLocationServiceHistoryOptions.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RetrieveLocationServiceHistoryOptions",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RetrieveLocationServiceHistoryOptions",
                           xmlWriter);
                   }
                ...
                if (localLocationIdentityTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"maximumServiceDate", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"maximumServiceDate");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("maximumServiceDate");
                                    }
                                

                                          if (localMaximumServiceDate==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("maximumServiceDate cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumServiceDate));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                                    ...
                                    localLocationIdentity);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                                        ...
                                        if (localMaximumServiceDate != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumServiceDate));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("maximumServiceDate cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static RetrieveLocationServiceHistoryOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrieveLocationServiceHistoryOptions object =
                new RetrieveLocationServiceHistoryOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RetrieveLocationServiceHistoryOptions".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetrieveLocationServiceHistoryOptions)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","maximumServiceDate").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMaximumServiceDate(
