 ...
 */
        ...
        public  class LocationServiceDetails extends com.freshdirect.routing.proxy.stub.transportation.KeyValuePairCollection
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","LocationServiceDetails"));
                 if (localPairsTracker){
                             if (localPairs!=null) {
                                 for (int i = 0;i < localPairs.length;i++){
