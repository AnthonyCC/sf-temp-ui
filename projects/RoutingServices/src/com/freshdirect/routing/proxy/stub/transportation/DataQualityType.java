 ...
 */
            ...
            /**
            *  DataQualityType bean class
            */
        
        public  class DataQualityType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for DataQualityType
                        */

                        
                                    protected java.lang.String localDataQualityType ;
                                
                            private static java.util.HashMap _table_ = new java.util.HashMap();

                            // Constructor
                            
                                protected DataQualityType(java.lang.String value, boolean isRegisterValue) {
                                    localDataQualityType = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localDataQualityType, this);
                                           
                                    }

                                }
                            
                                    public static final java.lang.String _dqtUnknown =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("dqtUnknown");
                                    ...
                                    public static final java.lang.String _dqtDispatcherEntered =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("dqtDispatcherEntered");
                                
                                    public static final java.lang.String _dqtAutoCaptured =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("dqtAutoCaptured");
                                ...
                                public static final DataQualityType dqtDispatcherEntered =
                                    new DataQualityType(_dqtDispatcherEntered,true);
                            
                                public static final DataQualityType dqtAutoCaptured =
                                    new DataQualityType(_dqtAutoCaptured,true);
                                ...
                                public java.lang.String toString() {
                                        ...
                                        return localDataQualityType.toString();
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DataQualityType.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                               ...
                               if (serializeType){
                                   ...
                                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                                       ...
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                          ...
                                          if (localDataQualityType==null){
                                            
                                                     throw new org.apache.axis2.databinding.ADBException("Value cannot be null !!");
                                                
                                         }else{
                                        
                                                       xmlWriter.writeCharacters(localDataQualityType);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataQualityType)
                            },
                            null);
    ...
    public static class Factory{
                ...
                public static DataQualityType fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static DataQualityType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return DataQualityType.Factory.fromString(content,namespaceUri);
                    } else {
                       return DataQualityType.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static DataQualityType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DataQualityType object = null;
                    ...
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        if (content.indexOf(":") > 0) {
                                            ...
                                            object = DataQualityType.Factory.fromString(content,namespaceuri);
                                        } else {
                                            // this seems to be not a qname send and empty namespace incase of it is
                                            // check is done in fromString method
                                            object = DataQualityType.Factory.fromString(content,"");
                                        }
