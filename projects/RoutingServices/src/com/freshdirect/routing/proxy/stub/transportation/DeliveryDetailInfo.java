                                       ...
                                       if (localDeliveryDetails!=null){
                                            for (int i = 0;i < localDeliveryDetails.length;i++){
                                                if (localDeliveryDetails[i] != null){
                                                 localDeliveryDetails[i].serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","deliveryDetails"),
                                                           factory,xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","DeliveryDetailInfo"));
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","deliveryDetails").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list4.add(com.freshdirect.routing.proxy.stub.transportation.DeliveryDetailItem.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","deliveryDetails").equals(reader.getName())){
                                                                    list4.add(com.freshdirect.routing.proxy.stub.transportation.DeliveryDetailItem.Factory.parse(reader));
