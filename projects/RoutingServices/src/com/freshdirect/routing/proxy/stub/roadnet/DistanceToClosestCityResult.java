 ...
 */
            ...
            /**
            *  DistanceToClosestCityResult bean class
            */
        
        public  class DistanceToClosestCityResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DistanceToClosestCityResult
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.roadnet.MapCardinalDirection localDirection ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.freshdirect.routing.proxy.stub.roadnet.MapCardinalDirection
                           */
                           public  com.freshdirect.routing.proxy.stub.roadnet.MapCardinalDirection getDirection(){
                            ...
                            /**
                               ...
                               */
                               public void setDirection(com.freshdirect.routing.proxy.stub.roadnet.MapCardinalDirection param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DistanceToClosestCityResult.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DistanceToClosestCityResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DistanceToClosestCityResult",
                           xmlWriter);
                   }
                                           ...
                                           localDirection.serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","direction"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static DistanceToClosestCityResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DistanceToClosestCityResult object =
                new DistanceToClosestCityResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DistanceToClosestCityResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DistanceToClosestCityResult)com.freshdirect.routing.proxy.stub.roadnet.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","direction").equals(reader.getName())){
                                
                                                object.setDirection(com.freshdirect.routing.proxy.stub.roadnet.MapCardinalDirection.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","city").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/RouteNetWebService","region").equals(reader.getName())){
