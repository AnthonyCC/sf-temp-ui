 ...
 */
            ...
            /**
            *  ChangedOrderFinancialDetailIdentity bean class
            */
        
        public  class ChangedOrderFinancialDetailIdentity extends com.freshdirect.routing.proxy.stub.transportation.OrderIdentity
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ChangedOrderFinancialDetailIdentity
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for InternalFinancialDetailID
                        */

                        
                                    protected int localInternalFinancialDetailID =
                           ...
                           */
                           public  int getInternalFinancialDetailID(){
                               return localInternalFinancialDetailID;
                           }
                            ...
                            /**
                               ...
                               * @param param InternalFinancialDetailID
                               */
                               public void setInternalFinancialDetailID(int param){
                            
                                            this.localInternalFinancialDetailID=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ChangedOrderFinancialDetailIdentity.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ChangedOrderFinancialDetailIdentity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ChangedOrderFinancialDetailIdentity",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"internalFinancialDetailID", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"internalFinancialDetailID");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("internalFinancialDetailID");
                                    }
                                
                                               if (localInternalFinancialDetailID==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("internalFinancialDetailID cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInternalFinancialDetailID));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","ChangedOrderFinancialDetailIdentity"));
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInternalStopID));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                                                                      "internalFinancialDetailID"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInternalFinancialDetailID));
    ...
    public static class Factory{
        ...
        */
        public static ChangedOrderFinancialDetailIdentity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ChangedOrderFinancialDetailIdentity object =
                new ChangedOrderFinancialDetailIdentity();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ChangedOrderFinancialDetailIdentity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChangedOrderFinancialDetailIdentity)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","internalFinancialDetailID").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setInternalFinancialDetailID(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
