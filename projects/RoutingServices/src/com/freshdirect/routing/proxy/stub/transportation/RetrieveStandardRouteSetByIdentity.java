...
/**
 * RetrieveStandardRouteSetByIdentity.java
 *
 ...
 */
            ...
            /**
            *  RetrieveStandardRouteSetByIdentity bean class
            */
        
        public  class RetrieveStandardRouteSetByIdentity
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                "RetrieveStandardRouteSetByIdentity",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.transportation.StandardRouteSetIdentity localIdentity ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.StandardRouteSetIdentity getIdentity(){
                            ...
                            /**
                               ...
                               */
                               public void setIdentity(com.freshdirect.routing.proxy.stub.transportation.StandardRouteSetIdentity param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RetrieveStandardRouteSetByIdentity.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RetrieveStandardRouteSetByIdentity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RetrieveStandardRouteSetByIdentity",
    ...
    public static class Factory{
        ...
        */
        public static RetrieveStandardRouteSetByIdentity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrieveStandardRouteSetByIdentity object =
                new RetrieveStandardRouteSetByIdentity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RetrieveStandardRouteSetByIdentity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetrieveStandardRouteSetByIdentity)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setIdentity(com.freshdirect.routing.proxy.stub.transportation.StandardRouteSetIdentity.Factory.parse(reader));
