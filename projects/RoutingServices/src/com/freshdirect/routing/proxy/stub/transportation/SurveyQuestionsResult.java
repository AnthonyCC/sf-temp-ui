                                   ...
                                   xmlWriter.writeEndElement();
                                       ...
                                       if (localDefs!=null){
                                            for (int i = 0;i < localDefs.length;i++){
                                                if (localDefs[i] != null){
                                                 localDefs[i].serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","defs"),
                                                           factory,xmlWriter);
                                                } else {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","defs").equals(reader.getName())){
                                    ...
                                    list2.add(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","defs").equals(reader.getName())){
                                                                    list2.add(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition.Factory.parse(reader));
