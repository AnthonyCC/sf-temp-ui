 ...
 */
            ...
            /**
            *  RoutingOrderActivity bean class
            */
        
        public  class RoutingOrderActivity
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RoutingOrderActivity
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for OrderActivityIdentity
                        */

                        
                                    protected com.freshdirect.routing.proxy.stub.transportation.RoutingOrderActivityIdentity localOrderActivityIdentity ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localOrderActivityIdentityTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return com.freshdirect.routing.proxy.stub.transportation.RoutingOrderActivityIdentity
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.RoutingOrderActivityIdentity getOrderActivityIdentity(){
                               return localOrderActivityIdentity;
                           }
                            ...
                            /**
                               ...
                               * @param param OrderActivityIdentity
                               */
                               public void setOrderActivityIdentity(com.freshdirect.routing.proxy.stub.transportation.RoutingOrderActivityIdentity param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localOrderActivityIdentityTracker = true;
                                       } else {
                                          localOrderActivityIdentityTracker = true;
                                              
                                       }
                                   
                                            this.localOrderActivityIdentity=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RoutingOrderActivity.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RoutingOrderActivity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RoutingOrderActivity",
                           xmlWriter);
                   }

               
                   }
                if (localOrderActivityIdentityTracker){
                                    if (localOrderActivityIdentity==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"orderActivityIdentity", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"orderActivityIdentity");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("orderActivityIdentity");
                                        }
                                     ...
                                     localOrderActivityIdentity.serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","orderActivityIdentity"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localOrderActivityIdentityTracker){
                            elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                                                      "orderActivityIdentity"));
                            
                            
                                    elementList.add(localOrderActivityIdentity==null?null:
                                    localOrderActivityIdentity);
                                } if (localOrderIdentityTracker){
                            elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                                                      "orderIdentity"));
    ...
    public static class Factory{
        ...
        */
        public static RoutingOrderActivity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RoutingOrderActivity object =
                new RoutingOrderActivity();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RoutingOrderActivity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RoutingOrderActivity)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","orderActivityIdentity").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setOrderActivityIdentity(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setOrderActivityIdentity(com.freshdirect.routing.proxy.stub.transportation.RoutingOrderActivityIdentity.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","orderID").equals(reader.getName())){
