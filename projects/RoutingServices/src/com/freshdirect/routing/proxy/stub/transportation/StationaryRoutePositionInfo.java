...
/**
 * StationaryRoutePositionInfo.java
 *
 ...
 */
            ...
            /**
            *  StationaryRoutePositionInfo bean class
            */
        
        public  class StationaryRoutePositionInfo extends com.freshdirect.routing.proxy.stub.transportation.RoutePositionInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = StationaryRoutePositionInfo
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for ServiceRadius
                        */

                        
                                    protected double localServiceRadius ;
                           ...
                           */
                           public  double getServiceRadius(){
                            ...
                            /**
                               ...
                               * @param param ServiceRadius
                               */
                               public void setServiceRadius(double param){
                            
                                            this.localServiceRadius=param;
                        ...
                        /**
                        * field for DistanceThreshold
                        */

                        
                                    protected double localDistanceThreshold ;
                           ...
                           */
                           public  double getDistanceThreshold(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DistanceThreshold
                               */
                               public void setDistanceThreshold(double param){
                            
                                            this.localDistanceThreshold=param;
                        ...
                        */
                                    ...
                                    protected java.util.Calendar localArrivalTime ;
                           ...
                           */
                           public  java.util.Calendar getArrivalTime(){
                            ...
                            /**
                               ...
                               */
                               public void setArrivalTime(java.util.Calendar param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       StationaryRoutePositionInfo.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StationaryRoutePositionInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StationaryRoutePositionInfo",
                           xmlWriter);
                   }
                                    ...
                                    if (localTimeZoneOptions==null){
                                     ...
                                     localTimeZoneOptions.serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","timeZoneOptions"),
                                        factory,xmlWriter);
                                           ...
                                           localUnitOfSpeed.serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","unitOfSpeed"),
                                               factory,xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"serviceRadius", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"serviceRadius");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("serviceRadius");
                                    }
                                
                                               if (java.lang.Double.isNaN(localServiceRadius)) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("serviceRadius cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localServiceRadius));
                                               }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"distanceThreshold", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"distanceThreshold");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("distanceThreshold");
                                    }
                                
                                               if (java.lang.Double.isNaN(localDistanceThreshold)) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("distanceThreshold cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDistanceThreshold));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","StationaryRoutePositionInfo"));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localServiceRadius));
                            
                                      elementList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService",
                                                                      "distanceThreshold"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDistanceThreshold));
    ...
    public static class Factory{
        ...
        */
        public static StationaryRoutePositionInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StationaryRoutePositionInfo object =
                new StationaryRoutePositionInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StationaryRoutePositionInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StationaryRoutePositionInfo)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","positionTime").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","unitOfSpeed").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","speed").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","serviceRadius").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setServiceRadius(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","distanceThreshold").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setDistanceThreshold(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(content));
