        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.transportation.MapPoint[] localVertices ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.MapPoint[] getVertices(){
                               ...
                               */
                              protected void validateVertices(com.freshdirect.routing.proxy.stub.transportation.MapPoint[] param){
                              ...
                              */
                              public void setVertices(com.freshdirect.routing.proxy.stub.transportation.MapPoint[] param){
                             ...
                             * @param param com.freshdirect.routing.proxy.stub.transportation.MapPoint
                             */
                             public void addVertices(com.freshdirect.routing.proxy.stub.transportation.MapPoint param){
                                   if (localVertices == null){
                                   localVertices = new com.freshdirect.routing.proxy.stub.transportation.MapPoint[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localVertices);
                               list.add(param);
                               this.localVertices =
                             (com.freshdirect.routing.proxy.stub.transportation.MapPoint[])list.toArray(
                            new com.freshdirect.routing.proxy.stub.transportation.MapPoint[list.size()]);
                                       ...
                                       if (localVertices!=null){
                                            for (int i = 0;i < localVertices.length;i++){
                                                if (localVertices[i] != null){
                                                 localVertices[i].serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","vertices"),
                                                           factory,xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DirectionArc".equals(type)){
                                ...
                                return (DirectionArc)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","instruction").equals(reader.getName())){
