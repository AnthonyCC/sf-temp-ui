 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition[] localQuestions ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition[] getQuestions(){
                               ...
                               */
                              protected void validateQuestions(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition[] param){
                              ...
                              */
                              public void setQuestions(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition[] param){
                             ...
                             */
                             public void addQuestions(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition param){
                                   if (localQuestions == null){
                                   localQuestions = new com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition[]{};
                                   }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SurveyDetails.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                       ...
                                       if (localQuestions!=null){
                                            for (int i = 0;i < localQuestions.length;i++){
                                                if (localQuestions[i] != null){
                                                 localQuestions[i].serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","questions"),
                                                           factory,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static SurveyDetails parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SurveyDetails".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SurveyDetails)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setIdentity(com.freshdirect.routing.proxy.stub.transportation.SurveyIdentity.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","code").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","questions").equals(reader.getName())){
                                    ...
                                    list4.add(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","questions").equals(reader.getName())){
                                                                    list4.add(com.freshdirect.routing.proxy.stub.transportation.QuestionDefinition.Factory.parse(reader));
