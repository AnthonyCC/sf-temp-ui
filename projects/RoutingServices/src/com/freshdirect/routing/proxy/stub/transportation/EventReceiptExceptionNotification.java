 ...
 */
            ...
            /**
            *  EventReceiptExceptionNotification bean class
            */
        
        public  class EventReceiptExceptionNotification extends com.freshdirect.routing.proxy.stub.transportation.Notification
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = EventReceiptExceptionNotification
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for ServerAddedTime
                        */

                        
                                    protected java.util.Calendar localServerAddedTime ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localServerAddedTimeTracker = false ;
                           ...
                           */
                           public  java.util.Calendar getServerAddedTime(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ServerAddedTime
                               */
                               public void setServerAddedTime(java.util.Calendar param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localServerAddedTimeTracker = true;
                                       } else {
                                          localServerAddedTimeTracker = false;
                                              
                                       }
                                   
                                            this.localServerAddedTime=param;
                        ...
                        /**
                        * field for AcknowledgedTime
                        */

                        
                                    protected java.util.Calendar localAcknowledgedTime ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAcknowledgedTimeTracker = false ;
                           ...
                           */
                           public  java.util.Calendar getAcknowledgedTime(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param AcknowledgedTime
                               */
                               public void setAcknowledgedTime(java.util.Calendar param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAcknowledgedTimeTracker = true;
                                       } else {
                                          localAcknowledgedTimeTracker = false;
                                              
                                       }
                                   
                                            this.localAcknowledgedTime=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       EventReceiptExceptionNotification.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EventReceiptExceptionNotification",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EventReceiptExceptionNotification",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localServerAddedTimeTracker){
                                    namespace = "http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"serverAddedTime", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"serverAddedTime");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("serverAddedTime");
                                    }
                                

                                          if (localServerAddedTime==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("serverAddedTime cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localServerAddedTime));
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localAcknowledgedTimeTracker){
                                    namespace = "http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"acknowledgedTime", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"acknowledgedTime");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("acknowledgedTime");
                                    }
                                

                                          if (localAcknowledgedTime==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("acknowledgedTime cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAcknowledgedTime));
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","EventReceiptExceptionNotification"));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                 ...
                                 if (localTimeStampTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                        ...
                                        if (localServerAddedTime != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localServerAddedTime));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("serverAddedTime cannot be null!!");
                                        }
                                    } if (localAcknowledgedTimeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                        ...
                                        if (localAcknowledgedTime != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAcknowledgedTime));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("acknowledgedTime cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static EventReceiptExceptionNotification parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EventReceiptExceptionNotification object =
                new EventReceiptExceptionNotification();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EventReceiptExceptionNotification".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EventReceiptExceptionNotification)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","serverAddedTime").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setServerAddedTime(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","acknowledgedTime").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setAcknowledgedTime(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","tolerance").equals(reader.getName())){
