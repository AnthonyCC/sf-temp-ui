...
public class TimeZoneOptions  implements java.io.Serializable {
    ...
    private com.freshdirect.routing.proxy.stub.roadnet.TimeZoneOptionsType optionType;

    private com.freshdirect.routing.proxy.stub.roadnet.TimeZoneValue timeZone;
    ...
    public TimeZoneOptions(
           ...
           com.freshdirect.routing.proxy.stub.roadnet.TimeZoneOptionsType optionType,
           com.freshdirect.routing.proxy.stub.roadnet.TimeZoneValue timeZone) {
     ...
     * @param optionType
     */
    public void setOptionType(com.freshdirect.routing.proxy.stub.roadnet.TimeZoneOptionsType optionType) {
        this.optionType = optionType;
    }
     ...
     * @param timeZone
     */
    public void setTimeZone(com.freshdirect.routing.proxy.stub.roadnet.TimeZoneValue timeZone) {
        this.timeZone = timeZone;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService", "TimeZoneOptions"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("embeddedInTimestamp");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService", "embeddedInTimestamp"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("optionType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService", "optionType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService", "TimeZoneOptionsType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("timeZone");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService", "timeZone"));
