 ...
 */
            ...
            /**
            *  BuildMatrixEx bean class
            */
        
        public  class BuildMatrixEx
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.roadnet.MapPoint[] localPoints ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.roadnet.MapPoint[] getPoints(){
                               return localPoints;
                           }
                               ...
                               */
                              protected void validatePoints(com.freshdirect.routing.proxy.stub.roadnet.MapPoint[] param){
                              ...
                              * @param param Points
                              */
                              public void setPoints(com.freshdirect.routing.proxy.stub.roadnet.MapPoint[] param){
                             ...
                             */
                             public void addPoints(com.freshdirect.routing.proxy.stub.roadnet.MapPoint param){
                                   if (localPoints == null){
                                   localPoints = new com.freshdirect.routing.proxy.stub.roadnet.MapPoint[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPoints);
                               list.add(param);
                               this.localPoints =
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.roadnet.PathOptions localOptions ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.roadnet.PathOptions getOptions(){
                               return localOptions;
                           }
                            ...
                            /**
                               ...
                               * @param param Options
                               */
                               public void setOptions(com.freshdirect.routing.proxy.stub.roadnet.PathOptions param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       BuildMatrixEx.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                       ...
                                       if (localPoints!=null){
                                            for (int i = 0;i < localPoints.length;i++){
                                                if (localPoints[i] != null){
                                                 localPoints[i].serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","points"),
                                                           factory,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static BuildMatrixEx parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BuildMatrixEx object =
                new BuildMatrixEx();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BuildMatrixEx".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BuildMatrixEx)com.freshdirect.routing.proxy.stub.roadnet.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","points").equals(reader.getName())){
                                    ...
                                    list1.add(com.freshdirect.routing.proxy.stub.roadnet.MapPoint.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","points").equals(reader.getName())){
                                                                    list1.add(com.freshdirect.routing.proxy.stub.roadnet.MapPoint.Factory.parse(reader));
                                                        ...
                                                        object.setPoints((com.freshdirect.routing.proxy.stub.roadnet.MapPoint[])
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setOptions(com.freshdirect.routing.proxy.stub.roadnet.PathOptions.Factory.parse(reader));
