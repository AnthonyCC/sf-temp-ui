...
/**
 * DeliveryAreaRouteCriteria.java
 *
 ...
 */
            ...
            /**
            *  DeliveryAreaRouteCriteria bean class
            */
        
        public  class DeliveryAreaRouteCriteria extends com.freshdirect.routing.proxy.stub.transportation.WaveCriteria
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DeliveryAreaRouteCriteria
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DeliveryAreaRouteCriteria.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeliveryAreaRouteCriteria",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeliveryAreaRouteCriteria",
                           xmlWriter);
                   }
                ...
                if (localWaveCodeTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localPreferredRunTimeTracker){
                                    namespace = "http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","DeliveryAreaRouteCriteria"));
                 if (localWaveCodeTracker){
    ...
    public static class Factory{
        ...
        */
        public static DeliveryAreaRouteCriteria parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeliveryAreaRouteCriteria object =
                new DeliveryAreaRouteCriteria();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeliveryAreaRouteCriteria".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeliveryAreaRouteCriteria)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setPreferredRunTime(
                                                   ...
                                                   object.setPreferredRunTime(java.lang.Integer.MIN_VALUE);
