        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.roadnet.PathDirections[] localPathDirections ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.freshdirect.routing.proxy.stub.roadnet.PathDirections[]
                           */
                           public  com.freshdirect.routing.proxy.stub.roadnet.PathDirections[] getPathDirections(){
                               ...
                               */
                              protected void validatePathDirections(com.freshdirect.routing.proxy.stub.roadnet.PathDirections[] param){
                              ...
                              */
                              public void setPathDirections(com.freshdirect.routing.proxy.stub.roadnet.PathDirections[] param){
                             ...
                             * @param param com.freshdirect.routing.proxy.stub.roadnet.PathDirections
                             */
                             public void addPathDirections(com.freshdirect.routing.proxy.stub.roadnet.PathDirections param){
                                   if (localPathDirections == null){
                                   localPathDirections = new com.freshdirect.routing.proxy.stub.roadnet.PathDirections[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPathDirections);
                             ...
                             (com.freshdirect.routing.proxy.stub.roadnet.PathDirections[])list.toArray(
                            new com.freshdirect.routing.proxy.stub.roadnet.PathDirections[list.size()]);
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.roadnet.MapExtents localExtents ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.freshdirect.routing.proxy.stub.roadnet.MapExtents
                           */
                           public  com.freshdirect.routing.proxy.stub.roadnet.MapExtents getExtents(){
                            ...
                            /**
                               ...
                               * @param param Extents
                               */
                               public void setExtents(com.freshdirect.routing.proxy.stub.roadnet.MapExtents param){
                           ...
                           xmlWriter);
                              ...
                              if (localPathDirectionsTracker){
                                       if (localPathDirections!=null){
                                            for (int i = 0;i < localPathDirections.length;i++){
                                                if (localPathDirections[i] != null){
                                                 localPathDirections[i].serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","pathDirections"),
                                                           factory,xmlWriter);
                                                } else {
                                    ...
                                    if (localExtents==null){
                                     ...
                                     localExtents.serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","extents"),
                                        factory,xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DirectionData".equals(type)){
                                ...
                                return (DirectionData)com.freshdirect.routing.proxy.stub.roadnet.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","pathDirections").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(com.freshdirect.routing.proxy.stub.roadnet.PathDirections.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","pathDirections").equals(reader.getName())){
                                                                    list3.add(com.freshdirect.routing.proxy.stub.roadnet.PathDirections.Factory.parse(reader));
                                                        ...
                                                        object.setPathDirections((com.freshdirect.routing.proxy.stub.roadnet.PathDirections[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.freshdirect.routing.proxy.stub.roadnet.PathDirections.class,
                                                                list3));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/RouteNetWebService","extents").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setExtents(com.freshdirect.routing.proxy.stub.roadnet.MapExtents.Factory.parse(reader));
