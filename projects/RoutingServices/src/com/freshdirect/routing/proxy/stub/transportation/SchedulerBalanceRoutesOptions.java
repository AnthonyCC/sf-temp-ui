 ...
 */
            ...
            /**
            *  SchedulerBalanceRoutesOptions bean class
            */
        
        public  class SchedulerBalanceRoutesOptions
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SchedulerBalanceRoutesOptions
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SchedulerBalanceRoutesOptions.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SchedulerBalanceRoutesOptions",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SchedulerBalanceRoutesOptions",
                           xmlWriter);
                   }
                ...
                if (localBalancingOptionsTracker){
                                    if (localBalancingOptions==null){
                                     ...
                                     localBalancingOptions.serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","balancingOptions"),
                                        factory,xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static SchedulerBalanceRoutesOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SchedulerBalanceRoutesOptions object =
                new SchedulerBalanceRoutesOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SchedulerBalanceRoutesOptions".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SchedulerBalanceRoutesOptions)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","balancingOptions").equals(reader.getName())){
