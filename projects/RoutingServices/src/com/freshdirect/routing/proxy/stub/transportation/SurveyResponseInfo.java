 ...
 */
            ...
            /**
            *  SurveyResponseInfo bean class
            */
        
        public  class SurveyResponseInfo extends com.freshdirect.routing.proxy.stub.transportation.RouteEventInfo
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.freshdirect.routing.proxy.stub.transportation.SurveyResult[] localResponses ;
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.SurveyResult[] getResponses(){
                               ...
                               */
                              protected void validateResponses(com.freshdirect.routing.proxy.stub.transportation.SurveyResult[] param){
                              ...
                              */
                              public void setResponses(com.freshdirect.routing.proxy.stub.transportation.SurveyResult[] param){
                             ...
                             */
                             public void addResponses(com.freshdirect.routing.proxy.stub.transportation.SurveyResult param){
                                   if (localResponses == null){
                                   localResponses = new com.freshdirect.routing.proxy.stub.transportation.SurveyResult[]{};
                                   }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SurveyResponseInfo.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SurveyResponseInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SurveyResponseInfo",
                                       ...
                                       if (localResponses!=null){
                                            for (int i = 0;i < localResponses.length;i++){
                                                if (localResponses[i] != null){
                                                 localResponses[i].serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","responses"),
                                                           factory,xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","SurveyResponseInfo"));
    ...
    public static class Factory{
        ...
        */
        public static SurveyResponseInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SurveyResponseInfo object =
                new SurveyResponseInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SurveyResponseInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SurveyResponseInfo)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","internalStopId").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","responses").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list6.add(com.freshdirect.routing.proxy.stub.transportation.SurveyResult.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone6){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","responses").equals(reader.getName())){
                                                                    list6.add(com.freshdirect.routing.proxy.stub.transportation.SurveyResult.Factory.parse(reader));
                                                        ...
                                                        object.setResponses((com.freshdirect.routing.proxy.stub.transportation.SurveyResult[])
