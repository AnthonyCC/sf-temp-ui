...
public class ReportsWebService_BindingStub extends org.apache.axis.client.Stub implements com.freshdirect.routing.proxy.stub.report.ReportsWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.freshdirect.routing.proxy.stub.report.Report.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/ReportsWebService", "report"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/ReportsWebService", "Report"), com.freshdirect.routing.proxy.stub.report.Report.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/ReportsWebService", "exportOptions"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/ReportsWebService", "ReportExportOptions"), com.freshdirect.routing.proxy.stub.report.ReportExportOptions.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
    ...
    public ReportsWebService_BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.freshdirect.routing.proxy.stub.report.Report.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportCriteriaType.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportExportOptions.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportExportType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportIdentity.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportParameter.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportParameterDataType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportParameterKind.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportRetrievalOptions.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.freshdirect.routing.proxy.stub.report.ReportType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identity, retrieveOptions});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.freshdirect.routing.proxy.stub.report.Report) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.freshdirect.routing.proxy.stub.report.Report) org.apache.axis.utils.JavaUtils.convert(_resp, com.freshdirect.routing.proxy.stub.report.Report.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
