...
public class StopSequenceNotification  extends com.freshdirect.routing.proxy.stub.transportation.Notification  implements java.io.Serializable {
    private com.freshdirect.routing.proxy.stub.transportation.NotificationSource source;

    private com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] newStopSequence;
    ...
    public StopSequenceNotification(
           ...
           com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] newStopSequence) {
        super(
            notificationType,
     ...
     */
    public void setNewStopSequence(com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] newStopSequence) {
        this.newStopSequence = newStopSequence;
    }

    public com.freshdirect.routing.proxy.stub.transportation.StopIdentity getNewStopSequence(int i) {
        return this.newStopSequence[i];
    }

    public void setNewStopSequence(int i, com.freshdirect.routing.proxy.stub.transportation.StopIdentity _value) {
