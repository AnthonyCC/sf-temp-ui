 ...
 */
            ...
            /**
            *  StopSequenceNotification bean class
            */
        
        public  class StopSequenceNotification extends com.freshdirect.routing.proxy.stub.transportation.Notification
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = StopSequenceNotification
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for NewStopSequence
                        * This was an Array!
                        */

                        
                                    protected com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] localNewStopSequence ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localNewStopSequenceTracker = false ;
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] getNewStopSequence(){
                               return localNewStopSequence;
                           }
                              ...
                              /**
                               * validate the array for NewStopSequence
                               */
                              protected void validateNewStopSequence(com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param NewStopSequence
                              */
                              public void setNewStopSequence(com.freshdirect.routing.proxy.stub.transportation.StopIdentity[] param){
                              
                                   validateNewStopSequence(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localNewStopSequenceTracker = true;
                                          } else {
                                             localNewStopSequenceTracker = false;
                                                 
                                          }
                                      
                                      this.localNewStopSequence=param;
                              }
                             ...
                             * @param param com.freshdirect.routing.proxy.stub.transportation.StopIdentity
                             */
                             public void addNewStopSequence(com.freshdirect.routing.proxy.stub.transportation.StopIdentity param){
                                   if (localNewStopSequence == null){
                                   localNewStopSequence = new com.freshdirect.routing.proxy.stub.transportation.StopIdentity[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localNewStopSequence);
                               list.add(param);
                               this.localNewStopSequence =
                             (com.freshdirect.routing.proxy.stub.transportation.StopIdentity[])list.toArray(
                            new com.freshdirect.routing.proxy.stub.transportation.StopIdentity[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       StopSequenceNotification.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StopSequenceNotification",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StopSequenceNotification",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localSource.serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","source"),
                                               factory,xmlWriter);
                                         if (localNewStopSequenceTracker){
                                       if (localNewStopSequence!=null){
                                            for (int i = 0;i < localNewStopSequence.length;i++){
                                                if (localNewStopSequence[i] != null){
                                                 localNewStopSequence[i].serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","newStopSequence"),
                                                           factory,xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("newStopSequence cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","StopSequenceNotification"));
                             ...
                             if (localNewStopSequence!=null) {
                                 for (int i = 0;i < localNewStopSequence.length;i++){
                                    ...
                                    if (localNewStopSequence[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                                                          "newStopSequence"));
                                         elementList.add(localNewStopSequence[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static StopSequenceNotification parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StopSequenceNotification object =
                new StopSequenceNotification();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StopSequenceNotification".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StopSequenceNotification)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list7 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","newStopSequence").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list7.add(com.freshdirect.routing.proxy.stub.transportation.StopIdentity.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone7){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","newStopSequence").equals(reader.getName())){
                                                                    list7.add(com.freshdirect.routing.proxy.stub.transportation.StopIdentity.Factory.parse(reader));
                                                        ...
                                                        object.setNewStopSequence((com.freshdirect.routing.proxy.stub.transportation.StopIdentity[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.freshdirect.routing.proxy.stub.transportation.StopIdentity.class,
                                                                list7));
