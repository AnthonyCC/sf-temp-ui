 ...
 */
            ...
            /**
            *  StopArriveNotification bean class
            */
        
        public  class StopArriveNotification extends com.freshdirect.routing.proxy.stub.transportation.Notification
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = StopArriveNotification
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for ArrivalTimeDataQuality
                        */

                        
                                    protected com.freshdirect.routing.proxy.stub.transportation.DataQualityType localArrivalTimeDataQuality ;
                           ...
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.DataQualityType getArrivalTimeDataQuality(){
                               return localArrivalTimeDataQuality;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ArrivalTimeDataQuality
                               */
                               public void setArrivalTimeDataQuality(com.freshdirect.routing.proxy.stub.transportation.DataQualityType param){
                            
                                            this.localArrivalTimeDataQuality=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       StopArriveNotification.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StopArriveNotification",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StopArriveNotification",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                            ...
                                            if (localArrivalTimeDataQuality==null){
                                                 throw new org.apache.axis2.databinding.ADBException("arrivalTimeDataQuality cannot be null!!");
                                            }
                                           localArrivalTimeDataQuality.serialize(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","arrivalTimeDataQuality"),
                                               factory,xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","StopArriveNotification"));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService",
                                                                      "arrivalTimeDataQuality"));
                            
                            
                                    if (localArrivalTimeDataQuality==null){
                                         throw new org.apache.axis2.databinding.ADBException("arrivalTimeDataQuality cannot be null!!");
                                    }
                                    elementList.add(localArrivalTimeDataQuality);
    ...
    public static class Factory{
        ...
        */
        public static StopArriveNotification parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StopArriveNotification object =
                new StopArriveNotification();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StopArriveNotification".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StopArriveNotification)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService","arrivalTimeDataQuality").equals(reader.getName())){
                                
                                                object.setArrivalTimeDataQuality(com.freshdirect.routing.proxy.stub.transportation.DataQualityType.Factory.parse(reader));
