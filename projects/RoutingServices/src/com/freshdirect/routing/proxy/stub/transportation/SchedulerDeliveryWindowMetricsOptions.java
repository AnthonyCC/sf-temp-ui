...
public class SchedulerDeliveryWindowMetricsOptions  implements java.io.Serializable {
    private com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowMetricsType type;

    private com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowBase[] deliveryWindows;
    ...
    public SchedulerDeliveryWindowMetricsOptions(
           com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowMetricsType type,
           com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowBase[] deliveryWindows,
     ...
     * @param type
     */
    public void setType(com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowMetricsType type) {
        this.type = type;
    }
     ...
     */
    public void setDeliveryWindows(com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowBase[] deliveryWindows) {
        this.deliveryWindows = deliveryWindows;
    }

    public com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowBase getDeliveryWindows(int i) {
        return this.deliveryWindows[i];
    }

    public void setDeliveryWindows(int i, com.freshdirect.routing.proxy.stub.transportation.SchedulerDeliveryWindowBase _value) {
