 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for DirectionArcs
                        * This was an Array!
                        */

                        
                                    protected com.freshdirect.routing.proxy.stub.transportation.DirectionArc[] localDirectionArcs ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDirectionArcsTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return com.freshdirect.routing.proxy.stub.transportation.DirectionArc[]
                           */
                           public  com.freshdirect.routing.proxy.stub.transportation.DirectionArc[] getDirectionArcs(){
                               return localDirectionArcs;
                           }
                              ...
                              /**
                               * validate the array for DirectionArcs
                               */
                              protected void validateDirectionArcs(com.freshdirect.routing.proxy.stub.transportation.DirectionArc[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param DirectionArcs
                              */
                              public void setDirectionArcs(com.freshdirect.routing.proxy.stub.transportation.DirectionArc[] param){
                              
                                   validateDirectionArcs(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localDirectionArcsTracker = true;
                                          } else {
                                             localDirectionArcsTracker = false;
                                                 
                                          }
                                      
                                      this.localDirectionArcs=param;
                              }
                             ...
                             * @param param com.freshdirect.routing.proxy.stub.transportation.DirectionArc
                             */
                             public void addDirectionArcs(com.freshdirect.routing.proxy.stub.transportation.DirectionArc param){
                                   if (localDirectionArcs == null){
                                   localDirectionArcs = new com.freshdirect.routing.proxy.stub.transportation.DirectionArc[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDirectionArcs);
                               list.add(param);
                               this.localDirectionArcs =
                             (com.freshdirect.routing.proxy.stub.transportation.DirectionArc[])list.toArray(
                            new com.freshdirect.routing.proxy.stub.transportation.DirectionArc[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       PathDirections.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localDirectionArcsTracker){
                                       if (localDirectionArcs!=null){
                                            for (int i = 0;i < localDirectionArcs.length;i++){
                                                if (localDirectionArcs[i] != null){
                                                 localDirectionArcs[i].serialize(new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","directionArcs"),
                                                           factory,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static PathDirections parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PathDirections object =
                new PathDirections();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PathDirections".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PathDirections)com.freshdirect.routing.proxy.stub.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","directionArcs").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(com.freshdirect.routing.proxy.stub.transportation.DirectionArc.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","directionArcs").equals(reader.getName())){
                                                                    list3.add(com.freshdirect.routing.proxy.stub.transportation.DirectionArc.Factory.parse(reader));
                                                        ...
                                                        object.setDirectionArcs((com.freshdirect.routing.proxy.stub.transportation.DirectionArc[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.freshdirect.routing.proxy.stub.transportation.DirectionArc.class,
                                                                list3));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","pathDescription1").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.roadnet.com/RTS/TransportationSuite/TransportationWebService","pathDescription2").equals(reader.getName())){
