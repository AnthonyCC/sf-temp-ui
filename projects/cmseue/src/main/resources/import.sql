...
insert into MEDIA(id, uri, width, height, type, mime_type, last_modified) values('media3', '/media/test/media-developer.html', null, null, 'Html', 'text/plain; charset=us-ascii', now());
