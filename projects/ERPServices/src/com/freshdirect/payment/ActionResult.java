...
public class ActionResult {
	...
	private Map<String, String> debug = null;
	public ActionResult() {
	...
	public void addError(ActionError error) {
		LOGGER.debug("error added: " + error.getType() + ", "
	...
	public void addWarning(ActionWarning warning) {
		LOGGER.debug("warning added: " + warning.getType() + ", "
	...
	public String toString() {
		return "ActionResult[ERRORS: " + this.errors + "][WARNINGS: "
				+ this.warnings + "]";
	}
