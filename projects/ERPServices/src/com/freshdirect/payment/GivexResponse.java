...
public class GivexResponse extends Result {

	/**
	 * 
	 */
	private static final long serialVersionUID = -930511328229667725L;
    ...
    public GivexResponse()
    {    	
    }
    
    public GivexResponse(long p_authCode
    ...
    private GCException exception;


	public GCException getException() {
		return exception;
	}
	public void setException(GCException exception) {
