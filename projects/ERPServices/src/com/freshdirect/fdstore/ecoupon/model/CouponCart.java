...
public class CouponCart implements Serializable{
	...
	public CouponCart(FDCouponCustomer couponCustomer,
			List<ErpOrderLineModel> orderLines,EnumCouponTransactionType tranType) {
		super();
	...
	public CouponCart(FDCouponCustomer couponCustomer,
			List<ErpOrderLineModel> orderLines, String orderId,EnumCouponTransactionType tranType) {
		super();
		this.couponCustomer = couponCustomer;
		this.orderLines = orderLines;
	...
	public CouponCart(FDCouponCustomer couponCustomer,
			String orderId,EnumCouponTransactionType tranType) {
		super();
		this.couponCustomer = couponCustomer;
		this.orderId = orderId;
		this.tranType = tranType;
