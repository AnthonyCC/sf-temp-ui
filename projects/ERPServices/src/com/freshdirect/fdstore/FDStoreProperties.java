...
public class FDStoreProperties {
    ...
    static {      	    	
        ...
        defaults.put(PROP_FDSTORE_WEB_CAREERLINK,
            "http://jobs-freshdirect.icims.com");
        ...
        defaults.put(PROP_FDPROMOTIONMGR_NEW_HOME,
            "freshdirect.fdstore.PromotionManagerNew");

        defaults.put(PROP_DLVMANAGER_HOME,
            "freshdirect.delivery.DeliveryManager");
        defaults.put(PROP_RULESMANAGER_HOME,
                "freshdirect.fdstore.RulesManager");
        defaults.put(PROP_AIRCLICMANAGER_HOME,
                "freshdirect.delivery.AirclicManager");
        defaults.put(PROP_DLVRESTRICTION_MGR_HOME,
            "freshdirect.delivery.DeliveryRestrictionManager");
        defaults.put(PROP_FDCUSTOMER_HOME, "freshdirect.fdstore.Customer");
        defaults.put(PROP_EMAIL_PROMOTION,
            "PromotionNotification@freshdirect.com");
        ...
        defaults.put(PROP_DLV_INSTRUCTION_SPECIAL_CHAR,
            "[~ | \\` | \" | \\! | \\@ | \\# | \\ $ | \\% | \\^ | \\& | \\* | \\( | \\) | \\- | _ | + | \\= | \\n | \\r]");
        ...
        defaults.put(PROP_RESTRICTED_PAYMENT_METHOD_HOME,
        ...
        */
        ...
        defaults.put(PROP_FDREFERRALMGR_HOME,
            "freshdirect.fdstore.ReferralManager");
        ...
        defaults.put(BSGS_SIGNUP_URL,
            "/product.jsp?productId=mkt_fd_dlvpss_b10g5f&catId=gro_gear_dlvpass");
        defaults.put(UNLIMITED_SIGNUP_URL,
            "/product.jsp?productId=mkt_fd_dlvpss_unl6m&catId=gro_gear_dlvpass");
        defaults.put(UNLIMITED_PROMOTIONAL_SIGNUP_URL,
            "/product.jsp?productId=mkt_fd_dlvpss_unl6m&catId=gro_gear_dlvpass");
        defaults.put(UNLIMITED_AMAZON_PRIME_SIGNUP_URL,
            "/product.jsp?productId=mkt_fd_dlvpss_unl6m&catId=gro_gear_dlvpass");
        defaults.put(CRM_BSGS_SIGNUP_URL,
            "/order/product.jsp?productId=mkt_fd_dlvpss_b10g5f&catId=gro_gear_dlvpass");
        defaults.put(CRM_UNLIMITED_SIGNUP_URL,
            "/order/product.jsp?productId=mkt_fd_dlvpss_unl6m&catId=gro_gear_dlvpass");
        defaults.put(CRM_UNLIMITED_PROMOTIONAL_SIGNUP_URL,
            "/order/product.jsp?productId=mkt_fd_dlvpss_unl6m&catId=gro_gear_dlvpass");
        defaults.put(CRM_UNLIMITED_AMAZON_PRIME_SIGNUP_URL,
            "/order/product.jsp?productId=mkt_fd_dlvpss_unl6m&catId=gro_gear_dlvpass");
        ...
        defaults.put(SMARTSTORE_CMS_RECOMM_REFRESH_RATE,
            Long.toString(Long.MAX_VALUE / 60 / 1000));
        ...
        defaults.put(FRESHNESS_GUARANTEED_PREFIXES,
            "FRU,VEG,MEA,SEA,DEL,CHE,DAI,HMR,VAR,CAT,BAK,PAS,YEL");

        defaults.put(HP_LETTER_MEDIA_PATH1,
            "/media/editorial/home/letter/hp_letter_new.html");
        defaults.put(HP_LETTER_MEDIA_PATH2,
            "/media/editorial/home/letter/hp_letter_customer.html");
        ...
        defaults.put(PROP_MEDIA_GIFT_CARD_TEMPLATE_PATH,
            "/media/editorial/giftcards/");
        ...
        defaults.put(PROP_CRM_HELP_LINK_ADDR_VALIDATION,
            "http://home.freshdirect.com/confluence/display/CRM/Address+Validation");
        defaults.put(PROP_CRM_HELP_LINK_GIFT_CARD,
            "http://home.freshdirect.com/confluence/display/CRM/Gift+Card");
        defaults.put(PROP_CRM_HELP_LINK_MAIN_HELP,
            "http://home.freshdirect.com/confluence/display/CRM/Home");
        defaults.put(PROP_CRM_HELP_LINK_CUST_PROFILE,
            "http://home.freshdirect.com/confluence/display/CRM/Customer+Profiles");
        defaults.put(PROP_CRM_HELP_LINK_TIMESLOT,
            "http://home.freshdirect.com/confluence/display/CRM/Timeslot+Request");
        defaults.put(PROP_CRM_HELP_LINK_FD_UPDATES,
            "http://home.freshdirect.com/confluence/display/CRM/FD+Updates");
        defaults.put(PROP_CRM_HELP_LINK_PROMOTIONS,
            "http://home.freshdirect.com/confluence/display/CRM/Promotion");
        defaults.put(PROP_CRM_HELP_LINK_CASE_MEDIA,
            "http://home.freshdirect.com/confluence/display/CRM/Media");
        defaults.put(PROP_CRM_HELP_LINK_CASE_MORE_ISSUES,
            "http://home.freshdirect.com/confluence/display/CRM/More+than+one+issue+with+order");
        defaults.put(PROP_CRM_HELP_LINK_CASE_CUST_TONE,
            "http://home.freshdirect.com/confluence/display/CRM/Customer%27s+tone");
        defaults.put(PROP_CRM_HELP_LINK_CASE_RESOL_SATISFY,
            "http://home.freshdirect.com/confluence/display/CRM/Resolution+satisfactory");
        defaults.put(PROP_CRM_HELP_LINK_CASE_RESOLV_FIRST,
            "http://home.freshdirect.com/confluence/display/CRM/Resolved+on+first+contact");
        defaults.put(PROP_CRM_HELP_LINK_CASE_FIRST_CONTACT,
            "http://home.freshdirect.com/confluence/display/CRM/First+contact+for+issue");
        ...
        defaults.put(PROP_CRM_CC_SECURITY_EMAIL_SUBJECT,
            "ALERT: CC/EC decryptions above threshold");
        defaults.put(PROP_CRM_CC_DETAILS_ACCESS_KEY,
            "9ac7ec230e0e4513578f309d6d3579ad");
        defaults.put(PROP_CRM_FORGOT_LDAP_PASSWORD_URL,
            "http://myaccount.freshdirect.com/cp/login/Login.aspx");
        ...
        defaults.put(PROP_MIDDLETIER_PROVIDER_URL, "http://10.64.14.185/dl");
    ...
    private synchronized static void refresh(boolean force) {
        ...
        if (force || ((t - lastRefresh) > REFRESH_PERIOD)) {
            config = ConfigHelper.getPropertiesFromClassLoader("fdstore.properties",
                    defaults);
            lastRefresh = t;
            LOGGER.info("Loaded configuration from fdstore.properties: " +
                config);
            fireEvent();
        }
    }
    ...
    public static String getCaseListLength(boolean isCaseHistory) {
        return (isCaseHistory) ? get(PROP_CRM_CASE_HISTORY_LIST_LENGTH)
                               : get(PROP_CRM_CASE_LIST_LENGTH);
    }
    ...
    public static boolean getAdServerUsesDeferredImageLoading() {
        return Boolean.valueOf(get(PROP_AD_SERVER_USES_DEFERRED_IMAGE_LOADING))
                      .booleanValue();
    }
    ...
    public static Date getDlvPromoExpDate() {
        ...
        try {
            ...
            new FDRuntimeException(
                "fdstore.dlvPromo.expDate property in fdstore.properties is not in correct yyyy-MM-dd format");
        }
    ...
    public static boolean isProductRecommendEnabled() {
        return Boolean.valueOf(get(PROP_PRODUCT_RECOMMEND_ENABLED))
                      .booleanValue();
    }
    ...
    public static DateRange getAdvanceOrderRange() {
        ...
        try {
            ...
            try {
                ...
                LOGGER.warn(
                    "fdstore.advance.order.start property in fdstore.properties is not in correct yyyy-MM-dd format, defaulting to 2000-01-01");
            } catch (ParseException f) {
                throw new FDRuntimeException(
                    "Error parsing advance start date, default value");
            }
        }
        ...
        try {
            ...
            try {
                ...
                LOGGER.warn(
                    "fdstore.advance.order.end property in fdstore.properties is not in correct yyyy-MM-dd format, defaulting to 2000-01-01");
            } catch (ParseException f) {
                throw new FDRuntimeException(
                    "Error parsing advance end date, default value");
            }
        }
    ...
    public static boolean isSmartstoreOnlineFactorsCached() {
        return Boolean.valueOf(get(SMARTSTORE_CACHE_ONLINE_FACTORS))
                      .booleanValue();
    }
    ...
    public static boolean isWhatsGoodPeakProduceEnabled() {
        return Boolean.valueOf(get(PROP_FDWHATSGOOD_PEAKPRODUCE_ENABLED))
                      .booleanValue();
    }

    public static boolean isWhatsGoodButchersBlockEnabled() {
        return Boolean.valueOf(get(PROP_FDWHATSGOOD_BBLOCK_ENABLED))
                      .booleanValue();
    }
    ...
    public static DateRange getAdvanceOrderNewRange() {
        ...
        try {
            ...
            try {
                dStart = SF.parse("2000-01-01");
                LOGGER.warn(
                    "fdstore.advance.order.newstart property in fdstore.properties is not in correct yyyy-MM-dd format, defaulting to 2000-01-01");
            } catch (ParseException f) {
                throw new FDRuntimeException(
                    "Error parsing advance new start date, default value");
            }
        }
        ...
        try {
            ...
            try {
                dEnd = SF.parse("2000-01-01");
                LOGGER.warn(
                    "fdstore.advance.order.newend property in fdstore.properties is not in correct yyyy-MM-dd format, defaulting to 2000-01-01");
            } catch (ParseException f) {
                throw new FDRuntimeException(
                    "Error parsing advance new end date, default value");
            }
        }
    ...
    public static boolean isWineShowRatings() {
        return Boolean.toString(true)
                      .equalsIgnoreCase(get(WINE_SHOW_RATINGS_KEY));
    }
    ...
    public static double getWinePriceBucketBound(int index) {
        ...
        try {
            ...
            LOGGER.warn("cannot parse " + WINE_PRICE_BUCKET_BOUND_PREFIX +
                index + ", using default value " + defaultValue, e);
