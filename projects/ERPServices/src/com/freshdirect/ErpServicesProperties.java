...
public class ErpServicesProperties {
	...
	static {
		...
		defaults.put(PROP_GIVEX_SERVER_SEC_URL, "https://gapi-us2.givex.com:50081/1.0/trans/");//"https://149.99.39.146:50081/1.0/trans/");
		...
		defaults.put(PROP_GIVEX_CONN_TIMEOUT, "15");
