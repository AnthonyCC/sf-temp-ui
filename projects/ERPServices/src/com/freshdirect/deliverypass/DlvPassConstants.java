...
public class DlvPassConstants {
	...
	public static final String RETURN_NOTE = "One delivery was credited due to the return order.";
	public static final String CANCEL_NOTE = "Pass was cancelled due to the return order.";	
