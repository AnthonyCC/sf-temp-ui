...
public class ErpPostAuthPersistentBean extends ErpGiftCardTranPersistentBean {
	
	private ErpPostAuthGiftCardModel model;
	
	/** Creates new ErpAuthorizationPersistentBean */
    public ErpPostAuthPersistentBean() {
		super();
		this.model = new ErpPostAuthGiftCardModel();
    }
    
    public ErpPostAuthPersistentBean(PrimaryKey pk){
    	this();
    	this.setPK(pk);
    }
	
	/** Load constructor. */
	public ErpPostAuthPersistentBean(PrimaryKey pk, Connection conn) throws SQLException {
		this();
		this.setPK(pk);
		load(conn);
	}
	 ...
	 */
	public ErpPostAuthPersistentBean(ErpPostAuthPersistentBean model) {
		this();
	...
	public void setFromModel(ModelI model) {
		this.model = (ErpPostAuthGiftCardModel)model;
		this.setModified();
	}
	...
	public static List findByParent(Connection conn, PrimaryKey parentPK) throws SQLException {
		...
		ps.setString(2, EnumTransactionType.POSTAUTH_GIFTCARD.getCode());
		ResultSet rs = ps.executeQuery();
		while (rs.next()) {
			ErpPostAuthPersistentBean bean = new ErpPostAuthPersistentBean(new PrimaryKey(rs.getString(1)), conn);
