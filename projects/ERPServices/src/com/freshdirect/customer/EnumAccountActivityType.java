...
public class EnumAccountActivityType implements java.io.Serializable {
	...
	public final static EnumAccountActivityType		STANDINGORDER_DELETE_DATE_SET		= new EnumAccountActivityType( "SO-Future delete", "Standing Order delete date has been choosen by user." );
