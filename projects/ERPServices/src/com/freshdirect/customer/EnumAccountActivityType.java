...
public class EnumAccountActivityType implements java.io.Serializable {
	...
	public final static EnumAccountActivityType		STANDINGORDER_TEMPLATE_DEL_DATE_SET	= new EnumAccountActivityType( "SO-Template del", "Standing Order template delete date has been choosen by user." );
