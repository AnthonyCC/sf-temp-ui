...
public abstract class ErpPaymentMethodTransactionModel extends ErpTransactionModel{
    ...
    public ErpPaymentMethodTransactionModel(EnumTransactionType transType) {
		super(transType);
    }
