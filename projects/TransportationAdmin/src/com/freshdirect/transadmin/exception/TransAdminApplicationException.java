...
public class TransAdminApplicationException extends Exception {
	...
	public TransAdminApplicationException(String errorCode, String args[]){		
		this.errorCode=errorCode;
		this.placeHolders =args;
	}
     
    
	public TransAdminApplicationException(Exception e){
		this.causedException=e;
	}
	
	public TransAdminApplicationException(List list){
	...
	public String getMessage()
	{
		try{
			...
			if(exceptionList!=null && exceptionList.size()>0){
				...
				throw new TransAdminSystemException("1001",exception);
			}	
