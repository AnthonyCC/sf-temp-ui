...
public class TransAdminCacheException extends RuntimeException {
	...
	public TransAdminCacheException(String errorCode, Throwable e) {
		this(e);
		this.errorCode = errorCode;
	}

	public TransAdminCacheException(Throwable e) {
