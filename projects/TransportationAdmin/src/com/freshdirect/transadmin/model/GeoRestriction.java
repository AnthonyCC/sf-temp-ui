...
public class GeoRestriction implements java.io.Serializable {
	...
	public GeoRestriction(String restrictionId, String name,
			String boundaryCode, Date startDate, Date endDate, String message,
			String active, String comments, String showMessage,
			String serviceType, String viewType, String applyTo,
			Set geoRestrictionDays) {
		super();
	...
	public GeoRestriction(String id, String name, String boundaryCode,
			Date startDate, Date endDate, String message, String inactive,String applyTo,
			String comments) {
		this.restrictionId = id;
		this.name = name;
		this.boundaryCode = boundaryCode;
