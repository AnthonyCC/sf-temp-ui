...
public class FDXlsView implements View {
    private static Log logger = LogFactory.getLog(FDXlsView.class);
    ...
    public void beforeBody(TableModel model) {
       ...
       /* if (encoding.equalsIgnoreCase("UTF")) {
            wb.setSheetName(0, "Export Workbook", HSSFWorkbook.ENCODING_UTF_16);
        	 wb.se setSheetName(0, "Export Workbook", HSSFWorkbook.ENCODING_UTF_16);
