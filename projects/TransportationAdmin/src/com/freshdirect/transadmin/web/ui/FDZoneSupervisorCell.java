...
public class FDZoneSupervisorCell extends FDBaseCell  {
		...
		if(obj instanceof ResourceList) {
			...
			if(resList!=null) {
				...
				for(int i=0;i<resList.size();i++) {
					String name=((ZoneSupervisor)resList.get(i)).getSupervisorLastName();
    ...
    public String getHtmlDisplay(TableModel model, Column column) {   
        ...
        if(resources!=null) {
        	...
        	ZoneSupervisor resourceInfo=null;
        	while(it.hasNext()) {
        		resourceInfo=(ZoneSupervisor)it.next();
        		if(resourceInfo.getSupervisorFirstName()!=null || resourceInfo.getSupervisorLastName()!=null) 
        		{
        			String star="";
        			html.tr(0).close();
        			html.td(0).close().append(star+resourceInfo.getSupervisorLastName()+" "+resourceInfo.getSupervisorFirstName()).tdEnd();
        			html.trEnd(0);
        		}
        	}
    		html.tableEnd(0);
