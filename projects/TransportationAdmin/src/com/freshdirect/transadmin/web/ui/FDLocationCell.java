...
public class FDLocationCell extends FDBaseCell  {
    ...
    public String getHtmlDisplay(TableModel model, Column column) {    	
        ...
        try {        	
            ...
            strBuf.append("javascript:pop('dlvbuildinglocation.do?id=");
            ...
            columnBuilder.getHtmlBuilder().a(strBuf.toString()).close().img("images/bg_cart.gif").aEnd();            
