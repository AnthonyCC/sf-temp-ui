...
<form id="activeListForm" action="" method="post"> 
	<ec:table items="unavailable"   action="${pageContext.request.contextPath}/plan.do"
		...
		<ec:row interceptor="obsoletemarker">
						 		<ec:column title=" " width="5px" filterable="false" sortable="false" cell="selectcol" property="planId" />    
								...
								<ec:column property="paycode" title="Paycode"/>
		                                      
		</ec:row>
	  </ec:table>
</form> 
<script>
 addHandlersParent('ec_table', 'rowMouseOver', 'editplan.do','id',0, 0);
</script>
</body>
</html>