		...
		<div class="cont_topleft">
			<div class="cont_row">
				<div class="cont_Litem" id="page_<%=pageTitle%>">						
						...
						<span><input id="view_button" type="image" alt="View" src="./images/icons/view.gif"  onclick="javascript:doCompositeLink('daterange','planDay','zone','plan.do');" onmousedown="this.src='./images/icons/view_ON.gif'" />
						</span>  
				</div>
			</div>
		</div> 
