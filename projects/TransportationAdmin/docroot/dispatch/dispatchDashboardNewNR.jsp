 ...
 <body marginwidth="0" marginheight="0">	
    ...
    <ec:table items="dispatchInfos" action="${pageContext.request.contextPath}/dispatchDashboardScreen.do"
    	...
    	<ec:row interceptor="obsoletemarker">	                      
	        <ec:column alias="trnTimeslotslotName" property="routeLastStopTime" title="Last Stop Time" filterable="false" sortable="false"/>
	        <ec:column alias="trnTimeslotslotNameNR" property="routeEndTime" title="Expected Return Time" filterable="false" sortable="false"/>
	        ...
	        <ec:column alias="trnStatus" property="assetStatus"  title="Asset Status" filterable="false" sortable="false"/>
        </ec:row>
    </ec:table>  
