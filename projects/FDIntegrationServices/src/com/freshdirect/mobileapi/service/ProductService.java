...
public interface ProductService {
    ...
    public List<Product> search(String searchTerm, Integer start, Integer max, SessionUser user, HttpServletRequest request, HttpContextWrapper wrapper) throws ServiceException;
    ...
    public List<Product> search(String searchTerm, String upc, Integer page, Integer max, SortType sortType, String brandId,
            String categoryId, String departmentId, SessionUser user, HttpServletRequest request, HttpContextWrapper wrapper) throws ServiceException;
