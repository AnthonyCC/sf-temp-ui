...
public class ScalePrice {
	...
	public ScalePrice(double price, String pricingUnit,double promoPrice) {
	...
	public ScalePrice(double price, String pricingUnit, double scaleLowerBound, double scaleUpperBound, String scaleUnit, double promoPrice) {
		this.price=price;
