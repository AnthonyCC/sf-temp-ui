...
<body BGCOLOR="#FFFFFF">
<dlv:depotControllerTag />
<dlv:depotRegionTag>
<table width="800" cellpadding="0" cellspacing="1" border="0">
	<form name="add_depot" method="POST" action="add_depot.jsp">
		<tr valign="bottom">
			...
			<td>
				<table>
					<tr>
						...
						<td><input type="text" size="20" name="depot_name" class="text10"></td>
					</tr>
					<tr>
						<td align="right"><b>Registration Code: </b></td>
						<td><input type="text" size="20" name="registration_code" class="text10"></td>
					</tr>
					<tr>
						<td align="right"><b>Depot Code: </b></td>
						<td><input type="text" size="20" name="depot_code" class="text10"></td>
					</tr>
                    <tr>
                        <td align="right"><b>Require Employee ID for Registration</b></td>
                        <td><input type="checkbox" name="requireEmployeeId"></td>
                    </tr>
					<tr>
                        <td align="right"><b>Pickup Location</b></td>
                        <td><input type="checkbox" name="pickup"></td>
                    </tr>
					<tr>
                        <td align="right"><b>Corporate Depot</b></td>
                        <td><input type="checkbox" name="corporateDepot"></td>
                    </tr>
                    <tr>
						<td align="right"><b>Customer Service Email: </b></td>
						<td><input type="text" size="30" name="cust_serv_email" class="text10"></td>
					</tr>
					<tr>
						...
						<td>
							<select name="region_id">
								...
								<logic:iterate id="region" collection="<%= regions %>" type="com.freshdirect.delivery.model.DlvRegionModel">
									<option value="<%=region.getPK().getId()%>"><%=region.getName()%></option>
								</logic:iterate>
							</select>
						</td>
					</tr>
		...
		<tr>
			<table cellpadding="0" cellspacing="0" border="0">
				<tr valign="bottom">
					...
					<td><input type="submit" value="Add Depot" class="text12wbold" style="background-color:669933;color:ffffff"></td>
					<td><font class="space8pix">&nbsp;&nbsp;</font></td>
				</tr>
			</table>
		</tr>
