...
/**
 * An runtime exception class that provides support for nested exceptions.
 *
 * @version $Revision$
 * @author $Author$
 */ 
public class RuntimeExceptionSupport extends RuntimeException {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -889894845070754395L;
	 ...
	 * Default constructor.
	 */	
	public RuntimeExceptionSupport() {
	}
	 ...
	 */	
	public RuntimeExceptionSupport(String message) {
		super(message);
	}
	 ...
	 */	
	public RuntimeExceptionSupport(Exception ex) {
	 ...
	 * @param message a custom message
	 */	
	public RuntimeExceptionSupport(Exception ex, String message) {
		this(message);
		this.nestedException = ex;
	}
