...
function checkError()
{
  ...
  if(document.rp.errMsg1.value!="" && document.rp.errMsg1.value=="false")
  {
     ...
     document.location.href = 'ref_obj1.jsp?SORT_COLUMN_NME='+sortColumnName+'&START_INDEX='+startIndex;
  }     
}
...
function clearAll(txt)
{
    ...
    if(txt!="save")
    {
       document.rp.refObjName.value="";   
    }   
    document.rp.refObjDesc.value="";
...
<font color="green">Referral Objective</font>
...
<div class="app">
<%
   String selectRefObj=(String)request.getParameter("selectRefObj");
   if(selectRefObj==null) selectRefObj="";
   
%>

<form name="rp" method="POST"  action="ref_obj2.jsp">
<input type="hidden" name="pageName" value="ref_obj2"/>
<input type="hidden" name="actionName" value=""/>
<input type="hidden" name="selectRefObj" value="<%=selectRefObj%>"/>
...
<%
  ...
  <ref:referralObjective id="refObj" pageName="ref_obj2">          

<input type="hidden" name="refObjId" value="<%=refObj.getPK()==null?"":refObj.getPK().getId()%>"/>
...
<tr>
 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
 <td colspan="2" align="center"> <b><U> REFERRAL OBJECT <UL><b></td> 
 <td></td> 
 <td></td> 
 <td></td> 
</tr>
...
<tr>
 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
 <td colspan="2" align="center"> <font color="red">*</font> <b> OBJECTIVE NAME : <b></td> 
 <td>  
 <%
if("save".equalsIgnoreCase(actionType))
   {
%>
<input type="text" name="refObjName" value="<%=refObj.getName()%>" readOnly="true" />
<%
}else{
%>
<input type="text" name="refObjName" value="<%=refObj.getName()%>"  maxlength="55"/>
<%
}
%>
...
<tr>
 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
 <td colspan="2" align="center"><font color="red">*</font> <b> OBJECTIVE DESC: <b></td> 
 <td>
 <textarea name="refObjDesc" rows="3" cols="40" style="width: 220px" onKeyDown="textCounter(this.form.refObjDesc,255);" onKeyUp="textCounter(this.form.refObjDesc,255);"><%=refObj.getDescription()%></textarea>
...
<td align="left"><INPUT type="button" value=" back " onClick="location.href='ref_obj1.jsp?SORT_COLUMN_NME=<%=sortByColumnName%>&START_INDEX=<%=startIndex%>'"/></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
