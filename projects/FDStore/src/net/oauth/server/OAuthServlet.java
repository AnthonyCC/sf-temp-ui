...
public class OAuthServlet {
	...
	private static Category LOGGER = LoggerFactory.getInstance( OAuthServlet.class );
    /**
     ...
     * @throws IOException 
     */
	public static OAuthMessage getMessage(HttpServletRequest request, String URL) throws IOException {
        if (URL == null) {
    ...
    public static void handleException(HttpServletResponse response,
            ...
            ServletException {
    	LOGGER.error("handleException came across the following: ", e);
