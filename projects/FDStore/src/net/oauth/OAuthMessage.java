...
public class OAuthMessage implements Serializable{
	...
	private static final long serialVersionUID = 218913260953165543L;

	public OAuthMessage(String method, String URL, Collection<? extends Map.Entry> parameters) throws IOException {
...
//        this.bodyAsStream = bodyAsStream;
        ...
        bodyAsString = readAll(bodyAsStream, getBodyEncoding());
