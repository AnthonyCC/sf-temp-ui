...
public class OAuthAccessor implements Cloneable, Serializable {
    ...
    public String toString(){
    	return String.format("id: %s, consumer: %s, requestToken: %s, accessToken: %s, tokenSecret: %s, properties: %s", id, consumer, requestToken, accessToken, tokenSecret, properties);
    }
}
