...
public class PopularityComparator implements Comparator<ContentNodeModel> {
    ...
    public PopularityComparator(boolean inverse, List<ContentNodeModel> products) {
        this(inverse, false, products);
    }

    public PopularityComparator(boolean inverse, boolean hideUnavailable, List<ContentNodeModel> products) {
        this.inverse = inverse;
        this.hideUnavailable = hideUnavailable;
        this.displayable = new HashSet<ContentKey>();
        this.globalComparator = ScriptedContentNodeComparator.createGlobalComparator();
        if (products != null) {
