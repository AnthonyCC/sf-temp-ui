...
public class WebDeliveryPassView {
	...
	private static final String OPTIN_FREE_TRIAL_DP_PASS_DETAIL_INFO_TEXT = " You have opted into the DeliveryPass Free Trial on ? date. You will start receiving free deliveries on your next order";
	...
	public String getDetailInfo() {
		...
		if (model != null) {
			...
			}/*else if(model.getType().isFreeTrialDP()) {
				Date purDate = model.getPurchaseDate();
				params = new String[] { dateFmtDisplay.format(purDate) };
				detailInfo = getTextAfterSetParams(OPTIN_FREE_TRIAL_DP_PASS_DETAIL_INFO_TEXT, params);
			}*/
			 else {
				// BSGS pass.
