...
public interface FDListManagerServiceI {

	// public FDCustomerList getCustomerList(FDIdentity identity,
	// EnumCustomerListType type, String listName) throws FDResourceException,
	// RemoteException;
