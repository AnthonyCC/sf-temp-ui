...
public class CreateCMRequest {
    ...
    private String composeShop5Query(ShopTagModel shop5TagModel) throws UnsupportedEncodingException {
        ...
        shop5QueryPart = String.format(shop5QueryPart, URLEncoder.encode(shop5TagModel.getProductId(), "UTF-8"), URLEncoder.encode(shop5TagModel.getProductName(), "UTF-8"),
                URLEncoder.encode(shop5TagModel.getQuantity(), "UTF-8"), URLEncoder.encode(shop5TagModel.getUnitPrice(), "UTF-8"),
                URLEncoder.encode(shop5TagModel.getCategoryId(), "UTF-8"), URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(1)), "UTF-8"),
                URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(2)), "UTF-8"), URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(3)), "UTF-8"),
                URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(4)), "UTF-8"), URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(5)), "UTF-8"),
                URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(6)), "UTF-8"), URLEncoder.encode(isNull(shop5TagModel.getAttributesMaps().get(7)), "UTF-8"));
    ...
    private String composeShop9Query(ShopTagModel shop9TagModel) throws UnsupportedEncodingException {
        ...
        shop9QueryPart = String.format(shop9QueryPart, URLEncoder.encode(shop9TagModel.getProductId(), "UTF-8"), URLEncoder.encode(shop9TagModel.getProductName(), "UTF-8"),
                URLEncoder.encode(shop9TagModel.getQuantity(), "UTF-8"), URLEncoder.encode(shop9TagModel.getUnitPrice(), "UTF-8"),
                URLEncoder.encode(shop9TagModel.getCategoryId(), "UTF-8"), URLEncoder.encode(shop9TagModel.getOrderId(), "UTF-8"),
                URLEncoder.encode(shop9TagModel.getOrderSubtotal(), "UTF-8"), URLEncoder.encode(shop9TagModel.getRegistrationId(), "UTF-8"),
                URLEncoder.encode(isNull(shop9TagModel.getAttributesMaps().get(1)), "UTF-8"), URLEncoder.encode(isNull(shop9TagModel.getAttributesMaps().get(2)), "UTF-8"),
                URLEncoder.encode(isNull(shop9TagModel.getAttributesMaps().get(3)), "UTF-8"), URLEncoder.encode(isNull(shop9TagModel.getAttributesMaps().get(4)), "UTF-8"),
                URLEncoder.encode(isNull(shop9TagModel.getAttributesMaps().get(5)), "UTF-8"), URLEncoder.encode(isNull(shop9TagModel.getAttributesMaps().get(6)), "UTF-8"),
    ...
    private String composeOrderQuery(OrderTagModel orderTagModel) throws UnsupportedEncodingException {
        ...
        orderQueryPart = String.format(orderQueryPart, URLEncoder.encode(orderTagModel.getOrderId(), "UTF-8"), URLEncoder.encode(orderTagModel.getOrderSubtotal(), "UTF-8"),
                URLEncoder.encode(orderTagModel.getOrderShipping(), "UTF-8"), URLEncoder.encode(orderTagModel.getRegistrationId(), "UTF-8"),
                URLEncoder.encode(orderTagModel.getRegistrantCity(), "UTF-8"), URLEncoder.encode(orderTagModel.getRegistrantState(), "UTF-8"),
                URLEncoder.encode(orderTagModel.getRegistrantPostalCode(), "UTF-8"), URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(1)), "UTF-8"),
                URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(2)), "UTF-8"), URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(3)), "UTF-8"),
                URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(4)), "UTF-8"), URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(5)), "UTF-8"),
                URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(6)), "UTF-8"), URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(7)), "UTF-8"),
                URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(8)), "UTF-8"), URLEncoder.encode(isNull(orderTagModel.getAttributesMaps().get(9)), "UTF-8"));
