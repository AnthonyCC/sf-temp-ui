...
public abstract class AbstractShopTagModelBuilder {
    ...
    private CoremetricsExtraData coremetricsExtraData = new CoremetricsExtraData();
    ...
    protected ShopTagModel createTagModel(FDCartLineI cartLine, ProductReference productRef) throws SkipTagException {
        return createTagModel(cartLine, productRef, isStandingOrder, coremetricsExtraData);
    }

    public static ShopTagModel createTagModel(FDCartLineI cartLine, ProductReference productRef, boolean isStandingOrder, CoremetricsExtraData coremetricsExtraData)
        ...
        if (isStandingOrder) {
            ...
            /*
             * else if(EnumATCContext.DDPP.equals(cartLine.getAddedFrom())){ tagModel.setCategoryId(PageViewTagModelBuilder.CustomCategory.DDPP.toString()); }
             */
        ...
        attributesMap.put(14, coremetricsExtraData.getCustomerType());
