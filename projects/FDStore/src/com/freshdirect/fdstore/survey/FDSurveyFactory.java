...
public class FDSurveyFactory {
    ...
    static {
        ...
        FDSurveyQuestion oQ1 = new FDSurveyQuestion("q1_loyalty", "Are you more loyal to Organic/Antibiotic-Free products than conventional products?", true,
                false);
        ...
        FDSurveyQuestion poQ1 = new FDSurveyQuestion("q_problem_area", "Please indicate the areas of concern with your most recent order:", false, true, true);
        ...
        FDSurveyQuestion podQ17 = new FDSurveyQuestion("q_contact_cs", "Have you contacted our Customer Service department about this problem?", true, false,
                false);
        ...
        FDSurveyQuestion cosfQ0 = new FDSurveyQuestion("q1_satisfaction_ques", "Please let us know your satisfaction with the following areas of FreshDirect:",
                false, false);
        ...
        FDSurveyQuestion cosfQ5 = new FDSurveyQuestion("q3_weekly_fd_purchase", "What % of your weekly corporate food purchases are fulfilled by FreshDirect?",
                true, false);
        ...
        FDSurveyQuestion cosfQ7 = new FDSurveyQuestion("q5_compare_ques", "Compared to your other food vendors, how would you rate FreshDirect?", false, false);
        ...
        FDSurveyQuestion cosfQ8 = new FDSurveyQuestion("q6_fd_buy_ques", "What percentage of the following do you currently use FreshDirect for?", false, false);
        ...
        FDSurveyQuestion cosfQ10 = new FDSurveyQuestion("q7_recommendation", "What recommendations would you make to improve FreshDirect's service? ", false,
                false, true);
        ...
        FDSurveyQuestion hamQ1 = new FDSurveyQuestion("VacationDestination", "If you leave the city for vacation this summer where will you go?", true, false);
        ...
        FDSurveyQuestion hamQ7 = new FDSurveyQuestion("VacationDelivery_hdr", "How likely would you be to use a Hamptons delivery option if there was:", false,
                false);
        ...
        FDSurveyQuestion hamQ10 = new FDSurveyQuestion("VacationNoFriday", "<span style=\"font-weight: normal;\">c)</span> ...no delivery on Fridays?", true,
                false);
        ...
        FDSurveyQuestion hamQ11 = new FDSurveyQuestion("VacationCentralLocation",
                "<span style=\"font-weight: normal;\">d)</span> ...no home delivery but a centralized pickup location 10-20 minutes away by car?", true, false);
        ...
        FDSurveyQuestion mdQ2 = new FDSurveyQuestion("MorningDelivery_hdr", "How likely would you be to use the weekday delivery option if there was:", false,
                false);
        ...
        FDSurveyQuestion usQ3 = new FDSurveyQuestion("UsabilitySearch", "When you \"search\" for products, how useful are the results?", true, false, false,
                true);
        ...
        FDSurveyQuestion usQ5 = new FDSurveyQuestion("UsabilityFocusGroup", "Would you be interested in participating in a FreshDirect web site focus group?",
                true, false, false);
        ...
        FDSurveyQuestion dnQ3 = new FDSurveyQuestion("DietNutritionWeight",
