...
public class FDSurveyFactory {
	...
	static {
		...
		FDSurveyQuestion q3 =
			new FDSurveyQuestion("quest3_ContactCS", "Did you contact customer service about your last order?", true, false);
		...
		FDSurveyFactory.getInstance().addSurvey(lastOrderSurvey);

		FDSurvey summerCheckout = new FDSurvey("SummerCheckout");

		q1 = new FDSurveyQuestion("quest1_WhereToDeliver", "Where would you be interested to get delivery?", true, false);
		...
		q2 = new FDSurveyQuestion("quest2_DeliveryTimeA", "What time would you prefer delivery?", true, false);
		...
		q3 = new FDSurveyQuestion("quest2_DeliveryTimeB", "What time would you prefer delivery?", true, false);
		...
		FDSurveyFactory.getInstance().addSurvey(summerCheckout);
		
		List radioOptions_yesNo = new ArrayList();
		...
		radioOptions.add(new FDSurveyAnswer("Important", "Important"));
		radioOptions.add(new FDSurveyAnswer("Somewhat Important", "Somewhat Important"));
		radioOptions.add(new FDSurveyAnswer("Not Important", "Not Important"));
		
		List radioOptions_percentageText = new ArrayList();
		...
		List radioOptions_household = new ArrayList();
		...
		List radioOptions_ageRange = new ArrayList();
		...
		FDSurvey organic2 = new FDSurvey("Organic2");

		FDSurveyQuestion oQ1 =
			new FDSurveyQuestion("q1_loyalty", "Are you more loyal to Organic/Antibiotic-Free products than conventional products?", true, false);
		oQ1.setAnswers(radioOptions_yesNo);
		organic2.addQuestion(oQ1);

		FDSurveyQuestion oQ2 =
			new FDSurveyQuestion(
				"q2_reason",
				"Why do you buy Organic/Antibiotic-Free products?",
				true,
				true);
		...
		FDSurveyQuestion oQ9 =
			new FDSurveyQuestion("q9_age", "What age range do you fall into?", false, false);
		...
		FDSurveyQuestion oQ12 = new FDSurveyQuestion(
			"q12_feedback",
			"Do you have feedback on FreshDirect's Organic offerings?",
			false,
			false,
			true);
		organic2.addQuestion(oQ12);

		FDSurveyFactory.getInstance().addSurvey(organic2);
		
		
		//******* POST ORDER SURVEY *******//
		FDSurvey postOrder = new FDSurvey("PostOrder");
		
		List radioOptions_severity = new ArrayList();
		...
		radioOptions_severity.add(new FDSurveyAnswer("This issue is annoying. If it continues it will become a real problem.", "This issue is annoying. If it continues it will become a real problem."));
		radioOptions_severity.add(new FDSurveyAnswer("This is a serious problem that must be addressed.", "This is a serious problem that must be addressed."));
		radioOptions_severity.add(new FDSurveyAnswer("This is enough to make me never use FreshDirect again.", "This is enough to make me never use FreshDirect again."));
		...
		FDSurveyQuestion poQ1 =
			new FDSurveyQuestion(
				"q_problem_area",
				"Please indicate the areas of concern with your most recent order:",
				false,
				true,
				true);
		...
		FDSurveyQuestion poQ2 =
			new FDSurveyQuestion(
				"q_problem_area_other",
		...
		FDSurveyFactory.getInstance().addSurvey(postOrder);
		
		//******* POST ORDER SURVEY DETAIL *******//
		
		FDSurvey postOrderDetail = new FDSurvey("PostOrderDetail");
		...
		FDSurveyQuestion podQ0 =
			new FDSurveyQuestion(
				"q_missing_item_hdr",
				"Item or box was missing",
				false,
				false,
				false);
		postOrderDetail.addQuestion(podQ0);
		
		FDSurveyQuestion podQ1 =
			new FDSurveyQuestion(
				"q_missing_item",
				"What was missing?",
				false,
		...
		FDSurveyQuestion podQ3 =
			new FDSurveyQuestion(
				"q_product_damage",
				"Product broken or bruised",
				false,
				true,
				false);
		...
		FDSurveyQuestion podQ4 =
			new FDSurveyQuestion(
				"q_package_damage",
				"Package damaged or leaking",
				false,
				true,
				false);
		...
		FDSurveyQuestion podQ6 =
			new FDSurveyQuestion(
				"q_quantity_issue_hdr",
				"Size or cut not as expected",
				false,
				false,
				false);
		postOrderDetail.addQuestion(podQ6);
		
		FDSurveyQuestion podQ7 =
			new FDSurveyQuestion(
				"q_quantity_issue_type",
		...
		FDSurveyQuestion podQ9 =
			new FDSurveyQuestion(
				"q_product_expire",
				"Product near or past expiration date",
				false,
				true,
				false);
		...
		FDSurveyQuestion podQ14 =
			new FDSurveyQuestion(
				"q_customer_service_other",
				"Other (please specify)",
				false,
				false,
				true);
		...
		FDSurveyQuestion podQ16 =
			new FDSurveyQuestion(
				"q_additional_information",
				"Please feel free to provide any additional information that might help us correct this problem:",
				false,
				false,
				true);
		postOrderDetail.addQuestion(podQ16);

		FDSurveyQuestion podQ17 = new FDSurveyQuestion("q_contact_cs", "Have you contacted our Customer Service department about this problem?", true, false, false);
		podQ17.setAnswers(radioOptions_yesNo);
		postOrderDetail.addQuestion(podQ17);
		
		FDSurveyFactory.getInstance().addSurvey(postOrderDetail);
		
		//****** COS FEEDBACK SURVEY ******//
		FDSurvey cos_feedback = new FDSurvey("COS_Feedback_Survey");

		List radioOptions_satisfaction = new ArrayList();
		...
		List radioOptions_preference = new ArrayList();
		...
		List radioOptions_percentage = new ArrayList();
		...
		List radioOptions_performance = new ArrayList();
		...
		List radioOptions_industry = new ArrayList();
		...
		FDSurveyQuestion cosfQ0 =
			new FDSurveyQuestion("q1_satisfaction_ques", "Please let us know your satisfaction with the following areas of FreshDirect:", false, false);
		cos_feedback.addQuestion(cosfQ0);
		
		FDSurveyQuestion cosfQ1 =
			new FDSurveyQuestion("q1_product_quality_hdr", "Product Quality", false, false);
		cos_feedback.addQuestion(cosfQ1);
		
		FDSurveyQuestion cosfQ1_1 =
			new FDSurveyQuestion("q1_product_quality_platters", "Platters", true, false);
		...
		FDSurveyQuestion cosfQ1_4 =
			new FDSurveyQuestion(
				"q1_product_quality_additional",
				"Additional Comments",
				false,
				false,
				true);
		...
		FDSurveyQuestion cosfQ2 =
			new FDSurveyQuestion("q1_delivery_service_hdr", "Delivery Service", false, false);
		...
		FDSurveyQuestion cosfQ2_3 =
			new FDSurveyQuestion(
				"q1_delivery_service_additional",
				"Additional Comments",
				false,
				false,
				true);
		...
		FDSurveyQuestion cosfQ3 =
			new FDSurveyQuestion("q1_website_hdr", "Web Site", false, false);
		cos_feedback.addQuestion(cosfQ3);
		
		FDSurveyQuestion cosfQ3_1 =
			new FDSurveyQuestion("q1_website_ease_of_use", "Ease of use", true, false);
		...
		FDSurveyQuestion cosfQ3_4 =
			new FDSurveyQuestion(
				"q1_website_additional",
				"Additional Comments",
				false,
				false,
				true);
		...
		FDSurveyQuestion cosfQ4 =
			new FDSurveyQuestion("q2_payment_method_question", "Rate the following payment options:", false, false);
		cos_feedback.addQuestion(cosfQ4);
		
		FDSurveyQuestion cosfQ4_1 =
			new FDSurveyQuestion("q2_payment_method_creditcard", "Credit Card", true, false);
		...
		FDSurveyQuestion cosfQ5 = new FDSurveyQuestion("q3_weekly_fd_purchase", "What % of your weekly corporate food purchases are fulfilled by FreshDirect?", true, false);
		cosfQ5.setAnswers(radioOptions_percentage);
		cos_feedback.addQuestion(cosfQ5);

		FDSurveyQuestion cosfQ6 = new FDSurveyQuestion("q4_non_fd_purchase", "Are there any specific products or services for which you are currently not using FreshDirect?", false, false, true);
		cos_feedback.addQuestion(cosfQ6);
		
		FDSurveyQuestion cosfQ7 =
			new FDSurveyQuestion("q5_compare_ques", "Compared to your other food vendors, how would you rate FreshDirect?", false, false);
		cos_feedback.addQuestion(cosfQ7);
		
		FDSurveyQuestion cosfQ7_1 =
			new FDSurveyQuestion("q5_compare_quality", "Quality", true, false);
		...
		FDSurveyQuestion cosfQ7_5 =
			new FDSurveyQuestion(
				"q5_compare_additional",
				"Additional Comments",
				false,
				false,
				true);
		...
		FDSurveyQuestion cosfQ8 =
			new FDSurveyQuestion("q6_fd_buy_ques", "What percentage of the following do you currently use FreshDirect for?", false, false);
		...
		FDSurveyQuestion cosfQ10 =
			new FDSurveyQuestion(
				"q7_recommendation",
				"What recommendations would you make to improve FreshDirect's service? ",
				false,
				false,
				true);
		cos_feedback.addQuestion(cosfQ10);
		
		FDSurveyFactory.getInstance().addSurvey(cos_feedback);
		
		//****** HAMPTONS SURVEY ******//
		FDSurvey hamptons05 = new FDSurvey("Hamptons05");

		List radioOptions_rating = new ArrayList();
		...
		List radioOptions_shopFor = new ArrayList();
		...
		List radioOptions_location = new ArrayList();
		...
		FDSurveyQuestion hamQ1 =
			new FDSurveyQuestion("VacationDestination", "If you leave the city for vacation this summer where will you go?", true, false);
		hamQ1.setAnswers(radioOptions_location);
		hamptons05.addQuestion(hamQ1);
		
		FDSurveyQuestion hamQ1a =
			new FDSurveyQuestion(
				"VacationDestinationOther",
				"Other",
				false,
				false,
				true);
		...
		hamQ3.addAnswer(new FDSurveyAnswer("Weekends plus an extended vacation (1 week to 1 month)", "Weekends plus an extended vacation (1 week to 1 month)"));
		...
		FDSurveyQuestion hamQ5 = new FDSurveyQuestion("VacationOrder", "If FreshDirect offered delivery to the Hamptons during the summer, how often would you be likely to order from FreshDirect?", true, false);
		...
		FDSurveyQuestion hamQ6 = new FDSurveyQuestion("VacationTimeslot", "What delivery days and time periods would be most convenient for you?", true, true);
		...
		FDSurveyQuestion hamQ7 = new FDSurveyQuestion("VacationDelivery_hdr", "How likely would you be to use a Hamptons delivery option if there was:", false, false);
		hamptons05.addQuestion(hamQ7);
		
		FDSurveyQuestion hamQ8 = new FDSurveyQuestion("Vacation1495", "<span style=\"font-weight: normal;\">a)</span> ...a $14.95 delivery fee?", true, false);
		hamQ8.setAnswers(radioOptions_rating);
		hamptons05.addQuestion(hamQ8);
		
		FDSurveyQuestion hamQ9 = new FDSurveyQuestion("Vacation3Hour", "<span style=\"font-weight: normal;\">b)</span> ...a 3-hour delivery window?", true, false);
		hamQ9.setAnswers(radioOptions_rating);
		hamptons05.addQuestion(hamQ9);
		
		FDSurveyQuestion hamQ10 = new FDSurveyQuestion("VacationNoFriday", "<span style=\"font-weight: normal;\">c)</span> ...no delivery on Fridays?", true, false);
		hamQ10.setAnswers(radioOptions_rating);
		hamptons05.addQuestion(hamQ10);
		
		FDSurveyQuestion hamQ11 = new FDSurveyQuestion("VacationCentralLocation", "<span style=\"font-weight: normal;\">d)</span> ...no home delivery but a centralized pickup location 10-20 minutes away by car?", true, false);
		hamQ11.setAnswers(radioOptions_rating);
		hamptons05.addQuestion(hamQ11);
		
		FDSurveyQuestion hamQ12 = new FDSurveyQuestion("VacationPickup", "How likely would you be to pick up your order on your way out of the city at our facility on the other side of the Midtown Tunnel (just a 5-minute detour)?", true, false);
		hamQ12.setAnswers(radioOptions_rating);
		hamptons05.addQuestion(hamQ12);
		
		FDSurveyQuestion hamQ13 = new FDSurveyQuestion("VacationBuy", "What type of food would you be most likely to order from FreshDirect while you're in the Hamptons?", true, true);
		...
		FDSurveyQuestion hamQ14 = new FDSurveyQuestion(
				"VacationSuggestion",
		...
		FDSurveyFactory.getInstance().addSurvey(hamptons05);

		//****** MORNING DELIVERY SURVEY ******//
		FDSurvey morningDelivery = new FDSurvey("MorningDelivery");	
		
		FDSurveyQuestion mdQ0 = new FDSurveyQuestion("MorningDeliveryOption", "If FreshDirect offered a weekday morning delivery option, how likely would you be use it?", true, false, false, true);
		mdQ0.setAnswers(radioOptions_rating);
		morningDelivery.addQuestion(mdQ0);
		
		FDSurveyQuestion mdQ1 = new FDSurveyQuestion("MorningDeliveryTimeslot", "At what time of morning would it be most convenient for you to receive delivery?", true, true);
		...
		FDSurveyQuestion mdQ2 = new FDSurveyQuestion("MorningDelivery_hdr", "How likely would you be to use the weekday delivery option if there was:", false, false);
		morningDelivery.addQuestion(mdQ2);
		
		FDSurveyQuestion mdQ3 = new FDSurveyQuestion("MorningDelivery695", "<span style=\"font-weight: normal;\">a)</span> ...a $6.95 delivery fee?", true, false, false, true, true);
		mdQ3.setAnswers(radioOptions_rating);
		morningDelivery.addQuestion(mdQ3);
		
		FDSurveyQuestion mdQ4 = new FDSurveyQuestion("MorningDelivery3Hour", "<span style=\"font-weight: normal;\">b)</span> ...a 3-hour delivery window?", true, false, false, true, true);
		mdQ4.setAnswers(radioOptions_rating);
		morningDelivery.addQuestion(mdQ4);
		
		FDSurveyQuestion mdQ5 = new FDSurveyQuestion("MorningDelivery8Cutoff", "<span style=\"font-weight: normal;\">c)</span> ...a cutoff time of 8 p.m. the night before?", true, false, false, true, true);
		mdQ5.setAnswers(radioOptions_rating);
		morningDelivery.addQuestion(mdQ5);
		
		FDSurveyQuestion mdQ6 = new FDSurveyQuestion("MorningDeliveryOrder", "If FreshDirect offered weekday morning delivery would you be likely to order more or less frequently?", true, false, false, true);
		mdQ6.setAnswers(radioOptions_rating);
		morningDelivery.addQuestion(mdQ6);
		
		FDSurveyQuestion mdQ7 = new FDSurveyQuestion("MorningDeliveryBuy", "If FreshDirect offered weekday morning delivery would you be likely to buy more or less food with each order?", true, false, false, true);
		mdQ7.setAnswers(radioOptions_rating);
		morningDelivery.addQuestion(mdQ7);
		
		FDSurveyQuestion mdQ8 =
			new FDSurveyQuestion("MorningDeliveryRecipient", "If FreshDirect offered weekday morning delivery, who would most likely be available to receive the order?", true, false);
		...
		FDSurveyQuestion mdQ8a =
			new FDSurveyQuestion(
				"MorningDeliveryRecipientOther",
				"Other",
				false,
				false,
				true);
		...
		FDSurveyQuestion mdQ9 =
			new FDSurveyQuestion("MorningDeliveryPurchase", "Approximately how much of your food is purchased from FreshDirect?", true, false);
		...
		FDSurveyQuestion mdQ10 = new FDSurveyQuestion(
			"MorningDeliverySuggestion",
			"Do you have any other suggestions or ideas?",
			false,
			false,
			true);
		...
		FDSurveyFactory.getInstance().addSurvey(morningDelivery);
		
		//****** USABILITY SURVEY ******//
		FDSurvey usability = new FDSurvey("Usability");	
		
		List radioOptions_ratingNa = new ArrayList();
		...
		List radioOptions_recommendRating = new ArrayList();
		...
		FDSurveyQuestion usQ1 = new FDSurveyQuestion("UsabilityInitialEase", "On your first few orders, how easy was it to use the FreshDirect web site?", true, false, false, true);
		...
		FDSurveyQuestion usQ3 = new FDSurveyQuestion("UsabilitySearch", "When you \"search\" for products, how useful are the results?", true, false, false, true);
		usQ3.setAnswers(radioOptions_ratingNa);
		usability.addQuestion(usQ3);
		
		FDSurveyQuestion usQ4 = new FDSurveyQuestion(
			"UsabilityAdditional",
			"What additional features would be most useful to you?",
			false,
			false,
			true);
		usability.addQuestion(usQ4);
		
		FDSurveyQuestion usQ5 = new FDSurveyQuestion("UsabilityFocusGroup", "Would you be interested in participating in a FreshDirect web site focus group?", true, false, false);
		usQ5.setAnswers(radioOptions_yesNo);
		usability.addQuestion(usQ5);
		
		FDSurveyFactory.getInstance().addSurvey(usability);
		
//		****** DIET & NUTRITION SURVEY ******//
		FDSurvey dietNutrition = new FDSurvey("DietNutrition");	
		
		FDSurveyQuestion dnQ0 = new FDSurveyQuestion("DietNutritionImportance", "When you shop for food, how important are considerations of nutrition and diet?", true, false, false, true);
		dnQ0.setAnswers(radioOptions_rating);
		dietNutrition.addQuestion(dnQ0);
		
		FDSurveyQuestion dnQ1 = new FDSurveyQuestion("DietNutritionSpecific", "When you shop for food, what specific nutritional factors are important to you? (please choose all that apply)", true, true);
		...
		FDSurveyQuestion dnQ1a =
			new FDSurveyQuestion(
				"DietNutritionSpecificOther",
				"Other",
				false,
				false,
				true);
		...
		FDSurveyQuestion dnQ2 = new FDSurveyQuestion("DietNutritionShop", "When you shop for food, how significant a factor is weight maintenance or weight loss?", true, false, false, true);
		dnQ2.setAnswers(radioOptions_rating);
		dietNutrition.addQuestion(dnQ2);
		
		FDSurveyQuestion dnQ3 = new FDSurveyQuestion("DietNutritionWeight", "What best describes your strategy when you try to maintain a healthy weight, or lose weight? <span style=\"\">(choose all that apply)</span>", true, true);
		...
		dnQ3.addAnswer(new FDSurveyAnswer("I choose whole grains, fruits, vegetables, seafood, and limited lean meats", "I choose whole grains, fruits, vegetables, seafood, and limited lean meats"));
		...
		FDSurveyQuestion dnQ3a =
			new FDSurveyQuestion(
				"DietNutritionWeightOther",
				"Other",
				false,
				false,
				true);
		...
		FDSurveyQuestion dnQ4 = new FDSurveyQuestion("DietNutritionVegetarian", "Is your household predominantly vegetarian? (please choose one)", true, false);
		...
		dnQ4.addAnswer(new FDSurveyAnswer("vegetarian including dairy, eggs, and seafood and/or poultry", "vegetarian including dairy, eggs, and seafood and/or poultry"));
		...
		FDSurveyQuestion dnQ4a =
			new FDSurveyQuestion(
				"DietNutritionVegetarianOther",
				"Other",
				false,
				false,
				true);
		...
		FDSurveyQuestion dnQ5 = new FDSurveyQuestion("DietNutritionAllergy", "Does anyone in your household have food allergies? (choose all that apply)", true, true);
		...
		FDSurveyQuestion dnQ5a =
			new FDSurveyQuestion(
				"DietNutritionAllergyOther",
				"Other",
				false,
				false,
				true);
		...
		FDSurveyFactory.getInstance().addSurvey(dietNutrition);
		
		
		FDSurvey rcptPageSurvey2 = new FDSurvey("ReceiptPageSurvey2");

		FDSurveyQuestion rpsQ1 = new FDSurveyQuestion("RcptPageSurveyShopFor", "When you shop for food, how many people do you typically shop for?", true, false);
		...
		FDSurveyQuestion rpsQ3a =
			new FDSurveyQuestion(
				"RcptPageSurveyCuisinesOther",
				"Other",
				false,
				false,
				true);
		...
		FDSurveyQuestion rpsQ4 = new FDSurveyQuestion("RcptPageSurveyDiet", "When you shop for food, what specific nutrition/dietary factors are important to you?", false, true);
		...
		FDSurveyQuestion rpsQ4a =
			new FDSurveyQuestion(
				"RcptPageSurveyDietOther",
				"Other",
				false,
				false,
				true);
