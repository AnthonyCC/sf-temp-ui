...
public class FourMinuteMealsHelper {
	...
	public static final ContentKey departmentKey = ContentKeyFactory.get( ContentType.Department, "fdi" );
	public static final ContentKey sidesInASnapKey = ContentKeyFactory.get( ContentType.Category, "hmr_fresh_sias" );
	public static final ContentKey editorialKey = ContentKeyFactory.get( ContentType.Category, "4mm-editorial" );
	public static final ContentKey filterPageKey = ContentKeyFactory.get( ContentType.Category, "4mm-view-all" );
	public static final ContentKey aboutPageKey = ContentKeyFactory.get( ContentType.Category, "4mm-about" );
	public static final ContentKey ingredientdomainKey = ContentKeyFactory.get( ContentType.Domain, "4mm-ingredients" );
	public static final ContentKey sideTypeDomainKey = ContentKeyFactory.get( ContentType.Domain, "4mm-sides" );
	public static final ContentKey extraVeggieSideDVKey = ContentKeyFactory.get( ContentType.DomainValue, "4mm-sides-vegetable" );
	public static final ContentKey extraStarchSideDVKey = ContentKeyFactory.get( ContentType.DomainValue, "4mm-sides-starch" );
