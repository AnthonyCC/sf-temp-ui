...
//	public List loadPromotions() throws FDResourceException, RemoteException;
	...
	public void updateDpFreeTrialOptin(FDIdentity identity,Boolean dpFreeTrialOptin) throws FDResourceException,RemoteException;

	public boolean isDpOptinOrNot(FDIdentity identity) throws FDResourceException,RemoteException;
}
