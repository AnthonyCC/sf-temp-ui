...
//TEmailRuntimeException
	...
	public int setDpFreeTrialOptin(boolean dpFreeTrialOptin, String custId) throws FDResourceException {
		Connection conn = null;
		try {
			conn = getConnection();
			return FDUserDAO.updateDpFreeTrialOptin(conn, dpFreeTrialOptin,custId);
		} catch (SQLException sqle) {
