...
// COS17-76
	...
	private static final String PENDING_SELF_COMPLAINT_WITH_CASHBACK_QUERY = "select distinct c.id as self_complaint_id, s.customer_id as customer_id, c.amount as complaint_amount, c.note as note "
	...
	private static final String PENDING_SELF_COMPLAINT_WITHOUT_CASHBACK_QUERY = "select distinct c.id as self_complaint_id, s.customer_id as customer_id, c.amount as complaint_amount, c.note as note "
			+ "from cust.complaint c " + "left join cust.sale s on s.id = c.sale_id "
			+ "join cust.complaintline cl on cl.complaint_id = c.id "
