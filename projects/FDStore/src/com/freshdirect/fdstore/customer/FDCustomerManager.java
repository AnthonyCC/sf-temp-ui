	...
	return addOnOrderCount;
		...
		public static ErpAuthorizationModel verifyCard(FDActionInfo info, ErpPaymentMethodI paymentMethod, boolean paymentechEnabled) throws FDResourceException,ErpPaymentMethodException{
			try{
				lookupManagerHome();
				FDCustomerManagerSB sb = managerHome.create();
				ErpAuthorizationModel auth=sb.verifyCard(info, paymentMethod, paymentechEnabled);
				return auth;
			}catch (CreateException ce) {
				invalidateManagerHome();
				throw new FDResourceException(ce, "Error creating bean");
		...
		public static void updateDpFreeTrialOptin(FDIdentity identity, Boolean dpFreeTrialOptin) throws FDResourceException{
			try{
				lookupManagerHome();
				FDCustomerManagerSB sb = managerHome.create();
				sb.updateDpFreeTrialOptin(identity, dpFreeTrialOptin);
			}catch (CreateException ce) {
				invalidateManagerHome();
				throw new FDResourceException(ce, "Error creating bean");
			} catch (RemoteException re) {
		...
		public static boolean isDpOptinOrNot(FDIdentity identity) throws FDResourceException{
			try{
				lookupManagerHome();
				FDCustomerManagerSB sb = managerHome.create();
				return sb.isDpOptinOrNot(identity);
			}catch (CreateException ce) {
				invalidateManagerHome();
				throw new FDResourceException(ce, "Error creating bean");
			} catch (RemoteException re) {
