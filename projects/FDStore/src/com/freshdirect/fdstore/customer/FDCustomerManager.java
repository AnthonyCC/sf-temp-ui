...
//			complaint.setAutoCaseId(autoCasePK.getId());
	...
	return addOnOrderCount;
		...
		public static int updateDpFreeTrialOptin(boolean dpFreeTrialOptin,String custId) throws FDResourceException{
			lookupManagerHome();
			try {
				FDCustomerManagerSB sb = managerHome.create();
				return sb.setDpFreeTrialOptin(dpFreeTrialOptin, custId);
			}catch (RemoteException e) {
