...
public class AutocompleteService {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(AutocompleteService.class);

    private final static int MAX_AUTOCOMPLETE_HITS = 20;

    public final static Set<String> stopWords = new HashSet<String>(Arrays.asList(new String[] { "I", "a", "about", "an", "and", "are", "as", "at", "be", "by", "for", "from",
            "how", "in",
