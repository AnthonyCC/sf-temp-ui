...
@Component
public class ECheckRulesConfiguration extends RuleConfiguration {

    public ECheckRulesConfiguration() {
    ...
    @Value("${com.freshdirect.fdstore.rules.echeck.location}")
    ...
    public String serviceName() {
        return "com.freshdirect.fdstore.rules.echeck.Engine";
    }
