...
public class FDFactoryProductInfoAspect extends BaseProductInfoAspect {
    ...
    public FDProductInfo getProductInfo(String sku) throws RemoteException, FDSkuNotFoundException, FDResourceException {
        ...
        if (avialableSkus.contains(sku)) {
            ...
            productInfo = new FDProductInfo(sku,1, materials,EnumATPRule.MATERIAL, EnumAvailabilityStatus.AVAILABLE, now,inventoryCache,null, null, dummyList, null, null, null, availDates);
    		...
    		dummyList.addZonePriceInfo(ZonePriceListing.MASTER_DEFAULT_ZONE, dummy);            
            productInfo = new FDProductInfo(sku,1, materials,EnumATPRule.MATERIAL, EnumAvailabilityStatus.DISCONTINUED, now,inventoryCache,null, null, dummyList, null, null, null, availDates);
        }
