...
import com.freshdirect.fdstore.promotion.management.ejb.FDPromotionManagerDAO;
...
public class FDPromotionManagerDAOTestCase extends DbTestCaseSupport {
	...
	public void testCreatePromotion() throws Exception {
		...
		FDPromotionModel p1 = new FDPromotionModel();
		...
		// execute
		PrimaryKey pk = FDPromotionManagerDAO.createPromotion(conn, p1);
		...
		FDPromotionModel p2 = FDPromotionManagerDAO.getPromotion(conn, p1.getPromotionCode());
	...
	public void testStorePromotion() throws Exception {
		...
		FDPromotionModel p1 = new FDPromotionModel(new PrimaryKey("p2"));
		...
		// execute
		FDPromotionManagerDAO.storePromotion(conn, p1);
	...
	public void testRemovePromotion() throws Exception {
		...
		// verify
		FDPromotionModel p2 = FDPromotionManagerDAO.getPromotion(conn, "P_THREE");
