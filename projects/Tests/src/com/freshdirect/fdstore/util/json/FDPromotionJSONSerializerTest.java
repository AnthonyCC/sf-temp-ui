...
public class FDPromotionJSONSerializerTest extends TestCase {
	...
	public void testNewPromoProperties() {
		...
		klassProps.put(com.freshdirect.fdstore.promotion.management.FDPromotionNewModel.class,
				new String[]{"applyFraud", "assignedCustomerParams", "assignedCustomerSize",  "assignedCustomerUserIds", "attributeList", "audienceDesc", "auditChanges", "cartBrands", "cartCats", "cartDepts", "cartSkus", "cartStrategies", "categoryName", "combineOffer", "createdBy", "createdDate", "custStrategies", "dcpdBrands", "dcpdCats", "dcpdData", "dcpdDepts", "dcpdRecCats", "dcpdRecps", "dcpdSkus", "description", "dlvDates", "dlvZoneStrategies", "dollarOffList", "expirationDate", "expirationDateStr", "expirationDay", "expirationMonth", "expirationTimeStr", "expirationYear", "extendDpDays", "favoritesOnly", "fuelSurchargeIncluded", "geoRestrictionType", "lastPublishedDate", "maxAmount", "maxItemCount", "maxUsage", "minSubtotal", "modifiedBy", "modifiedDate", "name", "needCustomerList", "needDryGoods", "offerDesc", "offerType", "onHold", "paymentStrategies", "percentOff", "perishable", "productName", "profileOperator", "promotionCode", "promotionType", "publishes", "redeemCount", "redemptionCode", "rollingExpirationDays", "ruleBased", "skuQuantity", "startDate", "startDateStr", "startDay", "startMonth", "startTimeStr", "startYear", "stateCountyList", "status", "subTotalExcludeSkus", "terms", "tmpAssignedCustomerUserIds", "waiveChargeType", "zipRestrictions"});		
