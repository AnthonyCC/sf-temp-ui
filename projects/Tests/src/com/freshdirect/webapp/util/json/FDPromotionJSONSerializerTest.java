...
public class FDPromotionJSONSerializerTest extends TestCase {
	...
	public void testNewPromoProperties() {
		...
		klassProps.put(com.freshdirect.fdstore.promotion.management.FDPromoContentModel.class,
				new String[]{"contentId", "contentType", "excluded", "promotionId"});
		klassProps.put(com.freshdirect.fdstore.promotion.management.FDPromoCustStrategyModel.class,
				new String[]{"cohorts", "dpExpEnd", "dpExpStart", "dpStatus", "excludeSameDayDlv", "orderRangeEnd", "orderRangeStart", "orderTypeCorporate", "orderTypeHome", "orderTypePickup", "paymentType", "priorEcheckUse", "promotionId"});
		klassProps.put(com.freshdirect.fdstore.promotion.management.FDPromotionNewModel.class,
				new String[]{"applyFraud", "assignedCustomerParams", "assignedCustomerUserIds", "attributeList", "audienceDesc", "auditChanges", "cartStrategies", "categoryName", "combineOffer", "createdBy", "createdDate", "custStrategies", "dcpdData", "description", "dlvDates", "dlvZoneStrategies", "expirationDate", "expirationDateStr", "expirationDay", "expirationMonth", "expirationTimeStr", "expirationYear", "extendDpDays", "favoritesOnly", "geoRestrictionType", "lastPublishedDate", "maxAmount", "maxItemCount", "maxUsage", "minSubtotal", "modifiedBy", "modifiedDate", "name", "needCustomerList", "needDryGoods", "offerDesc", "offerType", "onHold", "paymentStrategies", "percentOff", "perishable", "productName", "profileOperator", "promotionCode", "promotionType", "publishes", "redeemCount", "redemptionCode", "rollingExpirationDays", "ruleBased", "skuQuantity", "startDate", "startDateStr", "startDay", "startMonth", "startTimeStr", "startYear", "status", "subTotalExcludeSkus", "terms", "tmpAssignedCustomerUserIds", "waiveChargeType", "zipRestrictions"});
