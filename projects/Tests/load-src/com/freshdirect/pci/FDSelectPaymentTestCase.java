...
public class FDSelectPaymentTestCase extends DbTestCaseSupport {
	private Context ctx;
	private ErpCustomerHome customerHome;
    ...
    public FDSelectPaymentTestCase(String name) throws Exception{
        super(name);
		super.setUp();
...
//	}
	...
	public void testSelectPaymentMethod() throws Exception {
		...
		ErpPaymentMethodPersistentBean readBean = new ErpPaymentMethodPersistentBean(); 
		readBean.setPK(bean.getPK());
		readBean.load(conn);
		assertNotNull(readBean.getModel());
	}
	

	
	public static Test suite() {
		return new TestSuite(FDSelectPaymentTestCase.class);
	}
