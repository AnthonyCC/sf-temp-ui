...
public class WebUIDriver extends BaseAppDriver {
			...
			if (webDriver.findElements(
				...
				for (int i = 0; i < products_to_verify.size(); i++) {
					...
					.findElement(
							By
							.xpath(objMap
									.getLocator("strverifyProductNameOld")))
									.getText();
	...
	public void FD_chooseReserveTimeSlot(String Address, String ReserveType,
		...
		} else if(webDriver.findElements(By.xpath(objMap.getLocator("strerrorReservation"))).size()>0)
		{
			...
			RESULT
			.failed("Reservation of Time slot",
					"Time slot reservation should be successful",
	...
	public void FD_addToCart(String method, String item,
		...
		try {
			...
			try {
				product = handleOutOfStock(product, reorder_page,
			...
			try {
				item_customizable = itemCustomizationCheck(product,
			...
			if (method.equalsIgnoreCase("click")
				...
				try{
					...
					itemAddUsingClick(product, quantity, new_modify_flag);
	...
	//function to validate the added item in /FD_addToCartFunction
	...
	// function to add item into cart using hover method in /FD_addToCartFunction
	...
	// function to item into cart using click method in /FD_addToCartFunction
	public void itemAddUsingClick(WebElement product, String quantity, String new_or_modify) {
	...
	// function to check item customizable in /FD_addToCartFunction
	public boolean itemCustomizationCheck(WebElement product,
			boolean reorderPage, String gridOrList) {
	...
	// function to handle out of stock in /FD_addToCartFunction
	public WebElement handleOutOfStock(WebElement product, boolean reorderPage,
	...
	// function for the product selection in /FD_addToCartFunction
								...
								if (ItemText.equals(LineItem)) {
									...
									try {
										...
										// Checking if dropdown is displayed for item quantity
											...
											Qty = Double.parseDouble(CartItemRows.get(j).findElement(By.className(
													objMap.getLocator("drpqtyCRM"))).getAttribute("value"));
											Select Dropdown = new Select(CartItemRows.get(j).findElement(
													By.className(objMap.getLocator("drpqtyCRM"))));
									...
									By.xpath(objMap
											...
											.findElement(
													...
													.xpath(objMap
															...
															.isDisplayed()) {
								uiDriver.getwebDriverLocator(
										objMap.getLocator("btnClose")).click();
								break;
							}
							count++;
						} while (count < 5);
					...
					if (dept.contains("Deli") || dept.contains("Kitchen")
						...
						for (int i = 1; i < 6; i++) {
							if (dept.contains("Deli")) {
								sub_dept_xpath = "//li[@data-id='deliandcheese']/li/div/ul/li[@class='submenuitem']["
									+ i + "]/span/a";
							} else if (dept.equals("Kitchen")) {
								sub_dept_xpath = "//li[@data-id='kitchen']/li/div/ul/li[@class='submenuitem']["
									+ i + "]/span/a";
		...
		try {
			...
			case Add:
				...
				try{
					...
					RESULT.failed("Add Delivery address",
							"User should be able add new delivery address",
							"address could not get added due to: "+e.getMessage());
				}
