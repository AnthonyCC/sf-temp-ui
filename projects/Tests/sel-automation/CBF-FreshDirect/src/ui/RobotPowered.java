...
public class RobotPowered {
	...
	public void moveToElement(WebElement element) {
		...
		if (((String) GCONFIG.get("Browser")).equalsIgnoreCase("IE") || ((String) GCONFIG.get("Browser")).equalsIgnoreCase("SAFARI")) {
			//Scroll to Element
			...
			int xPosition = (int) (driver.manage().window().getPosition().x
					+ browserFurnitureOffsetX + webElementX - 30);
			int yPosition = (int) (driver.manage().window().getPosition().y
					+ browserFurnitureOffsetY + webElementY - 19);
