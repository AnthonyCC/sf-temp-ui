...
public class AccountDetailsCRMDriver extends BaseModuleDriver {
	...
	throws InterruptedException, FindFailed {
		...
		{
			RESULT.failed("Error encountered", "Basic Detail should be updated",
					"Error occured : " + e);
		}
	}
	...
	throws InterruptedException, FindFailed {
		...
		{
			RESULT.failed("Error encountered", "Address Detail should be updated",
					"Error occured" + e);
		}
	}
	...
	throws InterruptedException, FindFailed {
		try{
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.name(objMap.getLocator("txtNew_Userid"))));
		...
		{
			RESULT.failed("Error encountered", "login Detail should be updated",
					"Error occured" + e);
		}
	}
	...
	throws InterruptedException, FindFailed {
		try {
			...
			RESULT.failed("Error encountered", "Payment detail should be added",
					"Error occured" + e);
		}
	}
	...
	throws InterruptedException, FindFailed {
		try {
			...
			RESULT.failed("Error encountered", "Payment Detail should be edited",
					"Error occured" + e);
		}
	...
	public void CRMPasswordValidation(DataRow input, DataRow output){
		try {
			...
			RESULT.failed("Error encountered", "Password should be validated",
					"Error occured" + e);
		}
	}
