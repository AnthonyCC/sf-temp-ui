...
public class StandingOrderDriver extends BaseModuleDriver{
	...
	public void CreateStandingOrder(DataRow input, DataRow output) throws FindFailed, InterruptedException
	{
		try{
			...
			if (uiDriver.isDisplayed("btnstartShopping"))
			{
...
/*
	...
	public void ModifyStandingOrder(DataRow input, DataRow output) throws FindFailed, InterruptedException
	{
		SleepUtils.getInstance().sleep(TimeSlab.YIELD);
	...
	public void CancelStandingOrder(DataRow input, DataRow output) throws FindFailed, InterruptedException
	{
		SleepUtils.getInstance().sleep(TimeSlab.YIELD);
		List<WebElement> SOlist = webDriver.findElements(By.xpath(objMap.getLocator("lstsoList")));           //List of Standing Orders         
		int iSize = SOlist.size();
