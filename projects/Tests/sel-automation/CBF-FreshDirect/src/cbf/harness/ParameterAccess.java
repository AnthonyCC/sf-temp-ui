/******************************************************************************
$Id : ParameterAccess.java 9/8/2014 1:21:47 PM
 ...
 * 
 */
public class ParameterAccess implements TestResultTracker.Reporter {
	...
	public void copyRecentParameters(String inputGroupName,
		...
		for (String groupName : groupNames) {
			// Map group = mostRecentParameters;
			if (groupName == null) {
				ix = ix + 1;
				continue;
			}
	...
	/**
	 * Returns ParameterAccess format string
	 */
	...
	private GroupInfo addGroup(String groupName, String scope) {
		...
		case 'G':
			group = new PersistentMap(groupName);
			break;
		case 'I':
			group = new DataRow();
			break;
