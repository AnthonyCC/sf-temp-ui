/******************************************************************************
$Id : TestResult.java 9/8/2014 1:21:38 PM
...
/**
 * Defines the result object structure with the details like
 * entityType, can be TESTSUITE, TESTCASE, ITERATION, TESTSTEP etc
 * entityName, actual value of the entity like tc name, iter name, step name etc
 * entityDetails, actual entity object which gives complete details of entity
 * finalRsType, final result of the executed entity
 * startTime, execution start time
 * finishTime, execution finish time
 * msRsType, most significant result
 * msDetails, most significant result's details
 */
public class TestResult {
	...
	/**
	 * Updates TestResult object for msRsType, msDetails etc with the current execution check details
	 * 
	 * @param rsType
	...
	/**
	 * Updates TestResult object for msRsType, msDetails etc with the current execution child results
	 * 
	 * @param rsType
	 *            result type of the current child node under execution like PASSED, ERROR etc
	 * @param childResult
	...
	private void add(ResultType rsType, Object details) {
		int rsTypeCount = 0;
		/*boolean rsT=rsTypeCounts.isEmpty();
		if(rsT==false){
