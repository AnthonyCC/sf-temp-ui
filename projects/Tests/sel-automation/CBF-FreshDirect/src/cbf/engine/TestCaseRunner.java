/******************************************************************************
$Id : TestCaseRunner.java 9/8/2014 1:21:37 PM
...
public class TestCaseRunner {
	 ...
	 * @param oRPT
	 *            TestResultLogger object in order to log execution results
	 */
				...
				for (int i = 0; i < iterationCount; i++) {
					...
					if (iterRs.miscInfo.containsKey("abortRs")) {
						try {
							...
							logger.handleError("Iteration recovery failed:", e.getMessage());
						}
					}
				}
			}
