...
public class DlvRestrictionDAO {
	...
	private static final String GEOGRAPHY_RESTRICTION = "select ID, gr.NAME NAME, INACTIVE, COMMENTS,DAY_OF_WEEK, CONDITION, START_TIME, END_TIME  from dlv.GEO_RESTRICTION gr, dlv.GEO_RESTRICTION_BOUNDARY gb , dlv.GEO_RESTRICTION_DAYS gd where gr.BOUNDARY_CODE = gb.code and gr.ID = gd.RESTRICTION_ID and (gr.INACTIVE is null or gr.INACTIVE <> 'X') and mdsys.sdo_relate(gb.geoloc, mdsys.sdo_geometry(2001, 8265, mdsys.sdo_point_type(?,?,NULL), NULL, NULL), 'mask=ANYINTERACT querytype=WINDOW') ='TRUE'";
