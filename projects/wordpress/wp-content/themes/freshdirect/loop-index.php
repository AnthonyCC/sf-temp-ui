...
<?php
	include('utils/fd_the_content.php');
?>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : $content = fd_the_content();?>
	...
	<div class="myfd-post">			
			...
			<?php 
				...
				if ( count( $categories )  && $categories[0]->slug != "uncategorized" ) : $cat_name = $categories[0]->description or $categories[0]->name; $cat_id = $categories[0]->ID;
			?>
					<div class="myfd-category"><a href="<?php echo get_category_link($categories[0]->cat_ID)?>"><?php echo $cat_name;?></a></div>
				<?php endif; ?>
