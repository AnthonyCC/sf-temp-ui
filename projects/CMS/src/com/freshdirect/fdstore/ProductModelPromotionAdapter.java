...
public class ProductModelPromotionAdapter implements ProductModel, Serializable,
	...
	public String getPpSkuCode() {
		return ppSkuCode;
	}

	public void setPpSkuCode(String ppSkuCode) {
		this.ppSkuCode = ppSkuCode;
	}

	public ProductModelPromotionAdapter(ProductModel productModel,
			boolean isFeatured, String featuredHeader,String sku) {
	...
	public SkuModel getDefaultSku() {		 
		return productModel.getSku(ppSkuCode);
	}
	...
	public String getDefaultSkuCode() {		 
		return ppSkuCode;//productModel.getDefaultSkuCode();
	}
	...
	public FDProductInfo getFdProdInfo() {
		return fdProdInfo;
	}

	public void setFdProdInfo(FDProductInfo fdProdInfo) {
		this.fdProdInfo = fdProdInfo;
	}
