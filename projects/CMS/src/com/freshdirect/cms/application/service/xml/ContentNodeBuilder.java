 ...
 * </pre>
 */
public abstract class ContentNodeBuilder extends CmsNodeHandler {
    static long ID_GENERATOR = 0;

    protected static final Logger LOGGER = LoggerFactory.getInstance(ContentNodeBuilder.class);
    private static final Object IGNORE = new Object();
    private final Stack<Object> stack = new Stack<Object>();

    protected abstract void nodeCreated(ContentNodeI node);
    ...
    class Relationship extends Slot {
            Object value = null;
