...
public final class LoadMaterialConfigurationsTask extends PublishTask implements Callable<Map<String, Map<String, Map<String, String>>>> {
    ...
    @Override
    public Map<String, Map<String, Map<String, String>>> call() throws Exception {
        publishMessageLogger.log(publishId, new StorePublishMessage(StorePublishMessageSeverity.INFO, "Loading material configurations", LoadMaterialConfigurationsTask.class.getSimpleName()));

        return erpsService.fetchMaterialCharacteristics();
    }
