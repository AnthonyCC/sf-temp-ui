...
public class ChangeHistory extends LayoutContainer {
    ...
    private static final String RED = "#ffeeee;";
    private static final String GREEN = "#eeffee;";
    private static final String DRAFT_INDICATOR = "draft";

    private ChangeSetQuery query;
    private ChangeSetQueryResponse response;
    ...
    public void init(ChangeSetQueryResponse result) {
        ...
        boolean isMainBrach = !result.getChanges().isEmpty() && !result.getChanges().get(0).getChangeSetId().contains(DRAFT_INDICATOR);
        final BasePagingLoader<BasePagingLoadResult<BaseModelData>> loader = new BasePagingLoader<BasePagingLoadResult<BaseModelData>>(new ChangeSetLoader(result));
    ...
    public HtmlContainer createHeader() {
        return new HtmlContainer("<table width=\"100%\" class=\"pageTitle\" cellspacing=\"0\" cellpadding=\"0\">" + "<tbody><tr>" + "<td valign=\"bottom\">"
                + "<h1 class=\"view-title\">" + getLabel() + "</h1>" + "</td>" + "<td width=\"75\" valign=\"bottom\" align=\"right\" style=\"line-height: 0pt;\">"
    ...
    private ColumnConfig colourColumn(String colour, ColumnConfig cc) {
