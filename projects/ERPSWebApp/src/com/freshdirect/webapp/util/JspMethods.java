...
public class JspMethods {
	...
	public static boolean isMobile(String useragent) {
		...
		if (!"".equals(ua)) {
			if(ua.matches("(?i).*((android|bb\\d+|meego).+mobile|avantgo|bada\\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\\.(browser|link)|vodafone|wap|windows ce|xda|xiino|familyhub).*")
	...
	public static void main(String a[]) {
		...
		String useragent = "Mozilla/5.0 (Linux; Tizen 3.0; FamilyHub ) AppleWebKit/537.3 (KHTML, like Gecko) Version/2.3 Mobile Safari/537.3 ";
		System.out.println(useragent+"-->"+isMobile(useragent));
	}
}
