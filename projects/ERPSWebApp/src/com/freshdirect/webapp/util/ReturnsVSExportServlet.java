...
public class ReturnsVSExportServlet extends AbstractVSExportServlet{

	private static Category LOGGER = LoggerFactory.getInstance(ReturnsVSExportServlet.class);
	...
	private Map createReportLine(FDCustomerOrderInfo order) {
		...
		reportLine.put("LAST NAME", order.getLastName());
		reportLine.put("HOME PHONE", order.getPhone());
		return reportLine;
	}
