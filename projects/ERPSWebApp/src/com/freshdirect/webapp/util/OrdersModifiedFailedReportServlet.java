...
public class OrdersModifiedFailedReportServlet extends AbstractExcelReportServlet {
	
	private static Category LOGGER = LoggerFactory.getInstance(OrdersModifiedFailedReportServlet.class);
	...
	private List getStandardReport(HttpServletRequest request) throws FDResourceException {
		...
		criteria.setCriteriaMap("statuses", new String[]{"Failed"});
