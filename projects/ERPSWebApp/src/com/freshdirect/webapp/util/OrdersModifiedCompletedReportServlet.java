...
public class OrdersModifiedCompletedReportServlet extends AbstractExcelReportServlet {
	
	private static Category LOGGER = LoggerFactory.getInstance(OrdersModifiedCompletedReportServlet.class);
	...
	private List getStandardReport(HttpServletRequest request) throws FDResourceException {
		...
		criteria.setCriteriaMap("statuses", new String[]{"Completed"});
