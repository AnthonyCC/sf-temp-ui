...
public class QuickShopListRequestObject {
	...
	private String yourLastOrderId;
	...
	public void setTab(EnumQuickShopTab tabType) {
	...
	public String getYourLastOrderId() {
		return yourLastOrderId;
	}
	public void setYourLastOrderId(String yourLastOrderId) {
		this.yourLastOrderId = yourLastOrderId;
	}	
