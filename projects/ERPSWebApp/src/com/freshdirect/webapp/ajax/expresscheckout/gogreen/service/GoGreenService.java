...
public class GoGreenService {
	...
	public boolean overLayGoGreenPreferences(FDUserI user) throws FDResourceException {
		return FDCustomerManager.overLayGoGreenPreferences(user.getIdentity().getErpCustomerPK());
	}
