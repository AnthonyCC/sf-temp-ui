...
public class PaymentService {
	...
	private static final Comparator<ErpPaymentMethodI> PAYMENT_COMPARATOR_BY_ID_REVERSED = ComparatorChain.<ErpPaymentMethodI> reverseOrder(ComparatorChain.create(PAYMENT_COMPARATOR_BY_ID));
