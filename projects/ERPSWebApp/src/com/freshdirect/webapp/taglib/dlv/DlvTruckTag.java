...
public class DlvTruckTag extends com.freshdirect.framework.webapp.BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		if(selectedDate != null && !"".equals(selectedDate)){
			try{
				...
				trucks = sb.getTruckNumbersForDate(sf.parse(selectedDate));
		...
		pageContext.setAttribute(id, trucks);
