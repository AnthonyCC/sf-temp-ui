...
public interface SystemMessageList {
	...
	public final static String MSG_OUTERSPACE_ADDRESS			= "We're sorry, but you must have a valid home address in one of our <a href=\"javascript:popup('/help/delivery_zones.jsp','large')\">delivery zones</a> in order to register a new dlivery location.";
