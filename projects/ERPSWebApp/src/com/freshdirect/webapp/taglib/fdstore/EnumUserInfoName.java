...
public class EnumUserInfoName implements Serializable {
	...
	public final static EnumUserInfoName					DLV_UNATTENDED_DELIVERY_INSTRUCTIONS	= new EnumUserInfoName( "unattendedDeliveryInstr", "Unattended Delivery Instructions" );
