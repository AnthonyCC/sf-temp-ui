		...
		switch(Integer.parseInt(parsedValue)) {
			...
			case 35:  sm.setLocation1(true);
					  ...
					  if(user.getPromotionHistory().getPromotionUsageCount("5FREEDEL", "") < 5) {
						  sm.setMessage("</font><font class=\"text12\"><b>Enjoy five deliveries fee-free!</b>  Enter code <b><a href=\"javascript:popup(\'/shared/promotion_popup.jsp?promoCode=5FREEDEL\',\'large\')\">5FREEDEL</a></b> at checkout.</font><font>");
					  }
					  return sm;
