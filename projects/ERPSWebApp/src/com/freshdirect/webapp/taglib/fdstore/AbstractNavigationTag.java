...
public abstract class AbstractNavigationTag extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        SearchResults res = getResults(getCriteria(request));
        ...
        FilteredSearchResults fres = new FilteredSearchResults(res.getSearchTerm(), res, userId, "",user.getPricingContext());
