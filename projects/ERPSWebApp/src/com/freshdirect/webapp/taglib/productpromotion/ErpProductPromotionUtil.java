...
public class ErpProductPromotionUtil {
	...
	public static Object getAvailableCmsDepartments() {
        ...
        if(store != null) {
	       ...
	       ContentKey contentKey = ContentKeyFactory.get(FDContentTypes.DEPARTMENT,"wgd");
		...
		contentKey = ContentKeyFactory.get(FDContentTypes.DEPARTMENT,"our_picks");
	...
	public static String getDepartmentNameById(String deptId){
		CmsManager          manager     = CmsManager.getInstance();
		ContentKey contentKey = ContentKeyFactory.get(FDContentTypes.DEPARTMENT,deptId);
		ContentNodeI contentNode = manager.getContentNode(contentKey);
		if(null != contentNode){
			return (String)contentNode.getAttributeValue("FULL_NAME");
		}
		return "";
	}
}
