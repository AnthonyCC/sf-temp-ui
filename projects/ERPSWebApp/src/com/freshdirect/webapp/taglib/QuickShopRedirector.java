...
public class QuickShopRedirector extends BodyTagSupport {
	...
	public static enum FROM { NEW_PAST_ORDERS, NEW_LISTS, NEW_FD_LISTS, NEW_SO, NEW_SO_DETAILS, OLD_INDEX, OLD_SO, OLD_SO_DETAILS, OLD_QS_ORDER_SHOP_FROM, OLD_QS_LIST_SHOP_FROM, OLD_QS_ALL_LISTS };
	...
	/* =======================================================
	 * 		REDIRECTS from OLD to NEW quickshop pages
	 * ======================================================= */	
	...
	/* =======================================================
	 * 		REDIRECTS from NEW to OLD quickshop pages
	 * ======================================================= */
	...
	private String getRedirectForNewStandingOrderPage() {
		...
		// Not allowed to see the new stuff, send him back to the old and ugly page
	...
	public static boolean isEligibleForStandingOrders( FDUserI user ) {
		...
		// For "COS check" the same logic is used as for "eligible for standing orders" 
