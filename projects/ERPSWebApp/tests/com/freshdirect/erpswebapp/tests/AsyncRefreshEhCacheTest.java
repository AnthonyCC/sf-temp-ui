...
public class AsyncRefreshEhCacheTest extends TestCase {

	private AsyncDBRefreshEhCache<String, Object> cache;

	private AsyncDBRefreshEhCache<String, Object> buildCache(String name, int num) {
		return new AsyncDBRefreshEhCache<String, Object>(name, num);
	}
	
	@Test
	public void testReadWriteEhcache() {
		cache = buildCache("testEhCache1", 10);
	...
	public void testCapacity() {
		cache = buildCache("testEhCache2", 10);
		assertEquals(cache.size(), 0);
	...
	public void testRemove() {
		cache = buildCache("testEhCache3", 10);
		assertEquals(cache.size(), 0);
	...
	public void testUpdate() {
		cache = buildCache("testEhCache4", 10);
		assertEquals(cache.size(), 0);
