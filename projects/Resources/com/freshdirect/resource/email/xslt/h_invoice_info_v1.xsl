...
<tr>
	...
	<xsl:if test="order/depositValue > 0">
		<tr valign="top" class="orderSummary">
			<td colspan="2" align="right">NY State Bottle Deposit and Handling Fee:</td>
	...
	<tr valign="top">
		<td colspan="6" align="right"><b>D = NY State Bottle Deposit and Handling Fee</b></td>
	</tr>
</table>
</xsl:template>
...
<xsl:template name="orderlinesView">
	...
	<tr class="orderViewSummary">
		<td colspan="5" align="right">NY State Bottle Deposit and Handling Fee:</td>
