...
Your standing order has been scheduled for delivery.
...
PLEASE NOTE that some of the items in your standing order list were not available when your order was placed. Please check the content of the order below to make sure you're getting everything you need.
</xsl:if>
