...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
		...
		<td>
			...
			<p>Now that you've tried <a href="http://www.freshdirect.com/cmp">FreshDirect</a>, I'd like to find out personally about your experience. </p>
			
            <p><a href="http://www.freshdirect.com/cmp">FreshDirect</a> was created to give New Yorker's the best food at the best possible price. We are committed to providing the highest service levels possible and as such we are interested in how you judge our performance and to provide us with feedback accordingly.  Are you pleased with the food quality? Is our selection satisfactory? How were our prices?  Is there anything we can do better? How is delivery? Are there items you would like us carry? <a href="mailto:cmpservice@freshdirect.com">Drop us an e-mail</a> at <a href="mailto:cmpservice@freshdirect.com">cmpservice@freshdirect.com</a> and let us know your honest thoughts.</p>
			...
			<p>As a reminder your delivery day is - Thursday <a href="http://www.freshdirect.com/cmp">www.freshdirect.com/cmp</a> Access Code CMP600</p>
			...
			Creator and CEO
			<br/>
			<a href="http://www.freshdirect.com/cmp">FreshDirect</a>
			<br/>
