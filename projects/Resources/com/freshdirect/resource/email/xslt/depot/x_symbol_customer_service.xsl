...
Please note that FreshDirect delivery will now be available on Thursdays only -- all Monday delivery slots have been suspended for the summer months. The time of delivery remains the same -- 3:30 pm to 4:30 pm for the Bohemia office and 5 pm to 7pm for Holtsville.
...
Our Customer Service Team is always standing by to address any questions you may have about your FreshDirect order, the Web site, or any other topic of concern. Our toll free number is 1-866-511-1240. If you would prefer to send email, our address is symbolservice@freshdirect.com. 
