...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
		<tr>
		<td>
			<p>A few weeks ago you signed up for more information about <a href="http://www.freshdirect.com/symbol">FreshDirect</a>.</p>
			
			<p>We still want to welcome you to <a href="http://www.freshdirect.com/symbol">FreshDirect</a> with <b>$50 worth of free fresh food.</b>*</p>
            ...
            <p>Log on to <a href="http://www.freshdirect.com/symbol">www.freshdirect.com/symbol</a><xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;</xsl:text>Access Code: SYM123</p>

        <p>Start shopping for your favorite things, and get ready to have $50 worth of free fresh food.</p>

			<p>You can also contact us via email at <a href="mailto:symbolservice@freshdirect.com">symbolservice@freshdirect.com</a></p>
            ...
            <p>*See <a href="http://www.freshdirect.com/symbol">website</a> for details.</p>
