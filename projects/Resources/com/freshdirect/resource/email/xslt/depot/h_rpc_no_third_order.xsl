...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
		...
		<td>
			...
			<p>Now that you've tried <a href="http://www.freshdirect.com/rpc">FreshDirect</a>, I'd like to find out personally about your experience.</p>
			
            <p>I created <a href="http://www.freshdirect.com/rpc">FreshDirect</a> to give New Yorker's the best food at the best possible price. I also believe in treating customers like my own family, so I want to know the good and the bad. Are you pleased with the food quality? Is our selection satisfactory? How were our prices?  Is there anything we can do better? <a href="mailto:joe@freshdirect.com">Drop me an e-mail</a> and let me know your honest thoughts.</p>
            ...
            <p>As a reminder your delivery days are - Tuesday &amp; Friday from 3:00pm to 6:00pm<br />
			<a href="http://www.freshdirect.com/rpc">www.freshdirect.com/rpc</a></p>
