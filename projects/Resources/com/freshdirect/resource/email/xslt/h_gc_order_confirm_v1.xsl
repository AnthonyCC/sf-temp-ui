...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dt='http://xsltsl.org/date-time' version="1.0">
	...
	<xsl:include href='h_gc_recipient_info_v1.xsl'/>
...
<font face="verdana, arial, sans-serif" size="1" color="black">
									...
									<p>Thank you for your Gift Card order (<b>#<xsl:value-of select="order/erpSalesId"/></b>). Your Recipient List and payment details are below. The final total is<b> $<xsl:value-of select='format-number(order/subTotal, "###,##0.00", "USD")'/>.</b></p>
