...
<html>
	<head>
		...
		<title>FreshDirect expands delivery to Middle Village!</title>
...
Better Food. Better Prices. Delivered to Middle Village!

Middle Village Delivery Details:

Deliveries Begin Thursday April 1, 2004.

Place your order on the web today!

A note about our delivery areas:  
We look forward to delivering to additional parts of Middle Village in the near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>Better Food. Better Prices. Delivered to Middle Village!</b></font></td></tr>
                <tr valign="top">
				<td width="363" class="bodyCopySmall"><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="14" /><br/><img src="http://www.freshdirect.com/media_stat/images/template/email/middle_village.gif" width="350" height="363" alt="Map" border="0"/><br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="8" /></td>
<td width="25"><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="25" height="1" /></td>
                ...
                <b>Middle Village Delivery Details:</b>
                <br/><img src="http://www.freshdirect.com/media_stat/images/layout/clear.gif" width="1" height="12" /><br/>
                <font color="#CC0000" class="red12px"><b>Deliveries Begin Thursday April 1, 2004.</b></font>
                <br/>
                Place your order on the web today!
                ...
                <font color="#CC0000" class="red12px">We look forward to delivering to additional parts of Middle Village in the near future. We thank you for your patience and will send you an email as we continue to expand our delivery area.</font>
