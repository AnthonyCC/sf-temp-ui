...
<html>
	<head>
		...
		<title>FreshDirect expands delivery to more of Brooklyn Heights!</title>
...
Better Food. Better Prices. Delivered to Brooklyn Heights!
...
<td><xsl:call-template name="h_header_v1" />
	...
	<table cellpadding="0" cellspacing="0" width="90%">
                <tr><td colspan="3" class="header"><font size="4"><b>Better Food. Better Prices. Delivered to Brooklyn Heights!</b></font></td></tr>
                <tr valign="top">
                <td width="283" class="bodyCopySmall"><img src="/media_stat/images/layout/clear.gif" width="1" height="14" /><br/><img src="/media_stat/images/template/email/dumbo_bheights_2.gif" width="286" height="553" alt="Map"/><br/><img src="/media_stat/images/layout/clear.gif" width="1" height="8" /><br/><img src="/media_stat/images/layout/clear.gif" width="1" height="8" /></td>
