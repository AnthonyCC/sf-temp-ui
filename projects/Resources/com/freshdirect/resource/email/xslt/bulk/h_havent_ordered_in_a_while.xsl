...
<TABLE cellpadding="0" cellspacing="0"><TR>
	...
	<TR>
	<TD WIDTH="100%"><TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0"><TR><TD WIDTH="100%" BGCOLOR="#CCCCCC"><img src="/images/clear.gif" width="600" height="1" border="0" alt="" /></TD></TR></TABLE>
	<br/>
	<table cellpadding="0" cellspacing="0">
	<TR>
	<TD><P><b>Dear <xsl:value-of select="@first-name"/></b>,</P>
