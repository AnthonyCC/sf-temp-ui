...
public class MktAdminSystemException extends RuntimeException {
	...
	public MktAdminSystemException(String errorCode,Throwable e){
		this(e);
		this.errorCode=errorCode;		
	}
	     
    
	public MktAdminSystemException(Throwable e){
