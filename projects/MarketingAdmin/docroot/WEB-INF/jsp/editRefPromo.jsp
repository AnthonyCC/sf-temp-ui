...
<tmpl:insert template='site.jsp'>
	...
	%>
		...
		<div align="center">
			<table border="0" align="center"> <tbody>
				<tr><td colspan="2"><h2>Successfully Updated Refer A Friend Promotion</h2></td></tr>
	...
	%>
		<input type="hidden" name="action" value="editRef" />
		<br/>	
		<div align="center">
			<table border="0" align="center"> <tbody>
				<tr><td colspan="2"><h2>Review Edits for Refer A Friend Promotion</h2></td></tr>
				...
				<tr><td>Image Upload:</td><td><%=model.getSiteAccessImageFile()%></td></tr>
	...
	<% } if(!"true".equals(success)) { %>
		...
		<br/>	
		<div align="center" id="mainform" style="display:<%=("true".equals(success) || "true".equals(showApprove))?"none":"block"%>;">		<spring1:bind path="command.referralId">
					<input type="hidden" name="referralId" value='<c1:out value="${status.value}"/>' />
				</spring1:bind>
				...
				<table border="0" align="center"> <tbody>					
					...
					<INPUT type = "submit" value="Save Promotion"  /></td>					
					</tr>
				</tbody>
			</table>
		 </div>
