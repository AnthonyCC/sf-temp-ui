...
<tmpl:put name='title' direct='true'>FD Admin - Move Media Folder</tmpl:put>
<tmpl:put name='header' direct='true'>Move Media Folder</tmpl:put>
<tmpl:put name='direction' direct='true'>From</tmpl:put>
<tmpl:put name='path' direct='true'>/department</tmpl:put>
<tmpl:put name='button' direct='true'><table cellpadding="1" cellspacing="0" border="0" align="center" class="add_move"><tr><td class="button"><a href="#" class="button">&nbsp;move >>&nbsp;</a></td></tr></table></tmpl:put>
