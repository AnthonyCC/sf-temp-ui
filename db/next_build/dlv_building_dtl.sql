DROP TABLE DLV.DELIVERY_BUILDING_DTL;
...
(
  ...
  SVC_ADDR_LINE2        VARCHAR2(255 BYTE),
...
ALTER TABLE DELIVERY_BUILDING_DTL ADD (
  PRIMARY KEY
 (ID)
    USING INDEX 
    TABLESPACE FDDLVDAT
...
ALTER TABLE DELIVERY_BUILDING_DTL ADD (
 ...
 REFERENCES DELIVERY_BUILDING (ID));

GRANT DELETE, INSERT, SELECT, UPDATE ON  DELIVERY_BUILDING_DTL TO FDSTORE_PRDA;

GRANT DELETE, INSERT, SELECT, UPDATE ON  DELIVERY_BUILDING_DTL TO FDTRN_PRDA;

DROP SEQUENCE DLV.DELIVERY_BUILDING_DTL_SEQ;

CREATE SEQUENCE DLV.DELIVERY_BUILDING_DTL_SEQ
  START WITH 1
...
GRANT SELECT ON  DLV.DELIVERY_BUILDING_DTL_SEQ TO FDSTORE_PRDA;

GRANT SELECT ON  DLV.DELIVERY_BUILDING_DTL_SEQ TO FDTRN_PRDA;
