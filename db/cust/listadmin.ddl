CREATE TABLE LIST_VIRTUAL_OBJECT
(
...
CREATE TABLE LIST_TEMPLATE_OBJECT
(
...
CREATE TABLE LIST_TEMPLATE_FIELD
(
  ID VARCHAR2(16)          NOT NULL,
  TEMPLATE_ID VARCHAR2(16) NOT NULL,
...
CREATE TABLE LIST_TEMPLATE_ORDER_BY
(
  ID VARCHAR2(16)          NOT NULL,
  TEMPLATE_ID VARCHAR2(16) NOT NULL,
  FIELD_NAME VARCHAR2(30)  NOT NULL,
...
CREATE TABLE LIST_TEMPLATE_GROUP_BY
(
  ID VARCHAR2(16)           NOT NULL,
  TEMPLATE_ID VARCHAR2(16)  NOT NULL,
  FIELD_NAME VARCHAR2(30)   NOT NULL,
...
CREATE TABLE LIST_CONSTANT_CLAUSE
(
  ID VARCHAR2(16)       NOT NULL,
...
CREATE TABLE LIST_PARAM_CLAUSE
(
  ID VARCHAR2(16)    NOT NULL,
...
CREATE TABLE LIST_STATIC_DROPDOWN_CLAUSE
(
  ID VARCHAR2(16)       NOT NULL,
...
CREATE TABLE LIST_SELECT_DROPDOWN_CLAUSE
(
  ID VARCHAR2(16)           NOT NULL,
...
CREATE TABLE LIST_QUERY_DROPDOWN_CLAUSE
(
  ID VARCHAR2(16)       NOT NULL,
...
CREATE TABLE LIST_ENUM_DROPDOWN_CLAUSE
(
  ID VARCHAR2(16)          NOT NULL,
...
CREATE TABLE LIST_STORED_QUERY
(
  ID VARCHAR2(16)              NOT NULL,
  NAME VARCHAR2(30)            NOT NULL,
  TEMPLATE_ID VARCHAR2(16)     NOT NULL,
...
CREATE TABLE LIST_STORED_QUERY_VALUE
(
  ID VARCHAR2(16)               NOT NULL,
