	   	...
	   	BEGIN
		 	  DECLARE
					 ...
					 CURSOR timeslot_cur (resource_id_in TIMESLOT.RESOURCE_ID%TYPE) is
					 		SELECT BASE_DATE, START_TIME, END_TIME, CUTOFF_TIME, STATUS, CAPACITY, PLANNED_CAPACITY, TRAFFIC_FACTOR, ZONE_ID
							FROM TIMESLOT
					 ...
					 BEGIN
						  ...
						  THEN
							  ...
							  LOOP
								  ...
								  LOOP
								  	  INSERT INTO TIMESLOT(ID, RESOURCE_ID, BASE_DATE, START_TIME, END_TIME, CUTOFF_TIME, STATUS, CAPACITY, PLANNED_CAPACITY, TRAFFIC_FACTOR, ZONE_ID)
									  VALUES(SYSTEM_SEQ.NEXTVAL, resource_id, work_date, timeslot_rec.START_TIME, timeslot_rec.END_TIME, timeslot_rec.CUTOFF_TIME, timeslot_rec.STATUS, timeslot_rec.CAPACITY, timeslot_rec.PLANNED_CAPACITY, timeslot_rec.TRAFFIC_FACTOR, zone_id_in);
