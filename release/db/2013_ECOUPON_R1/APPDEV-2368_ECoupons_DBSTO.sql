...
CREATE TABLE CUST.COUPON_TRANS_DETAILS
 (
  ...
  COUPON_ID VARCHAR2(9 BYTE)    NOT NULL,
  COUPONLINE_ID VARCHAR2(16 BYTE)    NOT NULL,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON_HISTORY TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON_HISTORY TO FDSTORE_PRDB;

GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON TO FDSTORE_PRDB;

GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPONLINE TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPONLINE TO FDSTORE_PRDB; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPONLINE TO FDTRN_PRDA;

GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON_REWARD_UPC TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON_REWARD_UPC TO FDSTORE_PRDB;

GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON_REQ_UPC TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.FDCOUPON_REQ_UPC TO FDSTORE_PRDB;

GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPON_TRANS TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPON_TRANS TO FDSTORE_PRDB;

GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPON_TRANS_DETAILS TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.COUPON_TRANS_DETAILS TO FDSTORE_PRDB;

GRANT DELETE, INSERT, SELECT, UPDATE ON MIS.COUPON_ACTIVITY_LOG TO FDSTORE_PRDA; 
GRANT DELETE, INSERT, SELECT, UPDATE ON MIS.COUPON_ACTIVITY_LOG TO FDSTORE_PRDB;
