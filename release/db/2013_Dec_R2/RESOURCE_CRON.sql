    ...
    IS
     BEGIN
      ...
      CURSOR timeslot_cur (resource_id_in TIMESLOT.RESOURCE_ID%TYPE) is
        SELECT BASE_DATE, START_TIME, END_TIME, ROUTING_START_TIME, ROUTING_END_TIME, CUTOFF_TIME, PREMIUM_CUTOFF_TIME, STATUS, CAPACITY, PREMIUM_CAPACITY, PLANNED_CAPACITY, TRAFFIC_FACTOR, ZONE_ID, CT_CAPACITY, PREMIUM_CT_CAPACITY
       FROM TIMESLOT
        ...
        resource_rec := null;
         ...
         LOOP
          ...
          LOOP
             ...
             INSERT INTO TIMESLOT(ID, RESOURCE_ID, BASE_DATE, START_TIME, END_TIME, ROUTING_START_TIME, ROUTING_END_TIME, CUTOFF_TIME, PREMIUM_CUTOFF_TIME, STATUS, CAPACITY, PREMIUM_CAPACITY, PLANNED_CAPACITY, TRAFFIC_FACTOR, ZONE_ID, CT_CAPACITY, PREMIUM_CT_CAPACITY, IS_DYNAMIC)
           VALUES(SYSTEM_SEQ.NEXTVAL, resource_id, work_date, timeslot_rec.START_TIME, timeslot_rec.END_TIME, timeslot_rec.ROUTING_START_TIME, timeslot_rec.ROUTING_END_TIME, timeslot_rec.CUTOFF_TIME, timeslot_rec.PREMIUM_CUTOFF_TIME, timeslot_rec.STATUS, timeslot_rec.CAPACITY,timeslot_rec.PREMIUM_CAPACITY, timeslot_rec.PLANNED_CAPACITY, timeslot_rec.TRAFFIC_FACTOR, zone_id_in, timeslot_rec.CT_CAPACITY,timeslot_rec.PREMIUM_CT_CAPACITY, is_dynamic_in);
