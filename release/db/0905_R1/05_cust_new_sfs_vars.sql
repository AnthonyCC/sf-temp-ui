...
INSERT INTO SS_VARIANT_PARAMS (id, key, value) VALUES ('c_save_yf_1', 'prez_desc', '{0,choice,-1#''<p style="margin-top: 25px;">ENJOY YOUR <span class="save-price">{1,number,percent} OFF</span>!</p><p class="text11">You''''''''re saving ${2,number,0.00} for the favorites already in your cart.</p><p class="text11" style="margin-bottom: 25px;">For your convenience, <a href="{3}">click here</a> for ALL of your favorite items at their regular prices.</p>''|0#''<p style="text-transform: uppercase;">LET US TREAT YOU TO <span class="save-price">{1,number,percent}</span> OFF A FEW OF YOUR FAVORITE ITEMS</p><p class="text11"><a href="#">Click here for details</a></p>''|0<''<p>You''''''''re saving <span class="save-price">${2,number,0.00}</span> for the favorites already in your cart.</p><p class="text11">Keep shopping.. you''''''''ll save {1,number,percent} on any items you buy from<br>Your Favorites. <a href="#">Click here for details</a></p>''}');
...
INSERT INTO SS_VARIANT_PARAMS (id, key, value) VALUES ('c_save_fdf_1', 'prez_desc', '{0,choice,-1#''<p style="margin-top: 25px;">ENJOY YOUR <span class="save-price">{1,number,percent} OFF</span>!</p><p class="text11">You''''''''re saving ${2,number,0.00} for the favorites already in your cart.</p><p class="text11" style="margin-bottom: 25px;">For your convenience, <a href="{3}">click here</a> for your favorite items at their regular prices.</p>''|0#''<p style="text-transform: uppercase;">LET US TREAT YOU TO <span class="save-price">{1,number,percent}</span> OFF A FEW OF OUR FAVORITE ITEMS</p><p class="text11"><a href="#">Click here for details</a></p>''|0<''<p>You''''''''re saving <span class="save-price">${2,number,0.00}</span> for the favorites already in your cart.</p><p class="text11">Keep shopping.. you''''''''ll save {1,number,percent} on any items you buy from<br>FreshDirect Favorites. <a href="#">Click here for details</a></p>''}');
