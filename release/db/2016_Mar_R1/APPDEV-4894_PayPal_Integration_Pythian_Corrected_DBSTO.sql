...
AS
  SELECT NAME,
	  INGRIAN.IngFastDecryptOp (ACCOUNT_NUMBER_NEW,
				    ...
				    'PAYMENTINFO_NEW',
				    'ACCOUNT_NUMBER_NEW',
				    '734337025E4EB1F702879DF6D2E6CC13')
	     ACCOUNT_NUMBER,
	  EXPIRATION_DATE,
	  CARD_TYPE,
	  ADDRESS1,
...
BEGIN 
  ...
  INSERT INTO CUST.PAYMENTINFO_NEW 
              ...
              ( 
                          :NEW.NAME, 
                          ' ', 
                          ingrian.ingfastencryptvarcharbyname(:NEW.ACCOUNT_NUMBER, 'CUST', 'PAYMENTINFO', 'ACCOUNT_NUMBER', '734337025E4EB1F702879DF6D2E6CC13'),
                          :NEW.EXPIRATION_DATE, 
                          :NEW.CARD_TYPE, 
                          :NEW.ADDRESS1, 
                          :NEW.ADDRESS2, 
...
EWALLET_ID, VENDOR_EWALLET_ID, EWALLET_TX_ID, PAYPAL_ACCOUNT_ID, DEVICE_ID) AS
  SELECT ID,
	  ...
	  INGRIAN.IngFastDecryptOp (ACCOUNT_NUMBER_NEW,
				    ...
				    'PAYMENTMETHOD_NEW',
				    'ACCOUNT_NUMBER_NEW',
				    '734337025E4EB1F702879DF6D2E6CC13') ACCOUNT_NUMBER,
	  EXPIRATION_DATE,
	  CARD_TYPE,
	  ADDRESS1,
	  ADDRESS2,
...
BEGIN 
  ...
  INSERT INTO CUST.PAYMENTMETHOD_NEW 
              ...
              ( 
                          ...
                          :NEW.NAME, 
                          ' ', 
                          ingrian.ingfastencryptvarcharbyname(:NEW.ACCOUNT_NUMBER, 'CUST', 'PAYMENTMETHOD', 'ACCOUNT_NUMBER', '734337025E4EB1F702879DF6D2E6CC13'),
                          :NEW.EXPIRATION_DATE, 
                          :NEW.CARD_TYPE, 
                          :NEW.ADDRESS1, 
                          :NEW.ADDRESS2, 
...
BEGIN 
  ...
  SET    ID = :NEW.ID , 
         ...
         ACCOUNT_NUMBER_NEW = decode (:NEW.ACCOUNT_NUMBER , 
                                        :OLD.ACCOUNT_NUMBER , ACCOUNT_NUMBER_NEW , 
                                        ingrian.ingfastencryptvarcharbyname(:NEW.ACCOUNT_NUMBER, 'CUST', 'PAYMENTMETHO D', 'ACCOUNT_NUMBER', '734337025E4EB1F702879DF6D2E6CC13') ) , 
         EXPIRATION_DATE = :NEW.EXPIRATION_DATE , 
         CARD_TYPE = :NEW.CARD_TYPE , 
         ADDRESS1 = :NEW.ADDRESS1 , 
         ADDRESS2 = :NEW.ADDRESS2 , 
