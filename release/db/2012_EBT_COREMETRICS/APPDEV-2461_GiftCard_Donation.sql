...
INSERT INTO cms.relationshipdefinition (NAME, ID, CONTENTTYPE_ID, INHERITABLE, REQUIRED, NAVIGABLE, READONLY, LABEL, CARDINALITY_CODE) VALUES ('ORGANIZATION_LOGO_SMALL', 'DonationOrganization.ORGANIZATION_LOGO_SMALL', 'DonationOrganization', 'F', 'T', 'F', 'F', 'Organization logo Small', 'One');
INSERT INTO cms.relationshipdefinition (NAME, ID, CONTENTTYPE_ID, INHERITABLE, REQUIRED, NAVIGABLE, READONLY, LABEL, CARDINALITY_CODE) VALUES ('ORGANIZATION_RECIEPT_LOGO', 'DonationOrganization.ORGANIZATION_RECIEPT_LOGO', 'DonationOrganization', 'F', 'F', 'F', 'F', 'Organization logo Small', 'One');
