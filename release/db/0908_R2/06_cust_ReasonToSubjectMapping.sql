...
update complaint_code set subject_code='ORQ-015' where code='DAMBOXC';
update complaint_code set priority='9' where code='DAMBOXC';
update complaint_code set DLV_ISSUE_CODE=(select code from complaint_dlv_type where name='Damaged') where code='DAMBOXC';

update complaint_code set subject_code='DSQ-003' where code='DAMBOXD';
update complaint_code set priority='10' where code='DAMBOXD';
update complaint_code set DLV_ISSUE_CODE=(select code from complaint_dlv_type where name='Damaged') where code='DAMBOXD';

update complaint_code set subject_code='ORQ-004' where code='RTLBWRBX';
update complaint_code set priority='11' where code='RTLBWRBX';
...
update complaint_code set priority='12' where code='DPAUTODL';
update complaint_code set subject_code='DPQ-007' where code='DPAUTOCX';
update complaint_code set priority='12' where code='DPAUTOCX';
update complaint_code set subject_code='DPQ-007' where code='DPWRONG';
update complaint_code set priority='12' where code='DPWRONG';
update complaint_code set subject_code='ORQ-013' where code='EARLDEL';
update complaint_code set priority='13' where code='EARLDEL';
update complaint_code set subject_code='DSQ-016' where code='DLVPRB';
update complaint_code set priority='14' where code='DLVPRB';
update complaint_code set subject_code='LDQ-004' where code='LATEDL0';
update complaint_code set priority='15' where code='LATEDL0';
...
update complaint_code set priority='16' where code='LATEDL30';
...
update complaint_code set priority='17' where code='LATEDL60';
...
update complaint_code set priority='18' where code='LATEDL90';
...
update complaint_code set priority='19' where code='PRDXCL';
...
update complaint_code set priority='19' where code='PRDEXP';
...
update complaint_code set priority='20' where code='AVDFZN';
...
update complaint_code set priority='20' where code='WARM';
...
update complaint_code set priority='21' where code='DEFROST';
...
update complaint_code set priority='22' where code='PITTS';
...
update complaint_code set priority='23' where code='SMELL';
...
update complaint_code set priority='23' where code='DISCOL';
...
update complaint_code set priority='23' where code='XSOFT';
...
update complaint_code set priority='23' where code='HRDSTL';
...
update complaint_code set priority='23' where code='MOLDY';
...
update complaint_code set priority='23' where code='ORIPE';
...
update complaint_code set priority='23' where code='PRDDED';
...
update complaint_code set priority='23' where code='QUALDIS';
...
update complaint_code set priority='23' where code='SFOPCL';
...
update complaint_code set priority='23' where code='SPOILED';
...
update complaint_code set priority='23' where code='TOOFAT';
...
update complaint_code set priority='23' where code='TOOGRIS';
...
update complaint_code set priority='23' where code='TOOSPIC';
...
update complaint_code set priority='23' where code='URIPE';
...
update complaint_code set priority='23' where code='WILTED';
...
update complaint_code set priority='24' where code='BRUISED';
...
update complaint_code set priority='24' where code='CRACKED';
...
update complaint_code set priority='24' where code='PRDLEK';
...
update complaint_code set priority='25' where code='RTLBWRPR';
...
update complaint_code set priority='26' where code='MISITM';
...
update complaint_code set priority='27' where code='DISCUT';
...
update complaint_code set priority='27' where code='NTCUBSLC';
...
update complaint_code set priority='27' where code='NTGNDSPC';
...
update complaint_code set priority='27' where code='NTPAKSPC';
...
update complaint_code set priority='27' where code='NTASEX';
...
update complaint_code set priority='27' where code='SIZBIG';
...
update complaint_code set priority='27' where code='SIZSML';
...
update complaint_code set priority='27' where code='WRMISPK';
...
update complaint_code set priority='27' where code='WRNSIZ';
...
update complaint_code set priority='28' where code='DNTCAN';
...
update complaint_code set priority='28' where code='DAMBOPRD';
...
update complaint_code set priority='28' where code='PRDDAM';
...
update complaint_code set priority='29' where code='BULK';
...
update complaint_code set priority='29' where code='CUSNOSUB';
update complaint_code set subject_code='ORQ-005' where code='DISPSIZ';
update complaint_code set priority='29' where code='DISPSIZ';
...
update complaint_code set priority='30' where code='RTGDIS';
...
update complaint_code set priority='32' where code='SRTITM';
