...
ALTER TABLE TRANSP.PLAN ADD ( CONSTRAINT SCRIBDESTFACILITY_FK FOREIGN KEY (DESTINATION_FACILITY) REFERENCES TRANSP.TRN_FACILITY (ID)
                                                     , CONSTRAINT SCRIBORIGINFACILITY_FK  FOREIGN KEY (ORIGIN_FACILITY) REFERENCES TRANSP.TRN_FACILITY (ID));
...
ALTER TABLE TRANSP.DISPATCH ADD ( CONSTRAINT SCRIBDESTFACILITY_FK FOREIGN KEY (DESTINATION_FACILITY) REFERENCES TRANSP.TRN_FACILITY (ID)
                                                     , CONSTRAINT SCRIBORIGINFACILITY_FK  FOREIGN KEY (ORIGIN_FACILITY) REFERENCES TRANSP.TRN_FACILITY (ID));
                                                     
/*WAVE_INSTANCE*/

ALTER TABLE TRANSP.WAVE_INSTANCE  ADD  (ORIGIN_FACILITY    VARCHAR2(16 BYTE)   NOT NULL);
