...
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.EVENTSTOPNUMBERBREAKDOWN TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.EVENTSTOPNUMBERBREAKDOWN TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.EVENTSTOPNUMBERBREAKDOWN TO appdev;
GRANT SELECT ON TRANSP.EVENTSTOPNUMBERBREAKDOWN TO mis;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.EVENTTYPE TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.EVENTTYPE TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.EVENTTYPE TO appdev;
GRANT SELECT ON TRANSP.EVENTTYPE TO mis;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.EVENTSUBTYPE TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.EVENTSUBTYPE TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.EVENTSUBTYPE TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.MOTEVENTLOGBOOK TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.MOTEVENTLOGBOOK TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.MOTEVENTLOGBOOK TO mis;
GRANT SELECT ON TRANSP.MOTEVENTLOGBOOK TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.MOTSTOPNUMBERBREAKDOWN TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.MOTSTOPNUMBERBREAKDOWN TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.MOTSTOPNUMBERBREAKDOWN TO mis;
GRANT SELECT ON TRANSP.MOTSTOPNUMBERBREAKDOWN TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.MOTEVENTTYPE TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.MOTEVENTTYPE TO fdtrn_ststg01;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.AUTHUSERS TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.AUTHUSERS TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.AUTHUSERS TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.AUTHUSER_PRIVILEGE TO fdstore_ststg01;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.AUTHUSER_PRIVILEGE TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.AUTHUSER_PRIVILEGE TO appdev;

GRANT SELECT ON TRANSP.EVENTLOGSEQ TO fdstore_ststg01;
GRANT SELECT ON TRANSP.EVENTLOGSEQ TO fdtrn_ststg01;
GRANT SELECT ON TRANSP.EVENTLOGSEQ TO appdev;
GRANT SELECT ON TRANSP.MOTEVENTLOGSEQ TO fdstore_ststg01;
GRANT SELECT ON TRANSP.MOTEVENTLOGSEQ TO fdtrn_ststg01;
