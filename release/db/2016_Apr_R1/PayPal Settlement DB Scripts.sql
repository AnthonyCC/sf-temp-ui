...
GRANT SELECT ON CUST.SETTLEMENT_TRANSACTION TO APPDEV;
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.SETTLEMENT_TRANSACTION TO FDSTORE_STPRD01;
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.SETTLEMENT_TRANSACTION TO FDSTORE_PRDA;
GRANT DELETE, INSERT, SELECT, UPDATE ON CUST.SETTLEMENT_TRANSACTION TO FDSTORE_PRDB;


INSERT INTO CUST.AFFILIATE_MERCHANT (AFFILIATE_CODE,PAYMENT_TYPE,MERCHANT) VALUES('FD','PYPL','Freshdirect');
INSERT INTO CUST.AFFILIATE_MERCHANT (AFFILIATE_CODE,PAYMENT_TYPE,MERCHANT) VALUES('FDW','PYPL','FDW');
