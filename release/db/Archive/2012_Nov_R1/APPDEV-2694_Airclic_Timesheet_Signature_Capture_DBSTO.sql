...
GRANT SELECT,INSERT,UPDATE,DELETE ON TRANSP.EMPTIMESHEET_EXPORT TO FDSTORE_PRDA, FDTRN_PRDA;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON TRANSP.EMP_TIMESHEET TO FDSTORE_PRDA, FDTRN_PRDA;
...
CREATE OR REPLACE PROCEDURE TRANSP.EMP_TIMESHEET_CAPTURE  IS
   ...
   CURSOR tsCursor
   IS
      SELECT * FROM AIRCLIC_PROD.RUNNERTRACKINGSTATUS@AIRCLICRW.NYC.FRESHDIRECT.COM RT 
...
GRANT EXECUTE ON TRANSP.EMP_TIMESHEET_CAPTURE TO FDSTORE_PRDA, FDTRN_PRDA;
