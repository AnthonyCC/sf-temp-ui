...
GRANT SELECT ON DLV.CARTONSTATUS TO FDSTORE_PRDA, APPDEV;
...
GRANT SELECT, INSERT, DELETE, UPDATE on CUST.AUTO_LATE_DELIVERY TO FDSTORE_PRDA;

GRANT SELECT on CUST.AUTO_LATE_DELIVERY TO APPDEV;

GRANT SELECT, INSERT, DELETE, UPDATE on CUST.AUTO_LATE_DELIVERY_ORDERS TO FDSTORE_PRDA;
