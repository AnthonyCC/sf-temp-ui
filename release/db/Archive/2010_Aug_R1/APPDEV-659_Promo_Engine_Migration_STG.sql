...
INSERT,
DELETE,
UPDATE ON CUST.PROMOTION_NEW TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMOTION_NEW TO appdev;

-- MIGRATE DATA FROM CUST.PROMOTION TO CUST.PROMOTION_NEW
INSERT INTO CUST.PROMOTION_NEW(ID, CODE, NAME, DESCRIPTION, REDEMPTION_CODE, START_DATE, EXPIRATION_DATE, ROLLING_EXPIRATION_DAYS, MAX_USAGE,CAMPAIGN_CODE,PERCENT_OFF,MAX_AMOUNT,WAIVE_CHARGE_TYPE,NEEDDRYGOODS, MODIFY_DATE, RULE_BASED, FAVORITES_ONLY, COMBINE_OFFER,MODIFIED_BY,CREATE_DATE,CREATED_BY, CATEGORY_NAME, PRODUCT_NAME, DONOT_APPLY_FRAUD, PROFILE_OPERATOR, MAX_ITEM_COUNT, OFFER_TYPE, MIN_SUBTOTAL, OFFER_DESC, AUDIENCE_DESC) SELECT ID, CODE, NAME, DESCRIPTION, REDEMPTION_CODE, START_DATE, EXPIRATION_DATE, ROLLING_EXPIRATION_DAYS, MAX_USAGE,CAMPAIGN_CODE,PERCENT_OFF,MAX_AMOUNT,WAIVE_CHARGE_TYPE, NEEDDRYGOODS,MODIFY_DATE, RULE_BASED, RECOMMENDED_ITEMS_ONLY, ALLOW_HEADER_DISCOUNT,MODIFIED_BY,MODIFY_DATE,MODIFIED_BY, CATEGORY_NAME, PRODUCT_NAME, DONOT_APPLY_FRAUD, PROFILE_OPERATOR, MAX_ITEM_COUNT, CAMPAIGN_CODE, MIN_SUBTOTAL, NOTES, NOTES FROM CUST.PROMOTION;	

UPDATE CUST.PROMOTION_NEW set REDEEM_CNT=1 where id in(SELECT id from CUST.PROMOTION P where P.UNIQUE_USE='X');
...
UPDATE CUST.PROMOTION_NEW set NEEDCUSTOMERLIST = 'X' where CODE IN (SELECT CODE FROM CUST.PROMOTION@DBSTO.NYC.FRESHDIRECT.COM WHERE ID IN (SELECT PROMOTION_ID FROM CUST.PROMO_CUSTOMER@DBSTO.NYC.FRESHDIRECT.COM)); 

UPDATE CUST.PROMOTION_NEW set OFFER_TYPE = 'GENERIC' where  CAMPAIGN_CODE IN ('REDEMPTION', 'SIGNUP', 'REFERRAL', 'REFERRER');

UPDATE CUST.PROMOTION_NEW set OFFER_TYPE = 'LINE_ITEM' where CAMPAIGN_CODE IN ('DCPD');

UPDATE CUST.PROMOTION_NEW set OFFER_TYPE = 'SAMPLE' where CAMPAIGN_CODE IN ('SAMPLE');

UPDATE CUST.PROMOTION_NEW set OFFER_TYPE = 'WINDOW_STEERING' where CAMPAIGN_CODE IN ('WINDOW_STEERING');

UPDATE CUST.PROMOTION_NEW set OFFER_TYPE = 'GIFT_CARD' where CAMPAIGN_CODE IN ('GIFT_CARD');

UPDATE CUST.PROMOTION_NEW set OFFER_TYPE = 'WAIVECHARGE' where WAIVE_CHARGE_TYPE IS NOT NULL;

--Updating active gift card, redemption, window steering type promotions to type header.
UPDATE CUST.PROMOTION_NEW set CAMPAIGN_CODE = 'HEADER' where CAMPAIGN_CODE IN ('GIFT_CARD', 'REDEMPTION','WINDOW_STEERING', 'SIGNUP', 'REFERRAL', 'REFERRER');
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_ATTR_NEW TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_ATTR_NEW TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_DCPD_DATA_NEW TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_DCPD_DATA_NEW TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_GEOGRAPHY_NEW TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_GEOGRAPHY_NEW TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_GEOGRAPHY_DATA_NEW TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_GEOGRAPHY_DATA_NEW TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_VARIANTS_NEW TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_VARIANTS_NEW TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_CART_STRATEGY TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_CART_STRATEGY TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_CUST_STRATEGY TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_CUST_STRATEGY TO appdev;
...
GRANT EXECUTE ON CUST.PROMO_DLV_ZONECODES TO FDSTORE_PRDB;
 ...
 GRANT EXECUTE ON CUST.PROMO_DLV_ZONECODES TO FDSTORE_STSTG01;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_CHANGE TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_CHANGE TO appdev;
...
(
    ...
    OLD_VALUE     VARCHAR2(2999 BYTE),
    NEW_VALUE     VARCHAR2(2999 BYTE)
);
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_CHANGE_DETAIL TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_CHANGE_DETAIL TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_DELIVERY_DATES TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_DELIVERY_DATES TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_DLV_ZONE_STRATEGY TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_DLV_ZONE_STRATEGY TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PROMO_DLV_TIMESLOT TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PROMO_DLV_TIMESLOT TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PUBLISH_LOG TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PUBLISH_LOG TO appdev;
...
INSERT,
DELETE,
UPDATE ON CUST.PUBLISH_LOG_DETAIL TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.PUBLISH_LOG_DETAIL TO appdev;
...
ALTER TABLE CUST.PROMO_CUSTOMER ADD (CONSTRAINT CUST_PROMO_PROMO_FK FOREIGN KEY (PROMOTION_ID) REFERENCES CUST.PROMOTION_NEW (ID));
 ...
 CREATE INDEX CUST.PROMO_CHANGE_IDX1 ON PROMO_CHANGE(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_CHANGE_DETAIL_IDX1 ON PROMO_CHANGE_DETAIL(CHANGE_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_CUST_IDX1 ON PROMO_CUST_STRATEGY(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_DCPD_DATA_NEW_IDX1 ON PROMO_DCPD_DATA_NEW(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_DELIVERY_DATES_IDX1 ON PROMO_DELIVERY_DATES(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_DLV_TIMESLOT_IDX1 ON PROMO_DLV_TIMESLOT(PROMO_DLV_ZONE_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_ATTR_NEW_IDX1 ON PROMO_ATTR_NEW(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_GEOGRAPHY_NEW_IDX1 ON PROMO_GEOGRAPHY_NEW(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_GEOGRAPHY_DATA_NEW_IDX1 ON PROMO_GEOGRAPHY_DATA_NEW(GEOGRAPHY_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_NEW_IDX1 ON PROMOTION_NEW(NAME) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_NEW_MOD_DATE_IDX2 ON PROMOTION_NEW(MODIFY_DATE) TABLESPACE FDCUSIDX;
 CREATE INDEX CUST.PROMO_NEW_EXP_DATE_IDX2 ON PROMOTION_NEW(EXPIRATION_DATE) TABLESPACE FDCUSIDX;

--Customer Masquerade DB changes
--Begin
alter table 
  cust.agent 
add
...
INSERT,
DELETE,
UPDATE ON CUST.securityticket TO FDSTORE_STSTG01;

GRANT
SELECT
ON CUST.securityticket TO appdev;
