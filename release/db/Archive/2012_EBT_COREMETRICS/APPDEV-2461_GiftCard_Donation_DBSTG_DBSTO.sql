-- CUST schema
ALTER TABLE CUST.GIFT_CARD_RECIPIENT add (DONOR_ORGNAME     VARCHAR2(55 BYTE), GIFTCARD_TYPE   VARCHAR2(3 BYTE) DEFAULT 'RGC');
ALTER TABLE CUST.SAVED_RECIPIENT add (DONOR_ORGNAME     VARCHAR2(55 BYTE), GIFTCARD_TYPE   VARCHAR2(3 BYTE) DEFAULT 'RGC');
...
INSERT INTO cms.relationshipdefinition (NAME, ID, CONTENTTYPE_ID, INHERITABLE, REQUIRED, NAVIGABLE, READONLY, LABEL, CARDINALITY_CODE) VALUES ('ORGANIZATION_LOGO_SMALL', 'DonationOrganization.ORGANIZATION_LOGO_SMALL', 'DonationOrganization', 'F', 'T', 'F', 'F', 'Organization landing logo', 'One');
INSERT INTO cms.relationshipdefinition (NAME, ID, CONTENTTYPE_ID, INHERITABLE, REQUIRED, NAVIGABLE, READONLY, LABEL, CARDINALITY_CODE) VALUES ('ORGANIZATION_RECIEPT_LOGO', 'DonationOrganization.ORGANIZATION_RECIEPT_LOGO', 'DonationOrganization', 'F', 'F', 'F', 'F', 'Organization receipt logo', 'One');
...
INSERT INTO cms.relationshipdefinition (NAME, ID, CONTENTTYPE_ID, INHERITABLE, REQUIRED, NAVIGABLE, READONLY, LABEL, CARDINALITY_CODE) VALUES ('EDITORIAL_RECEIPT_MEDIA', 'DonationOrganization.EDITORIAL_RECEIPT_MEDIA', 'DonationOrganization', 'F', 'F', 'F', 'F', 'Editorial for Detail Content', 'One');
...
INSERT INTO cms.relationshipdestination (ID,  RELATIONSHIPDEFINITION_ID, CONTENTTYPE_ID, REVERSE_ATTRIBUTE_NAME, REVERSE_ATTRIBUTE_LABEL) VALUES ('DonationOrganization.ORGANIZATION_RECIEPT_LOGO.Image', 'DonationOrganization.ORGANIZATION_RECIEPT_LOGO', 'Image', NULL, NULL);
...
INSERT INTO cms.relationshipdestination (ID,  RELATIONSHIPDEFINITION_ID, CONTENTTYPE_ID, REVERSE_ATTRIBUTE_NAME, REVERSE_ATTRIBUTE_LABEL) VALUES ('DonationOrganization.EDITORIAL_RECEIPT_MEDIA.Html', 'DonationOrganization.EDITORIAL_RECEIPT_MEDIA', 'Html', NULL, NULL);
