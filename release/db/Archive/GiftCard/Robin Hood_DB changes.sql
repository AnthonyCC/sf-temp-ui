...
GRANT SELECT,INSERT,DELETE,UPDATE on  CUST.DONATION_OPT_IND to FDSTORE_PRDA;

GRANT SELECT,INSERT,DELETE,UPDATE on  CUST.DONATION_OPT_IND to FDSTORE_PRDB;

GRANT SELECT,INSERT,DELETE,UPDATE on  CUST.DONATION_OPT_IND to fdstore_stprd01;

GRANT SELECT on  CUST.DONATION_OPT_IND to APPDEV;


alter table  CUST.DELIVERYINFO drop column OPTIN_IND;