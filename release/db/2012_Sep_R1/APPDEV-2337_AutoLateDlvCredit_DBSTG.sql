...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON DLV.CARTONSTATUS TO FDSTORE_PRDA;
...
GRANT ALL on CUST.AUTO_LATE_DELIVERY TO FDSTORE_PRDA;

GRANT ALL on CUST.AUTO_LATE_DELIVERY_ORDERS TO FDSTORE_PRDA;

GRANT ALL on CUST.LATE_DLV_COMPLAINT_CODES TO FDSTORE_PRDA;
