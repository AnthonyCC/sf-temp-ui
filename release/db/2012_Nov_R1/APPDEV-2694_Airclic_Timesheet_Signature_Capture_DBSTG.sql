CREATE TABLE EMPTIMESHEET_EXPORT
(
  LAST_EXPORT  DATE,
  SUCCESS      CHAR(1 BYTE)                     DEFAULT 'N'
);

CREATE INDEX ETS_EXPORT_IDX ON EMPTIMESHEET_EXPORT
(LAST_EXPORT);

GRANT SELECT,INSERT,UPDATE,DELETE ON EMPTIMESHEET_EXPORT TO FDTRN_STSTG01;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON TRANSP.EMP_TIMESHEET TO FDTRN_STSTG01;
...
CREATE OR REPLACE PROCEDURE TRANSP.EMP_TIMESHEET_CAPTURE  IS
   ...
   CURSOR tsCursor
   IS
      SELECT * FROM AC_STAGETRAIN.RUNNERTRACKING@AIRCLICRW.NYC.FRESHDIRECT.COM RT 
...
GRANT EXECUTE ON TRANSP.EMP_TIMESHEET_CAPTURE TO FDTRN_STSTG01;
