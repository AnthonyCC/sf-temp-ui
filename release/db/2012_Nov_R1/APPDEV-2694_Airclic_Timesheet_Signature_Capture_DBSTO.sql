...
GRANT SELECT,INSERT,UPDATE,DELETE ON EMPTIMESHEET_EXPORT TO FDTRN_PRDA;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON TRANSP.EMP_TIMESHEET TO FDTRN_PRDA;
...
CREATE OR REPLACE PROCEDURE TRANSP.EMP_TIMESHEET_CAPTURE  IS
   ...
   CURSOR tsCursor
   IS
      SELECT * FROM AIRCLIC_PROD.RUNNERTRACKING@AIRCLICRW.NYC.FRESHDIRECT.COM RT 
...
GRANT EXECUTE ON TRANSP.EMP_TIMESHEET_CAPTURE TO FDTRN_PRDA;
