...
UPDATE CUST.PROMOTION_NEW set NEEDCUSTOMERLIST = 'X' where ID IN (SELECT PROMOTION_ID FROM CUST.PROMO_CUSTOMER@DBSTO.NYC.FRESHDIRECT.COM); -- Refer to Production 
