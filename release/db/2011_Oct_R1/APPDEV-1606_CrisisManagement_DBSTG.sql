...
(
  ...
  WINDOW_ENDTIME         DATE,
  INCLUDE_STANDINGORDER  VARCHAR2(16 BYTE),
...
(
  ...
  STANDINGORDER_ID   VARCHAR2(16 BYTE),
...
(
  ...
  ERROR_HEADER            VARCHAR2(1024 BYTE),
  STATUS                  VARCHAR2(8 BYTE)
);

CREATE INDEX TRANSP.IDX_CMBATCHSO_BATCHID ON TRANSP.CRISISMNG_BATCHSTANDINGORDER(BATCH_ID);

ALTER TABLE TRANSP.CRISISMNG_BATCHSTANDINGORDER ADD ( CONSTRAINT PK_CMBATCHSTANDINGORDER PRIMARY KEY (BATCH_ID, STANDINGORDER_ID));
...
/*permissions*/
GRANT EXECUTE ON TRANSP.CRISISMANAGER_ZONE_NO TO fdtrn_ststg01;

GRANT EXECUTE ON TRANSP.CRISISMANAGER_ZONE_NO TO appdev;

GRANT EXECUTE ON TRANSP.CRISISMANAGER_DELIVERYTYPE TO fdtrn_ststg01;

GRANT EXECUTE ON TRANSP.CRISISMANAGER_DELIVERYTYPE TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.CRISISMNG_BATCH TO fdtrn_ststg01;

GRANT SELECT ON TRANSP.CRISISMNG_BATCH TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.CRISISMNG_BATCHACTION TO fdtrn_ststg01;

GRANT SELECT ON TRANSP.CRISISMNG_BATCHACTION TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.CRISISMNG_BATCHORDER TO fdtrn_ststg01;

GRANT SELECT ON TRANSP.CRISISMNG_BATCHORDER TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.CRISISMNG_BATCHRESERVATION TO fdtrn_ststg01;

GRANT SELECT ON TRANSP.CRISISMNG_BATCHRESERVATION TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.CRISISMNG_BATCHSTANDINGORDER TO fdtrn_ststg01;

GRANT SELECT ON TRANSP.CRISISMNG_BATCHSTANDINGORDER TO appdev;

GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSP.CRISISMNG_BATCHTIMESLOT TO fdtrn_ststg01;

GRANT SELECT ON TRANSP.CRISISMNG_BATCHTIMESLOT TO appdev;

GRANT SELECT ON TRANSP.CRISISMNGBATCHSEQ TO fdtrn_ststg01;   

GRANT SELECT ON TRANSP.CRISISMNGBATCHSEQ TO appdev;

GRANT SELECT ON cust.customer TO fdtrn_ststg01;
GRANT SELECT ON cust.fdcustomer TO fdtrn_ststg01;
GRANT SELECT ON cust.customerinfo TO fdtrn_ststg01;
GRANT SELECT ON cust.sale TO fdtrn_ststg01;
GRANT SELECT ON cust.salesaction TO fdtrn_ststg01;
GRANT SELECT ON cust.deliveryinfo TO fdtrn_ststg01;
GRANT SELECT ON dlv.reservation TO fdtrn_ststg01;
GRANT SELECT ON cust.standing_order TO fdtrn_ststg01;
GRANT SELECT ON cust.customerlist TO fdtrn_ststg01;
GRANT SELECT ON cust.orderline TO fdtrn_ststg01;
GRANT SELECT ON cust.customerlist_details TO fdtrn_ststg01;
