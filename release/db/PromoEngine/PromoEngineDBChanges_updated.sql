...
ALTER TABLE CUST.PROMO_CUSTOMER ADD (CONSTRAINT CUST_PROMO_PROMO_FK FOREIGN KEY (PROMOTION_ID) REFERENCES CUST.PROMOTION_NEW (ID));
 ...
 CREATE INDEX PROMO_CHANGE_IDX1 ON PROMO_CHANGE(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_CHANGE_DETAIL_IDX1 ON PROMO_CHANGE_DETAIL(CHANGE_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_CUST_IDX1 ON PROMO_CUST_STRATEGY(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_DCPD_DATA_NEW_IDX1 ON PROMO_DCPD_DATA_NEW(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_DELIVERY_DATES_IDX1 ON PROMO_DELIVERY_DATES(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_DLV_TIMESLOT_IDX1 ON PROMO_DLV_TIMESLOT(PROMO_DLV_ZONE_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_ATTR_NEW_IDX1 ON PROMO_ATTR_NEW(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_GEOGRAPHY_NEW_IDX1 ON PROMO_GEOGRAPHY_NEW(PROMOTION_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_GEOGRAPHY_DATA_NEW_IDX1 ON PROMO_GEOGRAPHY_DATA_NEW(GEOGRAPHY_ID) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_NEW_IDX1 ON PROMOTION_NEW(NAME) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_NEW_MOD_DATE_IDX2 ON PROMOTION_NEW(MODIFY_DATE) TABLESPACE FDCUSIDX;
 CREATE INDEX PROMO_NEW_EXP_DATE_IDX2 ON PROMOTION_NEW(EXPIRATION_DATE) TABLESPACE FDCUSIDX;
